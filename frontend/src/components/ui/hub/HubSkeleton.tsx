...
export function HubListSkeleton() {
  return (
    <div className="space-y-4">
      {[1, 2, 3, 4, 5].map((i) => (
        <div key={i} className="p-5 rounded-2xl bg-white border border-slate-50 flex items-center justify-between">
  ...
  return (
    <Card className="h-full rounded-[2.5rem] border-none bg-white shadow-xl overflow-hidden flex flex-col">
      <CardHeader className="p-10 lg:p-14 border-b border-slate-50 space-y-8">
        ...
        <div className="bg-slate-50/50 rounded-3xl p-10 h-32 flex items-center justify-center">
      ...
      <CardContent className="p-10 lg:p-14 space-y-12 flex-1">
        ...
        <div className="space-y-4 pt-4">
          ...
          <div className="p-10 bg-slate-50/50 rounded-3xl h-48">
...
export function HubMetricSkeleton() {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      {[1, 2, 3, 4].map((i) => (
        <Card key={i} className="bg-white/60 backdrop-blur-xl border-white/5 rounded-3xl p-6 space-y-4">
