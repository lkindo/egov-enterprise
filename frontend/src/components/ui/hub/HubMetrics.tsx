  ...
  return (
    <div className={cn(
      ...
      <div className="flex justify-between items-start mb-10 relative z-10">
        <div className={cn(
          "w-14 h-11 rounded-lg flex items-center justify-center shadow-xl border border-border/10 group-hover:rotate-12 transition-transform", 
          iconBgMap[color]
        )}>
          <Icon size={24} />
        </div>
        <div className="flex flex-col items-end gap-2">
            ...
            {trend && (
                <span className={cn(
                    "text-xs font-bold px-2 py-0.5 rounded-lg border tracking-tighter uppercase",
