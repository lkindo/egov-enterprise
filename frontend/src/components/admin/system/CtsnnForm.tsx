...
import { CtsnnManage } from '@/services/ctsnnService';

interface CtsnnFormProps {
  initialData?: Partial<CtsnnManage>;
  onSubmit: (data: Partial<CtsnnManage>) => Promise<void>;
  onCancel: () => void;
}

export function CtsnnForm({ initialData, onSubmit, onCancel }: CtsnnFormProps) {
  const [formData, setFormData] = useState<Partial<CtsnnManage>>({
    usid: '',
    ctsnnCode: '1',
    ctsnnNm: '',
