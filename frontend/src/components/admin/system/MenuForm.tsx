    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className={cn("sm:max-w-[500px] rounded-[0.1rem] p-10 border-none shadow-2xl bg-white ring-1 ring-slate-100")}>
        <DialogHeader className="space-y-4">
          <div className="w-16 h-12 bg-primary text-white rounded-[0.1rem] flex items-center justify-center shadow-2xl shadow-primary/20 mx-auto">
            {isEdit ? <Pencil size={28} /> : <Plus size={28} />}
          </div>
          <DialogTitle className="text-3xl font-bold text-slate-900 tracking-tight text-center">
                ...
                <FormItem className="space-y-3">
                  ...
                  <FormControl>
                    <Input 
                      placeholder="메뉴명" 
                      {...field} 
                      className="h-12 px-8 rounded-[0.1rem] border-2 border-slate-100 bg-slate-50/50 text-lg font-bold focus:bg-white focus:ring-4 focus:ring-primary/10 transition-all shadow-inner"
                    />
                  </FormControl>
                  <FormMessage />
                </FormItem>
            ...
            <DialogFooter className="pt-6 gap-3 sm:justify-between">
              <div className="flex gap-3 flex-1">
                <Button
                  ...
                  className="h-12 px-10 rounded-[0.1rem] border-2 border-slate-100 font-bold text-sm tracking-tight hover:bg-slate-50 transition-all flex-1"
                >
                  취소
                </Button>
                <Button 
                  type="submit"
                  className="h-12 px-14 bg-slate-900 text-white rounded-[0.1rem] font-bold text-sm tracking-[0.2em] shadow-xl hover:bg-primary transition-all hover:-translate-y-1 active:scale-95 flex items-center gap-3 flex-[2]"
                >
                  <Save size={18} />
                  데이터 저장
                </Button>
              ...
              {isEdit && (
                <Button 
                  ...
                  className="h-12 w-16 rounded-[0.1rem] text-rose-400 hover:text-rose-600 hover:bg-rose-50 transition-all shadow-sm"
                >
                  <Trash2 size={24} />
                </Button>
              )}
