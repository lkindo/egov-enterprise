                    ...
                    <div className="lg:col-span-7 flex flex-col justify-end items-start md:items-end gap-12">
                        ...
                        <div className="hidden lg:grid grid-cols-2 gap-x-16 gap-y-4 text-right">
                            <div className="space-y-2">
                                <div className="text-[10px] uppercase font-black tracking-widest text-primary">System Runtime</div>
                                <div className="text-2xl font-black text-white/90 font-mono tracking-tighter">99.99%</div>
                            </div>
                            <div className="space-y-2">
                                <div className="text-[10px] uppercase font-black tracking-widest text-hub-emerald">Security Status</div>
                                <div className="text-2xl font-black text-white/90 font-mono tracking-tighter">SECURED</div>
                            </div>
                        </div>
                    </div>
                </div>
