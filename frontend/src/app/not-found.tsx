        ...
        <div className="min-h-[80vh] flex items-center justify-center p-6 relative overflow-hidden">
            ...
            <div className="max-w-md w-full bg-background/60 backdrop-blur-xl border-2 border-primary/5 rounded-[0.1rem] p-10 shadow-2xl shadow-primary/5 text-center space-y-8 animate-in fade-in zoom-in-95 duration-700">
                <div className="relative inline-block">
                    ...
                    <div className="absolute -bottom-2 -right-2 bg-destructive text-white text-sm font-bold px-3 py-1 rounded-full shadow-lg">
                        404
                    </div>
                </div>

                <div className="space-y-3">
                    <h1 className="text-3xl font-bold tracking-tight text-foreground">길을 잃으셨나요?</h1>
                ...
                <div className="pt-6 text-xs text-slate-500 font-bold tracking-tight">
