            ...
            <div className="max-w-md w-full bg-background/60 backdrop-blur-xl border-2 border-primary/5 rounded-[0.1rem] p-10 shadow-2xl shadow-primary/5 text-center space-y-8 animate-in fade-in zoom-in-95 duration-700">
                ...
                <div className="grid grid-cols-2 gap-4 pt-4">
                    <button
                        ...
                        className={cn(buttonVariants({ variant: "outline", size: "lg" }), "rounded-[0.1rem] h-14 font-bold border-2 gap-2")}
                    >
                        <ArrowLeft size={18} /> 이전으로
                    </button>
                    <Link
                        href="/"
                        className={cn(buttonVariants({ size: "lg" }), "rounded-[0.1rem] h-14 font-black shadow-xl shadow-primary/20 gap-2")}
                    >
                        <Home size={18} /> 홈으로 이동
                    </Link>
                </div>
