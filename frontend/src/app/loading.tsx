  ...
  return (
    <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-background/80 backdrop-blur-md transition-all duration-500">
      <div className="relative">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="w-10 h-10 bg-primary rounded-xl flex items-center justify-center shadow-lg shadow-primary/40 rotate-12 animate-bounce">
             <span className="text-primary-foreground font-black text-xs">eG</span>
          </div>
        </div>
      </div>
      ...
      <div className="mt-8 flex flex-col items-center gap-2">
        <h3 className="text-xl font-black tracking-tighter uppercase italic text-primary">Modernizing Enterprise</h3>
        ...
        <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-[0.3em] mt-2 opacity-50">Please wait a moment</p>
      </div>
