export default function GlobalLoading() {
 ...
 <h3 className="text-xl font-black tracking-tighter text-primary">엔터프라이즈 현대화</h3>
 ...
 <p className="text-[10px] font-bold text-muted-foreground tracking-[0.3em] mt-2 opacity-50">잠시만 기다려주세요</p>
 </div>
