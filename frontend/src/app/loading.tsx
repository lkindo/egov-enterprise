export default function GlobalLoading() {
 ...
 {/* Animated Rings */}
 <div className="w-24 h-24 border-4 border-primary/20 rounded-lg animate-pulse" />
 <div className="absolute top-0 left-0 w-24 h-24 border-4 border-primary border-t-transparent rounded-lg animate-spin duration-700" />
 ...
 <div className="mt-8 flex flex-col items-center gap-2">
    ...
    <div className="flex items-center gap-1.5">
      <div className="w-1.5 h-1.5 bg-primary rounded-lg animate-[bounce_1s_infinite_0ms]" />
      <div className="w-1.5 h-1.5 bg-primary rounded-lg animate-[bounce_1s_infinite_200ms]" />
      <div className="w-1.5 h-1.5 bg-primary rounded-lg animate-[bounce_1s_infinite_400ms]" />
    </div>
