export default function GlobalLoading() {
 ...
 <h3 className="text-xl font-black tracking-tighter text-primary">?”í„°?„ë¼?´ì¦ˆ ?„ë???/h3>
 ...
 <p className="text-[10px] font-bold text-muted-foreground tracking-[0.3em] mt-2 opacity-50">? ì‹œë§?ê¸°ë‹¤?¤ì£¼?¸ìš”</p>
 </div>
