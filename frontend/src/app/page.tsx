      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Link href="/cop/bbs/selectBoardList?bbsId=BBSMSTR_AAAAAAAAAAAA" aria-label="공지사항 더보기" className={buttonVariants({ variant: "ghost", size: "sm" })}>더보기</Link>
          </CardHeader>
          <CardContent>
            {loading ? (
              <div className="space-y-2">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Link href="/cop/bbs/selectBoardList?bbsId=BBSMSTR_CCCCCCCCCCCC" aria-label="오늘의 할일 더보기" className={buttonVariants({ variant: "ghost", size: "sm" })}>더보기</Link>
          </CardHeader>
          <CardContent>
            {loading ? (
              <div className="space-y-2">
