                        ...
                        <Table>
                            <TableHeader className="bg-slate-50/50">
                                <TableRow className="hover:bg-transparent">
                                    <TableHead className="w-[80px] text-center font-black text-slate-400 text-xs py-6 uppercase tracking-widest">Index</TableHead>
                                    <TableHead className="w-[300px] font-black text-slate-900 text-xs py-6 uppercase tracking-widest">Community Name</TableHead>
                                    <TableHead className="font-black text-slate-400 text-xs py-6 uppercase tracking-widest">Introduction</TableHead>
                                    <TableHead className="w-[150px] font-black text-slate-400 text-xs py-6 text-center uppercase tracking-widest">Manager</TableHead>
                                    <TableHead className="w-[150px] font-black text-slate-400 text-xs py-6 text-center uppercase tracking-widest">Established</TableHead>
                                </TableRow>
                            </TableHeader>
                            <TableBody>
                                {loading ? (
                                    ...
                                    <TableRow>
                                        <TableCell colSpan={5} className="h-48 text-center text-slate-400 font-bold text-xl uppercase tracking-tighter opacity-30">
                    ...
                    {totalPages > 1 && (
                        <div className="flex items-center justify-center gap-10 mt-20 pb-10">
                            <Button
                                ...
                                className="px-12 h-14 rounded-2xl font-black text-slate-400 border-2 border-transparent hover:border-slate-100 hover:bg-white hover:text-blue-600 transition-all uppercase tracking-widest text-xs"
                            >
                                Previous
                            </Button>
