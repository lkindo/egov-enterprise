          ...
          <div className="col-span-12 lg:col-span-8 space-y-[var(--gap-hub-section)]">
              ...
              <div className="space-y-[var(--gap-hub-section)] py-6">
                <div className="space-y-6">
                   ...
                   <div className="p-10 bg-slate-50 border-2 border-slate-100 rounded-[var(--radius-hub-widget)] shadow-inner relative overflow-hidden group">
                      ...
                      <p className="text-2xl font-bold tracking-tight text-slate-900 leading-relaxed relative z-10">
            ...
            >
              <div className="flex flex-col items-center justify-center py-24 text-center border-2 border-dashed border-slate-200 rounded-[var(--radius-hub-section)] bg-slate-50/30">
                ...
                <h4 className="text-xl font-bold text-slate-400 tracking-tight uppercase font-mono">_ No_Posts_Detected</h4>
          ...
          <div className="col-span-12 lg:col-span-4 space-y-[var(--gap-hub-section)]">
            <div className="rounded-[var(--radius-hub-section)] bg-slate-900 text-white p-12 space-y-10 shadow-2xl relative overflow-hidden group border-none">
              ...
              <div className="relative z-10 space-y-8 text-center">
                <div className="w-20 h-20 bg-white/10 rounded-[var(--radius-hub-item)] flex items-center justify-center mx-auto border border-white/5 shadow-inner group-hover:rotate-12 transition-transform">
                  <ShieldCheck size={40} className="text-primary" />
                </div>
                <div className="space-y-4">
                  <h4 className="text-2xl font-bold tracking-tight leading-tight uppercase font-mono">_ SECURITY<br />POLICY</h4>
            ...
            <div className="hub-glass-premium rounded-[var(--radius-hub-section)] p-10 space-y-10 border-2 border-slate-100 shadow-2xl relative overflow-hidden group">
               <div className="flex items-center justify-between border-b border-slate-200/50 pb-6">
                  <h4 className="text-sm font-bold text-slate-900 tracking-tight uppercase font-mono">_ Member_Pulse</h4>
...
function DetailBlock({ icon, label, value }: { icon: React.ReactNode, label: string, value: string }) {
  return (
    <div className="p-8 rounded-[var(--radius-hub-widget)] bg-slate-50 border border-slate-100 transition-all hover:bg-white hover:shadow-2xl hover:scale-[1.03] group relative overflow-hidden">
      ...
      <p className="text-xl font-bold tracking-tight text-slate-900 truncate font-mono relative z-10">
        {value}
      </p>
    </div>
  );
