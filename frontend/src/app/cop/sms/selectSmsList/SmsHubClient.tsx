  ...
  const columns: Column<SmsDto>[] = [
    {
      header: 'ID',
      accessor: (item) => (
        <span className="text-xs font-bold font-mono text-slate-400 tracking-tighter">
    ...
    },
    {
      ...
      accessor: (item) => (
        <div className="flex items-center gap-4">
          ...
          <span className="text-sm font-bold text-slate-900 tracking-tighter font-mono">
            {item.recptnTelno}
          </span>
        </div>
      )
    ...
    },
    {
      header: 'STATUS',
      accessor: () => (
        <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-emerald-50 text-emerald-600 rounded-lg border border-emerald-100 text-xs font-bold tracking-widest uppercase">
                ...
                <DialogContent className="sm:max-w-xl bg-white border-none shadow-[0_0_100px_rgba(0,0,0,0.1)] p-0 overflow-hidden rounded-lg">
                    <div className="bg-slate-900 p-10 text-white relative overflow-hidden">
                        ...
                        <div className="relative z-10 space-y-2">
                            ...
                            <DialogHeader>
                                <DialogTitle className="text-3xl font-bold tracking-tighter uppercase font-mono flex items-center gap-4 text-white">
                    ...
                    <div className="p-10 space-y-10">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="relative group">
                                    ...
                                    <Input
                                        ...
                                        className="pl-16 h-11 bg-slate-50 border-2 border-slate-100 rounded-[var(--radius-hub-item)] text-lg font-bold tracking-widest focus:ring-4 focus:ring-primary/10 transition-all placeholder:text-slate-200 font-mono"
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="relative group">
                                    <Textarea
                                        ...
                                        className="min-h-[200px] p-8 bg-slate-50 border-2 border-slate-100 rounded-[var(--radius-hub-item)] text-lg font-bold tracking-tighter focus:ring-4 focus:ring-primary/10 transition-all placeholder:text-slate-200 leading-relaxed font-mono"
                        ...
                        <div className="flex gap-4 pt-4 border-t border-slate-100">
                            <Button 
                                ...
                                className="h-11 px-10 rounded-[var(--radius-hub-item)] font-bold text-xs tracking-widest uppercase font-mono hover:bg-slate-50"
                            >
                                ABORT_OPERATION
                            </Button>
                            <Button 
                                ...
                                className="flex-1 h-11 rounded-[var(--radius-hub-item)] bg-slate-900 text-white font-bold text-xs tracking-widest uppercase shadow-2xl hover:bg-primary transition-all gap-4 group"
                            >
          ...
          <div className="col-span-12 lg:col-span-3 space-y-8">
            <div className="hub-glass-premium rounded-[var(--radius-hub-section)] p-8 space-y-8 border-2 border-slate-100/50 shadow-2xl relative overflow-hidden group">
              ...
              <div className="relative z-10 space-y-2">
                ...
                <h4 className="text-3xl font-bold tracking-tighter text-slate-900 uppercase font-mono">_ Channel<br />Throughput</h4>
              </div>
