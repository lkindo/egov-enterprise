            ...
            >
                ...
                {FORMS.map((form) => (
                  ...
                  >
                    ...
                    <div className="flex items-start gap-6 relative z-10">
                      <div className={cn(
                        "w-16 h-12 rounded-lg flex items-center justify-center text-white shadow-2xl rotate-3 group-hover:rotate-0 transition-transform duration-500 shrink-0",
                        form.color
                      )}>
                        {form.icon}
                      </div>
              ...
              <div className="p-12 bg-slate-900 rounded-[2.5rem] shadow-2xl relative overflow-hidden text-center">
                ...
                <div className="relative z-10 space-y-4">
                  <h4 className="text-xl font-bold text-white tracking-tight">_ "Precision in every dispatch."</h4>
                ...
                <Card className="rounded-[2.5rem] border-none bg-white shadow-[0_40px_100px_-20px_rgba(0,0,0,0.1)] overflow-hidden flex flex-col h-full min-h-[600px]">
                  <div className="p-10 lg:p-14 space-y-12 flex-1">
                    <div className="space-y-6">
                       ...
                       <Input 
                          ...
                          className="h-20 text-3xl font-bold tracking-tight bg-slate-50/50 border-none rounded-lg px-8 focus:ring-4 focus:ring-primary/5 transition-all shadow-inner"
                       />
                    </div>
                  ...
                  <div className="p-10 bg-slate-50/50 border-t border-slate-100 flex items-center justify-between">
                    ...
                    <Button 
                        ...
                        className="h-12 px-10 rounded-lg bg-slate-900 text-white font-bold shadow-2xl hover:bg-primary hover:-translate-y-1 transition-all gap-3 border-none uppercase tracking-widest text-xs"
                    >
