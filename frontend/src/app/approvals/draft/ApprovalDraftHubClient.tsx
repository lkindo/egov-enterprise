        ...
        <div className="flex items-center justify-between px-4">
          <div className="flex items-center gap-6">
            <Button 
                ...
                className="w-14 h-14 rounded-2xl bg-white shadow-xl hover:bg-slate-50 transition-all border-none"
            >
          ...
          <div className="hidden md:flex items-center gap-2 px-6 py-3 bg-white rounded-2xl shadow-xl border border-slate-100">
            <ShieldCheck size={16} className="text-emerald-500" />
            <span className="text-[10px] font-black text-slate-600 tracking-widest uppercase">Encryption Active</span>
          </div>
        </div>
                ...
                {FORMS.map((form) => (
                  ...
                  >
                    ...
                    <div className="flex items-start gap-6 relative z-10">
                      <div className={cn(
                        "w-16 h-16 rounded-2xl flex items-center justify-center text-white shadow-2xl rotate-3 group-hover:rotate-0 transition-transform duration-500 shrink-0",
                        form.color
                      )}>
                        {form.icon}
                      </div>
                ...
                <Card className="rounded-[2.5rem] border-none bg-white shadow-2xl p-8 space-y-8 overflow-hidden relative">
                   ...
                   <div className="space-y-6 relative z-10">
                      <div className="flex items-center gap-4">
                        <div className={cn("w-14 h-14 rounded-2xl flex items-center justify-center text-white shadow-xl", selectedForm?.color)}>
                          {selectedForm?.icon}
                        </div>
                        <div>
                          <h4 className="text-lg font-black text-slate-900 tracking-tight">{selectedForm?.title}</h4>
                          <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">{selectedForm?.category} MODULE</p>
                        </div>
                      </div>
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center gap-2 text-[10px] font-black text-slate-300 tracking-[0.3em] uppercase">
                ...
                <Card className="rounded-[2.5rem] border-none bg-white shadow-[0_40px_100px_-20px_rgba(0,0,0,0.1)] overflow-hidden flex flex-col h-full min-h-[600px]">
                  <div className="p-10 lg:p-14 space-y-12 flex-1">
                    <div className="space-y-6">
                       <label className="text-[10px] font-black text-slate-400 tracking-[0.5em] uppercase flex items-center gap-3">
                       ...
                       <Input 
                          ...
                          className="h-20 text-3xl font-black tracking-tighter bg-slate-50/50 border-none rounded-3xl px-8 focus:ring-4 focus:ring-primary/5 transition-all shadow-inner"
                       />
                    </div>
                  ...
                  <div className="p-10 bg-slate-50/50 border-t border-slate-100 flex items-center justify-between">
                    <Button 
                        ...
                        className="h-14 px-8 rounded-2xl font-black text-slate-400 hover:text-slate-900 transition-all uppercase tracking-widest text-[10px]"
                    >
                      Abort Dispatch
                    </Button>
                    <Button 
                        onClick={handleSubmit}
                        className="h-16 px-10 rounded-2xl bg-slate-900 text-white font-black shadow-2xl hover:bg-primary hover:-translate-y-1 transition-all gap-3 border-none uppercase tracking-widest text-[11px]"
                    >
