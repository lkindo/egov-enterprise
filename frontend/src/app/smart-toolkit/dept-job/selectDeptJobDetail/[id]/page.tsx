                ...
                <form onSubmit={handleSubmit}>
                    <CardContent className="pt-24 pb-20 px-12 md:px-20 space-y-20">
                        ...
                        <div className="space-y-6 group">
                            ...
                            <Input
                                ...
                                className="h-20 text-3xl font-bold border-2 border-slate-50 focus:border-slate-900 focus-visible:ring-slate-100 transition-all rounded-[0.1rem] px-10 bg-slate-50/50 shadow-inner group-focus-within:bg-white group-focus-within:shadow-2xl"
                    ...
                    <CardFooter className="flex flex-col md:flex-row justify-center gap-8 py-20 border-t border-slate-50 bg-slate-50/30 px-12 rounded-b-[3.5rem]">
                        <Link href="/smart-toolkit/dept-job/selectDeptJobList">
                            <Button type="button" variant="ghost" className="h-20 px-16 font-bold tracking-[0.3em] text-sm text-slate-400 hover:bg-white hover:text-rose-500 hover:shadow-2xl transition-all rounded-[0.1rem] border-2 border-transparent hover:border-rose-50">
                                <ArrowLeft className="w-6 h-6 mr-4" /> Discard & Return
                            </Button>
                        </Link>
                        <Button type="submit" className="h-20 px-24 gap-4 font-bold tracking-[0.3em] text-sm shadow-[0_24px_48px_-8px_theme(colors.slate.900/40)] bg-slate-900 hover:bg-black transition-all active:scale-95 ring-[20px] ring-slate-100 rounded-[0.1rem]" disabled={loading}>
                            {loading ? (
