...
const DeptJobListPage = () => {
    ...
    return (
        <div className="flex flex-col gap-6 p-6">
            <div className="flex items-center gap-2 text-sm text-muted-foreground bg-muted/50 p-3 rounded-[0.1rem] w-fit">
                    ...
                    {totalPages > 1 && (
                        <div className="flex items-center justify-center gap-6 mt-16 pb-10">
                            <Button
                                ...
                                disabled={pageNo === 1}
                                className="px-12 h-11 rounded-[0.1rem] font-bold text-slate-400 border-2 border-transparent hover:border-slate-100 hover:bg-white transition-all tracking-tight text-xs"
                            >
                                이전
                            </Button>
