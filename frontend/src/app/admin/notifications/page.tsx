                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10">
                    <div className="space-y-4">
                        <div className="flex items-center gap-3 text-emerald-400">
                            <ShieldCheck size={20} />
                            <span className="text-xs font-black uppercase tracking-[0.3em] leading-none">Security Verified Channel</span>
                        </div>
                    ...
                    <div className="flex flex-col gap-3 min-w-[200px]">
                        <div className="px-6 py-4 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-md flex items-center justify-between">
                            <span className="text-[10px] font-black uppercase tracking-widest opacity-50">Global Delivery</span>
                            <span className="text-xl font-black text-emerald-400">99.9%</span>
                        </div>
                        <div className="px-6 py-4 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-md flex items-center justify-between">
                            <span className="text-[10px] font-black uppercase tracking-widest opacity-50">Active Triggers</span>
                ...
                {view === 'hub' ? (
                    ...
                    <div className="animate-in zoom-in-95 duration-700">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
                            {[
                                { title: 'Email Templates', icon: <Mail className="text-blue-500" />, desc: '전문적인 비즈니스용 이메일 템플릿 라이브러리' },
                                ...
                                <div key={i} className="p-8 bg-card border-2 border-primary/5 rounded-[3rem] shadow-xl group hover:border-primary/20 transition-all cursor-pointer">
                                    ...
                                    <p className="text-xs font-medium text-muted-foreground leading-relaxed">{card.desc}</p>
                                </div>
                            ))}
                        </div>
                    </div>
