        ...
        actions={
          <div className="flex items-center gap-2 md:gap-4 flex-wrap">
            ...
            <DataExportExcel
              data={initialData}
              headers={[
                { label: '날짜', key: 'statsDate' },
                { label: statsName, key: 'statsCo' }
              ]}
        ...
        <div className="flex flex-col md:flex-row md:items-end gap-6 relative z-10">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 flex-1">
            <div className="space-y-3">
              <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest italic ml-1">Analysis Start</label>
            ...
            <div className="space-y-3">
              <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest italic ml-1">Analysis End</label>
              <div className="relative">
                <Calendar className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400" size={18} />
                <Input
                  type="date"
          ...
          <Button
            ...
            disabled={loading}
            className="h-14 px-10 bg-slate-900 text-white rounded-2xl font-black text-xs uppercase tracking-[0.2em] shadow-xl hover:bg-primary transition-all hover:-translate-y-1 active:scale-95 flex items-center gap-3 italic min-w-[160px]"
          >
      ...
      <div className="grid grid-cols-1 gap-10">
        <div className="responsive-card p-6 md:p-12 relative overflow-hidden group">
            <div className="flex items-center gap-4 mb-10">
                ...
                <div>
                    <h3 className="text-xl md:text-2xl font-black text-slate-900 uppercase tracking-tighter italic">{subtitle}</h3>
                    <p className="text-[9px] font-black text-slate-400 uppercase tracking-[0.3em]">Temporal Trend Analysis</p>
                </div>
            </div>
        ...
        <div className="responsive-card p-6 md:p-12">
            <div className="flex items-center gap-4 mb-10 px-2">
                ...
                <div>
                    <h3 className="text-xl md:text-2xl font-black text-slate-900 uppercase tracking-tighter italic">Data Integrity Matrix</h3>
                    <p className="text-[9px] font-black text-slate-400 uppercase tracking-[0.3em]">Tabular Dataset View</p>
                </div>
            </div>
