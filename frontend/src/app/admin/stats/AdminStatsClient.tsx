  ...
  return (
    <div className="space-y-12 pb-24 animate-in fade-in slide-in-from-bottom-8 duration-1000">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-2">
        ...
        <LuxuryStatCard title="실시간 활성 세션" value={initialSummary?.todayConnects} icon={<CloudLightning size={26} />} trend="+12%" color="primary" />
        <LuxuryStatCard title="시스템 영속성 자산" value={initialSummary?.totalPosts} icon={<ShieldCheck size={26} />} trend="+0.8%" color="indigo" />
      </div>
      ...
      <div className="grid grid-cols-12 gap-10 px-2 mt-4">
        <div className="col-span-12 lg:col-span-8 flex flex-col gap-10">
          <HubSectionCard
            title="네트워크 트래픽 진화"
            description="시스템 전반에 걸친 데이터 스트림의 흐름 및 진화 양상 분석입니다."
            icon={Activity}
          >
      ...
      <div className="grid grid-cols-12 gap-10 px-2">
        ...
        <div className="col-span-12 lg:col-span-6 flex flex-col gap-10">
          <HubSectionCard
            title="지리적 트래픽 분포"
            description="익명화된 데이터 기반의 네트워크 지리적 기원지 매핑입니다."
            icon={Globe}
          >
