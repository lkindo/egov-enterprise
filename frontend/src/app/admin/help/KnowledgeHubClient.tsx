...
export default function KnowledgeHubClient({ defaultTab }: { defaultTab?: KnowledgeCategory }) {
 ...
 <h2 className="text-2xl md:text-4xl font-black text-foreground tracking-tighter uppercase leading-none">엔터프라이즈 지식 매트릭스</h2>
 </div>
 ...
 <h1 className="text-4xl md:text-6xl font-black text-white tracking-tighter leading-none uppercase ">지식 베이스</h1>
 ...
 <h3 className="text-2xl font-black text-slate-900 tracking-tighter uppercase leading-none">액세스 매트릭스 거부</h3>
 ...
 <span className="text-3xl font-black text-muted-foreground/20 group-hover:text-primary/20 transition-colors w-8 ">{idx + 1}</span>
 ...
 <div className="flex-1 min-w-0">
 <p className="text-xs font-black text-white/90 tracking-tight truncate leading-none mb-1.5 uppercase ">{activity.title}</p>
 ...
 <div>
 <h4 className="text-xl font-black text-slate-900 tracking-tighter uppercase leading-none">인텔리전스 엔진</h4>
...
function StatsCard({ label, value, desc, trend }: { label: string, value: string, desc: string, trend: string }) {
 ...
 <h4 className="text-4xl font-black tracking-tighter text-slate-900 tabular-nums group-hover:text-primary transition-colors">{value}</h4>
...
function CategoryCard({ title, desc, icon, count, color, active, onClick }: any) {
 ...
 <div className="space-y-1">
 <div className="flex items-center justify-between">
 <h3 className="font-black text-2xl tracking-tighter text-slate-900 uppercase leading-none">{title}</h3>
