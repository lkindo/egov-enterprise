...
export default function RoleManagePage() {
 ...
 />
 <Button type="submit" className="h-12 px-10 rounded-lg bg-slate-900 border-none text-white font-bold text-xs tracking-widest shadow-2xl hover:bg-primary transition-all hover:-translate-y-1">패턴 분석</Button>
 </form>
 </div>
 <div>
