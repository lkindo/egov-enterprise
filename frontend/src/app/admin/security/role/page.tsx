            ...
            <FormField label="보안 롤 식별값(Role Code)" required description="보안 레이어 내의 유일한 규칙 식별자">
              <div className="relative group/id">
                ...
                <Input
                  ...
                  className="h-16 pl-16 rounded-xl border-2 text-md font-black italic tracking-widest uppercase shadow-inner"
                  placeholder="롤 식별값"
                />
              </div>
            </FormField>
          ...
          <FormField label="접근 패턴 (URL/Resource Pattern)" required description="보안 필터가 인터셉트할 리소스 경로 규칙">
            <div className="relative group/ptn">
              ...
              <Input
                ...
                className="h-16 pl-16 rounded-xl border-2 text-md font-mono font-black italic shadow-inner"
            ...
            <FormField label="우선순위 (Sort Order)" description="보안 필터 체인에서의 적용 우선순위">
              <div className="relative group/sort">
                ...
                <Input
                  ...
                  className="h-16 pl-16 rounded-xl border-2 text-md font-black italic shadow-inner"
                  placeholder="1"
                />
              </div>
            </FormField>
