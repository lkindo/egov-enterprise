          ...
          {!selectedDept ? (
            ...
            <div className="space-y-6 animate-in fade-in slide-in-from-right-8 duration-700">
              <div className="p-8 bg-gradient-to-br from-primary/10 via-card to-transparent border border-primary/20 rounded-[2.5rem] flex items-center gap-6 shadow-sm shadow-primary/5">
                ...
                <div>
                  <h4 className="text-sm font-black text-primary/60 tracking-widest uppercase mb-1">Batch Policy Setup</h4>
              ...
              <div className="p-5 flex items-center gap-4 text-xs font-bold text-muted-foreground bg-muted/30 rounded-3xl border border-dashed border-border">
