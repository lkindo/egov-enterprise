...
/**
 * Î≥¥Ïïà Í∂åÌïú Îß§Ìä∏Î¶?ä§ ?úÍ∞Å??(Access Control Grid)
 * ??ï†(XÏ∂?Í≥?Î©îÎâ¥(YÏ∂???Í¥ÄÍ≥ÑÎ? ?àÌä∏Îß??§Ì??ºÏùò Í≤©ÏûêÎ°??úÍ∞Å?îÌïò?? * ?úÏä§???ÑÏ≤¥??Î≥¥Ïïà ?âÎ©¥???úÎàà??Ï°∞Í∞ê?òÍ≥† ?úÏñ¥?????àÍ≤å ?©Îãà??
 */
    ...
    <div className={cn(
       ...
       <div className="flex flex-col lg:flex-row items-center justify-between gap-8 bg-slate-900 rounded-[2.5rem] p-10 shadow-2xl relative overflow-hidden group">
          ...
          <div className="flex items-center gap-6 relative z-10 text-center lg:text-left">
             ...
             <div>
                <h3 className="text-2xl font-black text-white tracking-tighter italic uppercase leading-none">Security_Matrix_Observer</h3>
          ...
          <div className="flex items-center gap-6">
              <div className="relative flex-1 group/search">
                  ...
                  <Input 
                      ...
                      placeholder="Î©îÎâ¥ ?∏Îìú Í≤Ä??(Î™ÖÏπ≠, ID)..."
                      value={searchMenu}
                                     ...
                                     <AnimatePresence mode="wait">
                                        {isSelected ? (
                                           ...
                                           >
                                              ...
                                              <span className="text-[9px] font-black text-white/50 tracking-tighter uppercase italic">AUTHORIZED</span>
                                           </motion.div>
                                        ) : (
                                           <motion.div
                                              initial={{ opacity: 0 }}
       ...
       <div className="flex items-center gap-6 p-8 bg-slate-50 border-2 border-slate-100 border-dashed rounded-[2.5rem]">
          ...
          <div className="space-y-1">
             ...
             <p className="text-[11px] font-medium text-slate-400">
                Í∞?Í≤©Ïûê(Cell)Î•??¥Î¶≠?òÏó¨ ?¥Îãπ ??ï†???Ä??Î©îÎâ¥ ?ëÍ∑º Í∂åÌïú???†Í??©Îãà?? Î≥ÄÍ≤ΩÏÇ¨??? ?∞Ï∏° ?ÅÎã®??<span className="text-slate-900 font-black">COMMIT_CHANGES</span> Î≤ÑÌäº???åÎü¨???§Ï†ú ?ÑÌÇ§?çÏ≤ò??Î∞òÏòÅ?©Îãà??
             </p>
          </div>
       </div>
    </div>
