...
export default async function SecurityAuthorityHubPage() {
  ...
  return (
    <Suspense fallback={<div className="p-24 text-center font-mono text-xs tracking-widest uppercase animate-pulse text-hub-indigo">Loading Security Fabric Architecture...</div>}>
