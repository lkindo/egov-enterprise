...
export default function GroupManagePage() {
 ...
 <span className="text-[9px] font-bold text-muted-foreground/40 truncate block max-w-[300px] leading-none">{item.groupDc || '규정 설명이 제공되지 않음'}</span>
 </div>
 )
 },
 {
 ...
 <div>
 <span className="text-[10px] font-black text-muted-foreground/30 tracking-[0.4em] uppercase font-mono ">기능 그룹 테이블 프로브</span>
 </div>
 </div>
