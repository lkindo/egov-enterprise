...
export default async function LoginPolicyPage() {
  ...
  return (
    <Suspense fallback={<div className="p-24 text-center text-xs font-bold tracking-widest text-muted-foreground animate-pulse"><h1 className="sr-only">사용자 로그인 정책을 불러오는 중</h1>사용자·조직 데이터를 불러오는 중입니다...</div>}>
      <UserOrgHubClient 
        defaultTab="POLICIES" 
