  ...
  const columns = [
    {
      ...
      accessor: (item: any) => (
        <div className="flex items-center gap-3">
          ...
          <div>
            <span className="font-black italic uppercase tracking-tighter text-slate-900 block">{item.userNm}</span>
            <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest italic">{item.emplyrId}</span>
          </div>
        </div>
      )
    },
        ...
        return (
            <div className="flex items-center gap-4">
                <div className={cn(
                    ...
                    <span className="text-[9px] font-black uppercase tracking-widest italic">{isAbsent ? 'Absent' : 'Available'}</span>
                </div>
                <Switch 
                    checked={isAbsent} 
    ...
    <div className="max-w-6xl mx-auto space-y-12 px-4 md:px-0 pb-24 animate-in fade-in slide-in-from-bottom-8 duration-1000">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="p-10 rounded-[3rem] bg-emerald-50 border-2 border-emerald-100 shadow-xl shadow-emerald-900/5 group hover:scale-[1.02] transition-all cursor-default relative overflow-hidden">
            ...
            <p className="text-[10px] font-black text-emerald-400 uppercase tracking-[0.3em] mt-2 italic flex items-center gap-2">
        ...
        <div className="p-10 rounded-[3rem] bg-rose-50 border-2 border-rose-100 shadow-xl shadow-rose-900/5 group hover:scale-[1.02] transition-all cursor-default relative overflow-hidden">
            ...
            <p className="text-[10px] font-black text-rose-400 uppercase tracking-[0.3em] mt-2 italic flex items-center gap-2">
      ...
      <div className="responsive-card p-6 md:p-12 border-2 border-slate-100 bg-white/50 backdrop-blur-xl relative overflow-hidden group">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12 relative z-10">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h3 className="text-xl md:text-2xl font-black text-slate-900 uppercase tracking-tighter italic">Status Matrix</h3>
                    <p className="text-[9px] font-black text-slate-400 uppercase tracking-[0.3em]">Resource Availability Control</p>
                </div>
            </div>
            <div className="flex items-center gap-4">
