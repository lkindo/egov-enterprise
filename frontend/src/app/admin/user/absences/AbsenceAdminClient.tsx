      ...
      accessor: (item: any) => {
        ...
        return (
          <div className="flex items-center gap-6 py-4">
            <div className={cn(
              "w-16 h-11 rounded-lg flex items-center justify-center text-white shadow-2xl transition-all duration-700 relative overflow-hidden group-hover:scale-110",
          ...
          <div className="rounded-lg p-12 bg-slate-900 text-white shadow-2xl relative overflow-hidden group h-full border-none">
            ...
            <div className="relative z-10 space-y-12">
              <div className="space-y-3">
                ...
                <h4 className="text-3xl font-bold tracking-tighter leading-tight uppercase text-primary text-left">가용성<br />인텔리전스</h4>
              </div>
