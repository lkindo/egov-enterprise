...
export default async function DeptManagePage() {
  ...
  return (
    <Suspense fallback={<div className="p-6 text-center text-[length:var(--font-size-body)] text-muted-foreground"><h1 className="sr-only">부서 관리를 불러오는 중</h1>사용자·조직 데이터를 불러오는 중입니다...</div>}>
      <UserOrgHubClient 
        defaultTab="DEPTS" 
