          ...
          <div className="flex items-center gap-5 flex-1">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-center gap-3 mt-1">
                ...
                {item.orgnztDc && (
                  <span className={cn(
                    "text-[10px] font-bold truncate max-w-[200px] italic",
        ...
        <div className="space-y-10 pt-4 text-left">
          ...
          <div className="p-8 rounded-xl bg-indigo-50/30 border-2 border-indigo-100/50 flex items-start gap-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[10px] font-bold text-indigo-700/60 leading-relaxed italic uppercase text-left">구성된 노드는 시스템 아키텍처에 따라 자동 배치됩니다.</p>
            </div>
          </div>
        </div>
      </StandardModal>
