...
export default function DeptAdminClient({ 
 ...
 <span className="font-mono font-black text-slate-400 italic text-[10px] tracking-tight">{item.orgnztId}</span>
 )
 },
 {
 header: '부서 명',
 ...
 <span className="font-black italic tracking-tighter text-slate-900">{item.orgnztNm}</span>
 </div>
 )
 },
 {
 ...
 <div>
 <h3 className="text-xl md:text-2xl font-black text-slate-900 tracking-tighter italic">Structural Assets</h3>
 <p className="text-[9px] font-black text-slate-400 tracking-[0.3em]">Managed Department Data</p>
 </div>
 </div>
 <div className="flex items-center gap-4">
 ...
 <label className="text-[10px] font-black text-slate-400 tracking-tight italic ml-2">Department Designation</label>
 <Input
 ...
 <div className="space-y-3">
 <label className="text-[10px] font-black text-slate-400 tracking-tight italic ml-2">Description Payload</label>
 <Textarea
