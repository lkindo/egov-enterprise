    ...
    <div className="space-y-12 pb-24 animate-in fade-in duration-1000 font-sans">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8 px-2">
        <div className="space-y-3">
          <div className="flex items-center gap-3">
             ...
             <span className="text-[10px] font-black tracking-[0.4em] text-primary uppercase leading-none">?ÑÏπò Í≥µÍ∞Ñ Îß§Ìä∏Î¶?ä§ (Rough Map Engine)</span>
          </div>
          <h2 className="text-3xl md:text-5xl font-black text-slate-900 tracking-tighter uppercase italic leading-none flex items-center gap-3">
            ?ΩÎèÑ ÏßÄÎ¶?Í¥ÄÎ¶?<Navigation className="text-primary" />
          </h2>
          <p className="text-xs font-bold text-slate-400 tracking-tight mt-2 max-w-lg">?êÍ≥†Î∏??îÌÑ∞?ÑÎùº?¥Ï¶à???úÏÑ§ Î∞?Í±∞Ï†ê ?ïÎ≥¥Î•?ÏßÄÍ∞?Í∞Ä?•Ìïú ?úÎìúÎßàÌÅ¨Î°?Í¥ÄÎ¶¨Ìïò??Í≥µÍ∞Ñ ?∏ÌÖîÎ¶¨Ï†Ñ???ºÌÑ∞?ÖÎãà??</p>
        </div>
      ...
      <div className="grid grid-cols-12 gap-10 px-2 h-auto lg:h-[600px]">
              ...
              <div className="flex-1 overflow-y-auto p-10 space-y-4 scrollbar-elegant">
                 {isLoading ? (
                    ...
                    <motion.div 
                      layout
                      key={map.roughMapId} 
                      className="p-6 bg-white border border-slate-50 rounded-[2rem] hover:ring-[15px] hover:ring-primary/5 hover:border-primary/20 transition-all cursor-pointer group flex items-center justify-between"
                    >
                       <div className="flex items-center gap-5">
                          <div className="w-12 h-12 rounded-[1.2rem] bg-slate-900 flex items-center justify-center text-white group-hover:bg-primary transition-colors pr-2">
        ...
        <div className="col-span-12 lg:col-span-7 h-full">
           <Card className="h-full rounded-[4rem] border-0 bg-slate-50 shadow-2xl overflow-hidden relative group ring-1 ring-slate-900/5">
              ...
              <div className="absolute top-12 left-12 z-20 space-y-4">
                 <div className="p-6 bg-white/90 backdrop-blur-xl rounded-3xl border border-white shadow-2xl space-y-3 max-w-[280px]">
                 ...
                 {displayItems.slice(0, 5).map((map, i) => (
                    ...
                    >
                       <div className="relative group/pin cursor-pointer">
                          ...
                          <div className="w-10 h-10 bg-slate-900 text-white rounded-2xl flex items-center justify-center shadow-2xl border-2 border-white group-hover/pin:bg-primary transition-all rotate-45 -translate-y-4 group-hover/pin:-translate-y-6">
              ...
              <div className="absolute bottom-12 right-12 flex gap-4">
                 ...
                 <Button className="h-14 px-10 rounded-2xl bg-slate-900 text-white font-black tracking-[0.3em] text-[10px] shadow-[0_20px_50px_rgba(0,0,0,0.3)] hover:bg-primary transition-all uppercase italic">Í≥µÍ∞Ñ ?úÎ??àÏù¥???§Ìñâ</Button>
              </div>
           </Card>
        </div>
      </div>
