...
export default function RoughMapManagementClient() {
 ...
 <h2 className="text-3xl md:text-5xl font-black text-slate-900 tracking-tighter uppercase leading-none flex items-center gap-3">
 ...
 <h3 className="text-xl font-black text-slate-900 tracking-tighter leading-none">{displayItems[0]?.roughMapSj || 'Select Node'}</h3>
 ...
 <Button className="h-14 px-10 rounded-xl bg-slate-900 text-white font-black tracking-[0.3em] text-[10px] shadow-[0_20px_50px_rgba(0,0,0,0.3)] hover:bg-primary transition-all uppercase ">공간 시뮬레이션 실행</Button>
 </div>
 </Card>
 </div>
 </div>
