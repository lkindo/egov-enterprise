...
export default function RoughMapManagementClient() {
 ...
 <span className="text-xs font-bold tracking-[0.4em] text-primary uppercase leading-none">��ġ ���� ��Ʈ���� (Rough Map Engine)</span>
 </div>
 <h2 className="text-3xl md:text-5xl font-bold text-slate-900 tracking-tight uppercase leading-none flex items-center gap-3">
 �൵ ���� ���� <Navigation className="text-primary" />
 </h2>
 <p className="text-xs font-bold text-slate-400 tracking-tight mt-2 max-w-lg">eGov ������������ �ü� �� ���� ������ ���������� �����ϴ� ���� ���ڸ����� �����Դϴ�.</p>
 </div>
 ...
 <Map size={64} />
 <span className="font-bold text-lg tracking-tight uppercase">NO MAP ASSETS FOUND</span>
 </div>
 ...
 <h4 className="text-base font-bold text-slate-900 tracking-tight group-hover:text-primary transition-colors">{map.roughMapSj}</h4>
 ...
 <h3 className="text-xl font-bold text-slate-900 tracking-tight leading-none">{displayItems[0]?.roughMapSj || 'Select Node'}</h3>
 ...
 <Button className="h-11 px-10 rounded-lg bg-slate-900 text-white font-bold tracking-[0.3em] text-xs shadow-[0_20px_50px_rgba(0,0,0,0.3)] hover:bg-primary transition-all uppercase ">���� �ùķ��̼� ����</Button>
 </div>
 </Card>
 </div>
 </div>
