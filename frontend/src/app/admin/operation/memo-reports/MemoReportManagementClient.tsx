...
export default function MemoReportManagementClient() {
 ...
 <Button className="h-11 px-8 rounded-lg bg-slate-100 text-slate-900 font-bold tracking-widest text-xs uppercase hover:bg-slate-200 transition-all gap-3 border shadow-sm">
 ...
 <FileText size={64} />
 <span className="font-bold text-xl tracking-tighter uppercase ">NO DATA UNITS</span>
 </div>
 ) : (
 <>
 ...
 <h4 className="text-base font-bold tracking-tighter truncate leading-none mb-1 text-ellipsis overflow-hidden">{report.reprtSj}</h4>
 ...
 <span className="text-xs font-bold text-primary uppercase tracking-[0.4em] leading-none">리포트 분석 뷰 (Analytical View)</span>
 <h3 className="text-2xl font-bold tracking-tighter ">{selectedReport.reprtSj}</h3>
 </div>
 ...
 <div className="space-y-1">
 <p className="text-xs font-bold text-white/30 uppercase tracking-widest">작성 노드</p>
 <div className="flex items-center gap-3 font-bold text-lg tracking-tighter">
 <div className="w-6 h-6 rounded-lg bg-primary" /> {selectedReport.wrterNm}
 </div>
 </div>
 <div className="w-[1px] h-10 bg-white/5" />
 <div className="space-y-1">
 <p className="text-xs font-bold text-white/30 uppercase tracking-widest">수신 대상</p>
 <div className="flex items-center gap-3 font-bold text-lg tracking-tighter">
 ...
 <p className="text-xs font-bold text-white/30 uppercase tracking-widest">운영 날짜</p>
 <p className="text-lg font-bold tabular-nums tracking-tighter">{selectedReport.reprtDe}</p>
 </div>
 </div>
 ...
 <Button className="h-11 flex-1 rounded-lg bg-white text-slate-900 font-bold tracking-[0.2em] text-xs hover:scale-105 transition-all shadow-2xl">상세 수정</Button>
 <Button className="h-11 flex-[2] rounded-lg bg-primary text-white font-bold tracking-[0.4em] text-xs hover:scale-105 transition-all shadow-2xl shadow-primary/40 uppercase ">지시사항 등록</Button>
 </div>
 </Card>
 </motion.div>
 ) : (
 ...
 <h3 className="text-2xl font-bold text-slate-900 tracking-tighter uppercase ">SELECT REPORT NODE</h3>
 <p className="text-xs font-bold text-slate-400 tracking-[0.5em] mt-2 leading-relaxed">데이터 흐름 확인하려면 <br /> 좌측 스트림에서 리포트를 선택하세요</p>
 </div>
 )}
 </AnimatePresence>
 </div>
