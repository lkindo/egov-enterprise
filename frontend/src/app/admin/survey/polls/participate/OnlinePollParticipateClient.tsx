                                ...
                                <div className="relative z-10 space-y-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="px-4 py-1 bg-primary/20 rounded-full border border-primary/20 flex items-center gap-2">
                                            ...
                                            <span className="text-[10px] font-black tracking-tighter uppercase font-mono italic">{selectedPoll.pollBeginDe} - {selectedPoll.pollEndDe}</span>
                                        </div>
                                    </div>
    ...
    return (
        ...
        >
            ...
            <div className="space-y-4">
                ...
                <div className="flex items-center gap-3 font-mono text-[11px] font-black text-slate-400 tracking-tighter italic">
