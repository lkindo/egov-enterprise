...
export default function OnlinePollAdminClient({ 
 ...
 header: '기간',
 accessor: (item: OnlinePollDto) => (
 <div className="flex items-center gap-3 font-mono text-[11px] font-black text-muted-foreground/60 tracking-tighter ">
 ...
 <label className="text-[11px] font-black text-slate-400 tracking-[0.2em] uppercase ml-2">시작일시</label>
 ...
 <div className="space-y-4">
 <label className="text-[11px] font-black text-slate-400 tracking-[0.2em] uppercase ml-2">종료일시</label>
 <div className="relative group">
 <Calendar className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-300 group-focus-within:text-primary transition-colors" size={18} />
 <Input
 type="date"
