  ...
  return (
    <div className="p-8 space-y-10 animate-in fade-in duration-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="rounded-[2rem] border-none shadow-sm bg-slate-900 text-white p-8 space-y-4 text-left">
            ...
            <Card className="rounded-[2rem] border-none shadow-sm bg-white p-8 space-y-4 ring-1 ring-slate-100 text-left">
            ...
            <Card className="rounded-[2rem] border-none shadow-sm bg-white p-8 space-y-4 ring-1 ring-slate-100 text-left">
                <div className="w-12 h-12 rounded-2xl bg-slate-100 flex items-center justify-center text-left">
            ...
            <form onSubmit={handleSearch} className="flex flex-col md:flex-row items-center gap-4">
                <div className="relative flex-1 w-full group">
                    ...
                    <Input
                        ...
                        className="h-14 pl-14 rounded-2xl border-2 border-transparent bg-white shadow-sm focus:border-amber-500 focus:ring-0 transition-all font-bold text-left"
