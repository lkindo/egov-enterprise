    ...
    <div className="p-6 max-w-4xl mx-auto space-y-8 animate-in fade-in duration-700">
      <div className="flex items-center justify-between">
        <Button variant="ghost" onClick={() => router.back()} className="rounded-lg font-bold gap-2 hover:bg-slate-100 transition-all">
            <ArrowLeft className="w-4 h-4" /> ?�로가�?        </Button>
      </div>
      ...
      <Card className="border-none shadow-[0_32px_64px_-12px_rgba(0,0,0,0.08)] overflow-hidden rounded-lg bg-white ring-1 ring-slate-100">
        <CardHeader className="bg-slate-900 pb-12 pt-12 px-10 text-white relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-2">
                ...
                <CardTitle className="text-3xl font-bold tracking-tight capitalize ">?�문 ?�록</CardTitle>
                <p className="text-slate-400 font-medium lowercase">?�로???�라???�문???�격??맞게 ?�록?�니??</p>
            </div>
        </CardHeader>
        <CardContent className="p-10 space-y-10">
          <div className="space-y-3">
            <Label htmlFor="pollNm" className="text-sm font-bold text-slate-500 ml-1">?�문�?(?�수)</Label>
            <Input
              id="pollNm"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-3">
              <Label className="text-sm font-bold text-slate-500 ml-1">?�작??/Label>
              <Popover>
            ...
            <div className="space-y-3">
              <Label className="text-sm font-bold text-slate-500 ml-1">종료??/Label>
              <Popover>
                <PopoverTrigger asChild>
                  <Button
                    variant={"outline"}
          ...
          <div className="space-y-3">
            <Label className="text-sm font-bold text-slate-500 ml-1">?�문 ?�형</Label>
            <Select
            ...
            >
              ...
              <SelectContent className="rounded-lg border-none shadow-2xl">
                <SelectItem value="001" className="font-bold py-3 text-slate-700">?�� ?�반 ?�문</SelectItem>
                <SelectItem value="002" className="font-bold py-3 text-slate-700">?���??�표</SelectItem>
              </SelectContent>
            </Select>
          </div>
