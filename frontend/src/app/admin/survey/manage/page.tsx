    ...
    <div className="p-8 space-y-10 animate-in fade-in duration-700">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-2">
          ...
          <h1 className="text-4xl font-bold tracking-tighter text-foreground ">온라인 설문 <span className="text-primary">관리</span></h1>
      ...
      <Card className="border-none shadow-[0_32px_64px_-12px_rgba(0,0,0,0.08)] overflow-hidden rounded-lg bg-white ring-1 ring-slate-100">
        <CardHeader className="bg-slate-50/50 border-b p-8">
          <form onSubmit={handleSearch} className="flex flex-col md:flex-row items-center gap-4">
            ...
            <Button type="submit" className="h-11 px-10 rounded-lg bg-white border-2 border-slate-200 text-slate-900 font-bold text-sm hover:bg-slate-50 hover:border-slate-300 shadow-sm transition-all active:scale-95">조회하기</Button>
          </form>
        </CardHeader>
          ...
          <Table>
            <TableHeader className="bg-slate-50/50">
              <TableRow className="hover:bg-transparent">
                ...
                <TableHead className="font-bold text-slate-900 text-xs py-6 px-4">설문 정보 (Survey Name)</TableHead>
                <TableHead className="w-[250px] font-bold text-slate-400 text-xs py-6 text-center">기간 (Period)</TableHead>
                <TableHead className="w-[120px] font-bold text-slate-400 text-xs py-6 text-center">상태</TableHead>
                <TableHead className="w-[150px] font-bold text-slate-400 text-xs py-6 text-center">등록자</TableHead>
                <TableHead className="w-[150px] font-bold text-slate-400 text-xs py-6 text-center">등록일</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {isLoading ? (
                ...
                polls.map((poll, index) => (
                  ...
                  >
                    ...
                    <TableCell className="text-center py-6">
                      <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-slate-100 rounded-lg text-slate-500 font-bold text-xs">
