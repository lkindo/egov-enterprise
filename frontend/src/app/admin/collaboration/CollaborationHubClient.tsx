...
export default function CollaborationHubClient({ defaultTab = 'MESSAGES' }: CollaborationHubClientProps) {
 ...
 <h4 className={cn("text-lg font-bold tracking-tight leading-none", selectedItemId === note.noteId ? "text-white" : "text-slate-900")}>
 {note.noteSj}
 </h4>
 ...
 <div className={cn(
 "w-16 h-10 rounded-lg flex items-center justify-center font-bold text-2xl border-2 transition-all shadow-inner",
 selectedItemId === address.adbkId 
 ...
 <h4 className="text-xl font-bold tracking-tight leading-none">{address.adbkNm}</h4>
 ...
 <h4 className={cn("text-lg font-bold tracking-tight leading-none", selectedItemId === scrap.scrapId ? "text-white" : "text-slate-900")}>
 {scrap.scrapNm}
 </h4>
 ...
 <span className="text-xs font-bold tracking-[0.5em] text-primary uppercase leading-none px-3 py-1 bg-primary/5 rounded-full border border-primary/10">Collaboration Hub</span>
 </div>
 ...
 className="h-10 px-8 rounded-lg border-2 border-slate-200 bg-white text-slate-900 font-bold tracking-widest text-xs uppercase hover:bg-slate-50 hover:scale-105 active:scale-95 transition-all shadow-xl gap-3 group"
 >
 ...
 className="h-10 px-10 rounded-lg bg-slate-900 text-white font-bold tracking-widest text-xs uppercase hover:scale-105 active:scale-95 transition-all shadow-2xl gap-3 group"
 >
 ...
 <p className="text-5xl font-bold tracking-tight text-slate-900">99.9%</p>
 ...
 <div className="space-y-1">
 <h2 className="text-2xl font-bold text-slate-900 tracking-tight leading-none uppercase">Intelligence Detail</h2>
 <p className="text-xs font-bold text-slate-400 tracking-widest uppercase ">Node_ID: {selectedItemId}</p>
 </div>
 </div>
 <Badge className="bg-primary/10 text-primary border-primary/20 font-bold text-xs px-3 py-1.5 rounded-full uppercase tracking-widest ">Verified Node</Badge>
 </div>
 ...
 <Button className="flex-1 h-10 rounded-lg bg-slate-900 text-white font-bold tracking-widest text-xs uppercase shadow-2xl hover:scale-[1.02] active:scale-95 transition-all gap-3">
 ...
 className="h-10 w-16 rounded-lg border-2 border-slate-200 text-slate-400 hover:text-rose-500 hover:border-rose-500/20 hover:bg-rose-50 transition-all shadow-xl"
 >
 ...
 <h3 className="text-3xl font-bold text-slate-900 tracking-tight leading-none uppercase opacity-30">
 Select Data Node
 </h3>
...
function NavButton({ icon, label, active, count, onClick, dataTestId }: { icon: any, label: string, active: boolean, count: number, onClick: () => void, dataTestId?: string }) {
 ...
 <div className="flex items-center gap-5">
 <div className={cn(
 "w-12 h-10 rounded-lg flex items-center justify-center transition-all shadow-inner border",
...
function NoteDetail({ note }: { note: any }) {
 ...
 <div className="flex items-center gap-4">
 <div className="w-12 h-10 rounded-full bg-slate-100 flex items-center justify-center font-bold text-slate-400 ">
 ...
 <div className="space-y-4">
 <h3 className="text-3xl font-bold text-slate-900 tracking-tight leading-tight underline decoration-primary/20 underline-offset-8">
 {note.noteSj}
 </h3>
...
function AddressDetail({ address }: { address: any }) {
 ...
 <h3 className="text-4xl font-bold text-slate-900 tracking-tight leading-none uppercase">{address.adbkNm}</h3>
...
function InfoRow({ icon: Icon, label, value }: { icon: any, label: string, value: string }) {
 ...
 <div className="flex items-center gap-5">
 <div className="w-12 h-10 rounded-lg bg-slate-50 flex items-center justify-center text-slate-400 group-hover/row:text-primary transition-colors">
 <Icon size={20} />
 </div>
