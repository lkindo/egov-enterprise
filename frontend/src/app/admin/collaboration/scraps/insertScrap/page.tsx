        ...
        <form onSubmit={handleSubmit}>
          <CardHeader className="border-b bg-gradient-to-tr from-indigo-50 via-slate-50 to-white pb-12 pt-12 px-10">
            <div className="flex items-center gap-5">
              <div className="p-4 bg-indigo-600 rounded-xl shadow-xl shadow-indigo-200 animate-bounce-slow">
            ...
            <div className="grid gap-8">
              ...
              <div className="group space-y-3">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="h-14 pl-16 rounded-xl border-2 border-slate-100 bg-slate-50/30 focus:bg-white focus:ring-4 focus:ring-indigo-100 focus:border-indigo-600 transition-all font-bold"
                  />
                </div>
              </div>
              ...
              <div className="group space-y-3">
                ...
                <Textarea
                  ...
                  className="min-h-[180px] p-6 rounded-xl border-2 border-slate-100 bg-slate-50/30 focus:bg-white focus:ring-4 focus:ring-indigo-100 focus:border-indigo-600 transition-all font-medium leading-relaxed resize-none shadow-inner"
                />
              </div>
            </div>

            <div className="p-6 bg-slate-50 rounded-xl flex items-start gap-4 border border-slate-100">
          ...
          <CardFooter className="p-10 border-t bg-slate-50/50 flex flex-col md:flex-row gap-4">
            <Button
              ...
              variant="outline"
              onClick={() => router.back()}
              className="w-full md:w-auto h-16 px-10 rounded-xl border-2 font-black text-slate-600 hover:bg-slate-100 transition-all flex items-center gap-2 group"
            >
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full md:flex-1 h-16 rounded-xl font-black text-lg shadow-xl shadow-indigo-100 bg-indigo-600 hover:bg-indigo-700 hover:-translate-y-1 transition-all flex items-center gap-3 group"
            >
              {loading ? (
                <>
