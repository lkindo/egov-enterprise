...
export default function AddressBookInsertHubClient() {
 ...
 <span className="text-xs font-bold tracking-[0.5em] text-primary uppercase leading-none px-3 py-1 bg-primary/5 rounded-full border border-primary/10">Organizational Network</span>
 </div>
