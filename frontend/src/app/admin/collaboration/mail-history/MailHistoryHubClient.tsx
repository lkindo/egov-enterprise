...
export default function MailHistoryHubClient() {
 ...
 <div className="space-y-1">
 <h2 className="text-2xl font-black text-slate-900 tracking-tighter leading-none uppercase">Mail Intelligence</h2>
 <p className="text-[9px] font-black text-slate-400 tracking-widest uppercase ">ID: {selectedItemId}</p>
 </div>
 </div>
 <Badge className="bg-primary/10 text-primary border-primary/20 font-black text-[9px] px-3 py-1.5 rounded-full uppercase tracking-widest ">Verified Logs</Badge>
 </div>
 ...
 <h3 className="text-3xl font-black text-slate-900 tracking-tighter underline decoration-primary/20 underline-offset-8 leading-tight">
 {selectedItem?.sj}
 </h3>
