...
export default function MailHistoryHubClient() {
 ...
 <span className="text-xs font-bold tracking-[0.5em] text-primary uppercase leading-none px-3 py-1 bg-primary/5 rounded-full border border-primary/10">Mail Archive</span>
 </div>
 ...
 <h4 className={cn("text-lg font-bold tracking-tight leading-none truncate max-w-[200px]", selectedItemId === mail.mssageId ? "text-white" : "text-slate-900")}>
 {mail.sj}
 </h4>
 ...
 <Badge className="bg-emerald-500/10 text-emerald-500 border-none font-bold text-xs px-2">SUCCESS</Badge>
 </div>
 ) : (
 <Badge className="bg-rose-500/10 text-rose-500 border-none font-bold text-xs px-2">FAILED</Badge>
 )}
 </div>
 </motion.div>
 ))}
 ...
 className="h-full"
 >
 <div className="hub-glass-premium h-full rounded-lg border-2 border-primary/20 shadow-2xl overflow-hidden flex flex-col bg-white">
 ...
 <div className="space-y-1">
 <h2 className="text-2xl font-bold text-slate-900 tracking-tight leading-none uppercase">Mail Intelligence</h2>
 <p className="text-xs font-bold text-slate-400 tracking-widest uppercase ">ID: {selectedItemId}</p>
 </div>
 </div>
 <Badge className="bg-primary/10 text-primary border-primary/20 font-bold text-xs px-3 py-1.5 rounded-full uppercase tracking-widest ">Verified Logs</Badge>
 </div>
 ...
 <h3 className="text-3xl font-bold text-slate-900 tracking-tight underline decoration-primary/20 underline-offset-8 leading-tight">
 {selectedItem?.sj}
 </h3>
 <div className="p-10 rounded-lg bg-slate-50 border border-slate-100 shadow-inner min-h-[200px]">
 ...
 variant="outline"
 className="h-12 w-full rounded-lg border-2 border-slate-200 text-slate-400 hover:text-rose-500 hover:border-rose-500/20 hover:bg-rose-50 transition-all shadow-xl font-bold tracking-widest text-xs uppercase gap-3"
 >
