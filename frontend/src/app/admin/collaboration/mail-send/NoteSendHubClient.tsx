...
export default function NoteSendHubClient() {
 ...
 <span className="text-xs font-bold tracking-[0.5em] text-primary uppercase leading-none px-3 py-1 bg-primary/5 rounded-lg border border-primary/10">Secure Communications</span>
 </div>
