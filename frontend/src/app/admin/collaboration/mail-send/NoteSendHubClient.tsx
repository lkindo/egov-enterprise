...
export default function NoteSendHubClient() {
 ...
 <span className="text-xs font-bold tracking-tight text-primary leading-none px-3 py-1 bg-primary/5 rounded-lg border border-primary/10">Secure Communications</span>
 </div>
 ...
 >
 <div className="flex items-center gap-4">
 <div className="w-12 h-12 rounded-lg bg-primary/20 flex items-center justify-center font-bold text-xl border border-white/10">
 {selectedRecipient.name.charAt(0)}
 </div>
 <div className="space-y-0.5">
 <p className="text-lg font-bold tracking-tight leading-none">{selectedRecipient.name}</p>
 <p className="text-xs font-bold opacity-40 tracking-tight">{selectedRecipient.id}</p>
 </div>
 </div>
 <Button 
 type="button" 
 ...
 className="h-11 text-xl font-bold tracking-tight bg-slate-50 border-none rounded-lg focus-visible:ring-2 focus-visible:ring-primary/20 transition-all placeholder:text-slate-300"
 ...
 >
 <div className="flex items-center gap-4">
 <div className="w-10 h-10 rounded-lg bg-slate-50 flex items-center justify-center font-bold text-slate-300 group-hover:bg-primary group-hover:text-white transition-all">
 ...
 <h3 className="text-sm font-bold text-slate-900 tracking-tight transition-colors">Intelligence Payload</h3>
 </div>
 <div className="flex items-center gap-2">
 <div className="w-2 h-2 rounded-lg bg-primary animate-pulse" />
 <span className="text-xs font-bold text-muted-foreground tracking-tight">Encrypted Stream Ready</span>
 </div>
 </div>
 <Textarea
 value={form.noteCn}
