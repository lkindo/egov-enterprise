...
export default function MailSendHubClient() {
 ...
 recptnPerson: selectedRecipient.email || selectedRecipient.id,
 sj: form.sj,
 ...
 >
 <div className="flex items-center gap-4">
 <div className="w-12 h-12 rounded-full bg-primary/20 flex items-center justify-center font-black text-xl border border-white/10">
 {selectedRecipient.name.charAt(0)}
 </div>
 <div className="space-y-0.5">
 <p className="text-lg font-black tracking-tight leading-none">{selectedRecipient.name}</p>
 <p className="text-[10px] font-bold opacity-40 uppercase tracking-widest">{selectedRecipient.email || selectedRecipient.id}</p>
 </div>
 </div>
 <Button 
 type="button" 
