      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b-2 border-border/50 pb-12">
        ...
        <div className="flex items-center gap-3 relative z-10">
          ...
          <form action={async (formData) => {
            ...
            if (res.success) {
              toast('ÏßÄ???êÏÇ∞????†ú?òÏóà?µÎãà??', 'success');
        ...
        <div className="relative bg-white dark:bg-muted/10 rounded-[4rem] p-16 md:p-24 border-2 border-border/40 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.05)] overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl mx-auto space-y-16">
            <div className="flex items-center gap-4">
              ...
              <p className="text-[10px] font-black tracking-[0.6em] text-primary uppercase leading-none italic">Í≤ÄÏ¶ùÎêú ÏßÄ???∞Ïù¥?∞ÏÖã</p>
            </div>
        ...
        <div className="hub-card-premium p-12 bg-slate-900 border-none text-white shadow-2xl relative overflow-hidden group">
          ...
          <div className="relative z-10 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {/* ??Î∂ÄÎ∂ÑÏ? ?§Ï†ú ?åÏùº Î¶¨Ïä§??Î°úÏßÅ???àÎã§Î©??∞Îèô */}
