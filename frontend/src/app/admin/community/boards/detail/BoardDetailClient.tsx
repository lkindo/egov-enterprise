...
export function BoardDetailClient({ dataPromise }: BoardDetailClientProps) {
 ...
 <span className="text-xs font-bold tracking-widest uppercase">Return to Hub</span>
 </Button>
 ...
 <h1 className="text-3xl md:text-4xl font-bold text-foreground tracking-tight leading-tight uppercase max-w-4xl">
 ...
 className="h-12 px-6 rounded-lg border-2 font-bold text-xs tracking-widest uppercase gap-3 shadow-xl hover:-translate-y-1 transition-all"
 >
 ...
 type="submit"
 variant="outline"
 className="h-12 w-12 rounded-lg border-2 text-rose-500 border-rose-100 hover:bg-rose-500 hover:text-white shadow-xl hover:-translate-y-1 transition-all"
 >
 <Trash2 size={20} />
 </Button>
 </form>
 ...
 <p className="text-xs font-bold tracking-widest text-primary uppercase leading-none ">
 ...
 <div
 className={cn(
 "prose prose-lg dark:prose-invert prose-slate max-w-none transition-all duration-700",
 ...
 "prose-p:my-10",
 "prose-blockquote:border-l-[6px] prose-blockquote:border-primary prose-blockquote:bg-primary/5 prose-blockquote:px-12 prose-blockquote:py-10 prose-blockquote:rounded-r-lg prose-blockquote:",
