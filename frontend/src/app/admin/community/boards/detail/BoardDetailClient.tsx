...
export function BoardDetailClient({ dataPromise }: BoardDetailClientProps) {
 ...
 <p className="text-[10px] font-black tracking-widest text-muted-foreground uppercase">Knowledge Node Not Found</p>
 ...
 <h1 className="text-5xl md:text-6xl font-black text-foreground tracking-tighter leading-[0.9] uppercase max-w-4xl">
 ...
 className="h-16 px-8 rounded-xl border-2 font-black text-[11px] tracking-widest uppercase gap-3 shadow-xl hover:-translate-y-1 transition-all"
 >
 ...
 type="submit"
 variant="outline"
 className="h-16 w-16 rounded-xl border-2 text-rose-500 border-rose-100 hover:bg-rose-500 hover:text-white shadow-xl hover:-translate-y-1 transition-all"
 >
 <Trash2 size={24} />
 </Button>
 </form>
 ...
 {/* --- Meta Info Bar --- */}
 <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 p-10 bg-slate-50 dark:bg-muted/10 rounded-xl border-border/40 border">
 ...
 <div className="relative bg-white dark:bg-muted/10 rounded-xl p-16 md:p-24 border-2 border-border/40 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.05)] overflow-hidden">
 ...
 <p className="text-[10px] font-black tracking-[0.6em] text-primary uppercase leading-none ">
 ...
 "prose-code:bg-slate-100 prose-code:p-1 prose-code:rounded prose-pre:bg-slate-900 prose-pre:p-8 prose-pre:rounded-xl"
 )}
 ...
 <div className="flex items-center gap-4">
 <div className="w-12 h-12 rounded-xl bg-white/10 flex items-center justify-center text-primary border border-white/5">
 <Download size={24} />
 </div>
 <p className="text-[11px] font-black tracking-widest uppercase">Associated Data Assets</p>
 </div>
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
 <div className="flex items-center justify-between p-6 bg-white/5 rounded-xl border border-white/10 hover:bg-white hover:text-slate-900 transition-all cursor-pointer group/file">
 <div className="flex items-center gap-4">
...
function MetaItem({ icon, label, value }: { icon: React.ReactNode, label: string, value: string }) {
 ...
 <div className="w-12 h-12 rounded-xl bg-white dark:bg-muted flex items-center justify-center text-primary shadow-lg border border-border/50 transition-all group-hover:rotate-12">
 {icon}
 </div>
