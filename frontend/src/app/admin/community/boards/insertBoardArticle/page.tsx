...
export default function InsertBoardArticlePage() {
 ...
 variant="outline"
 onClick={() => router.back()}
 className="w-16 h-11 rounded-lg border-2 group hover:bg-slate-900 transition-all duration-500 shadow-xl active:scale-95"
 >
 <ArrowLeft className="group-hover:text-white group-hover:-translate-x-1 transition-all" />
 </Button>
 <div className="space-y-2">
 <div className="flex items-center gap-3">
 <span className="text-xs font-bold tracking-[0.5em] text-primary uppercase leading-none px-3 py-1 bg-primary/5 rounded-lg border border-primary/10">Enterprise Intelligence</span>
 </div>
 <h1 className="text-4xl font-bold text-slate-900 dark:text-white tracking-tighter uppercase leading-none transition-colors">New Knowledge Asset</h1>
 </div>
 </div>
 ...
 className="h-11 bg-transparent border-none text-slate-900 dark:text-white text-3xl font-bold placeholder:text-slate-900/10 dark:placeholder:text-white/10 focus-visible:ring-0 p-0 tracking-tight"
 ...
 <h3 className="text-sm font-bold text-slate-900 dark:text-white uppercase tracking-widest transition-colors">지식 노드 콘텐츠</h3>
 </div>
 <div className="flex items-center gap-2">
 <div className="w-2 h-2 rounded-lg bg-emerald-500 animate-pulse" />
 <span className="text-xs font-bold text-muted-foreground uppercase tracking-widest">실시간 동기화 준비됨</span>
 </div>
 </div>
 ...
 variant="outline"
 onClick={() => router.back()}
 className="h-11 flex-1 sm:flex-none px-10 rounded-lg border-2 font-bold tracking-widest text-xs uppercase hover:bg-slate-50 transition-all"
 >
 Cancel
 </Button>
 <Button
 ...
 className="h-11 flex-1 sm:flex-none px-12 rounded-lg bg-primary text-white font-bold tracking-widest text-xs uppercase hover:scale-105 active:scale-95 transition-all shadow-xl shadow-primary/20 gap-3 group"
 >
 {isSubmitting ? (
 ...
 <div className="inline-flex items-center gap-3 px-6 py-2 bg-slate-50 rounded-lg border border-border/50">
