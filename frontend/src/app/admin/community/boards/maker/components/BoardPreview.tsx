...
const MOCK_POSTS = [
  { id: 1, title: '?ÑÏûê?ïÎ? ?úÏ??ÑÎ†à?ÑÏõå??4.x ?ÖÎç∞?¥Ìä∏ Í∞Ä?¥Îìú?ºÏù∏', author: 'Í¥ÄÎ¶¨Ïûê', date: '2024-05-20', views: 1240, comments: 45, image: 'https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=800&q=80' },
  { id: 2, title: 'Î¶¨Ïï°???úÎ≤Ñ Ïª¥Ìè¨?åÌä∏(RSC) ?ÑÏûÖ ??Ï£ºÏùò?¨Ìï≠ Î∞?Î™®Î≤î ?¨Î?', author: 'Í∏∞Ïà†?ÅÏã†?Ä', date: '2024-05-19', views: 856, comments: 23, image: 'https://images.unsplash.com/photo-1633356122544-f134324a6cee?w=800&q=80' },
  { id: 3, title: 'MSA ?òÍ≤Ω?êÏÑú??Î∂ÑÏÇ∞ ?∏Îûú??Öò Ï≤òÎ¶¨ ?ÑÎûµ (Saga ?®ÌÑ¥)', author: '?åÎû´?ºÏã§', date: '2024-05-18', views: 2301, comments: 67, image: 'https://images.unsplash.com/photo-1558494949-ef010958384e?w=800&q=80' },
];
