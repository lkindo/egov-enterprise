...
const authorData = [
  { name: 'Í¥ÄÎ¶¨Ïûê', value: 400 },
  { name: '?¨Ïö©?êA', value: 300 },
  { name: '?¨Ïö©?êB', value: 200 },
  { name: 'Í∏∞Ì?', value: 100 },
];
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
      ...
      <Card className="lg:col-span-2 border-none shadow-lg rounded-lg overflow-hidden ring-1 ring-slate-100">
        <CardHeader className="flex flex-row items-center justify-between pb-2 pt-6 px-8">
          ...
          <span className="text-xs font-bold text-muted-foreground tracking-tight bg-muted px-2 py-1 rounded-md">?§ÏãúÍ∞?/span>
        </CardHeader>
