...
export function BoardStats() {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
      {/* 트래픽 추이 */}
      <Card className="lg:col-span-2 border-none shadow-lg rounded-lg overflow-hidden ring-1 ring-border">
      ...
      {/* 작성자 분포 */}
      <Card className="border-none shadow-lg rounded-lg overflow-hidden ring-1 ring-border">
