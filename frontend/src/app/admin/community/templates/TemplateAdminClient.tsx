...
export default function TemplateAdminClient({
 ...
 >
 <SelectTrigger className="h-16 rounded-xl border-2 border-slate-100 bg-slate-50/50 font-black text-[10px] tracking-tight focus:bg-white">
 ...
 className="h-16 px-10 rounded-xl border-2 border-slate-100 font-black text-sm tracking-tight hover:bg-slate-50 transition-all"
 >
 취소
 </Button>
 <Button
 onClick={handleAdd}
 disabled={loading}
 className="h-16 px-14 bg-slate-900 text-white rounded-xl font-black text-sm tracking-[0.2em] shadow-xl hover:bg-primary transition-all hover:-translate-y-1 active:scale-95 flex items-center gap-3 flex-1"
 >
