    ...
    return (
        <div className="max-w-6xl mx-auto space-y-12 px-4 md:px-0 pb-24 animate-in fade-in slide-in-from-bottom-8 duration-1000">
                ...
                actions={
                    <div className="flex items-center gap-4">
                        <Button
                            ...
                            variant="outline"
                            className="h-14 w-14 rounded-xl border-2 border-slate-100 text-slate-400 hover:text-primary hover:bg-primary/5 transition-all shadow-md active:scale-95"
                        >
                            <RefreshCcw size={18} className={cn(loading && "animate-spin")} />
                        </Button>
                        <Button
                            onClick={() => setIsAddOpen(true)}
                            className="h-14 px-8 bg-slate-900 text-white rounded-xl font-black text-sm tracking-[0.2em] shadow-xl hover:bg-primary transition-all hover:-translate-y-1 active:scale-95 flex items-center gap-3 italic"
                        >
                            <Plus size={18} />
                            신규 블루프린트
                        </Button>
            ...
            <Dialog open={isAddOpen} onOpenChange={setIsAddOpen}>
                <DialogContent className="sm:max-w-[500px] rounded-xl p-10 border-none shadow-2xl bg-white">
                    <DialogHeader className="space-y-4">
                        <div className="w-16 h-16 bg-primary text-white rounded-xl flex items-center justify-center shadow-2xl shadow-primary/20 mx-auto">
                            <Plus size={28} />
                        </div>
                    ...
                    <div className="space-y-8 py-8">
                        <div className="space-y-3">
                            ...
                            <Input
                                ...
                                className="h-16 px-8 rounded-xl border-2 border-slate-100 bg-slate-50/50 text-lg font-black italic focus:bg-white focus:ring-4 focus:ring-primary/10 transition-all shadow-inner"
                            />
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            <div className="space-y-3">
                                ...
                                >
                                    <SelectTrigger className="h-16 rounded-xl border-2 border-slate-100 bg-slate-50/50 font-black text-[10px] tracking-tight italic focus:bg-white">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="relative">
                                ...
                                <Input
                                    ...
                                    className="h-16 pl-16 pr-8 rounded-xl border-2 border-slate-100 bg-slate-50/50 font-mono text-sm font-bold focus:bg-white focus:ring-4 focus:ring-primary/10 transition-all shadow-inner"
                                />
                            </div>
                        </div>
                    </div>
                    ...
                    <DialogFooter>
                        <Button
                            ...
                            className="h-16 px-10 rounded-xl border-2 border-slate-100 font-black text-sm tracking-tight italic hover:bg-slate-50 transition-all"
                        >
                            취소
                        </Button>
                        <Button
                            onClick={handleAdd}
                            disabled={loading}
                            className="h-16 px-14 bg-slate-900 text-white rounded-xl font-black text-sm tracking-[0.2em] shadow-xl hover:bg-primary transition-all hover:-translate-y-1 active:scale-95 flex items-center gap-3 italic flex-1"
                        >
