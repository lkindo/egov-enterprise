        ...
        <div className="flex justify-end gap-3 pr-4">
          {(item.confmAt === 'N' || item.confmAt === 'A') && (
            <Button
              ...
              className="h-10 px-6 bg-slate-900 text-white rounded-[0.1rem] text-[10px] font-black tracking-widest uppercase hover:bg-primary transition-all active:scale-95 shadow-xl shadow-slate-900/10 flex items-center gap-2 group"
            >
          ...
          <Button
            variant="ghost"
            size="icon"
            className="h-10 w-10 text-rose-500 bg-rose-50 hover:bg-rose-500 hover:text-white border border-rose-100 rounded-[0.1rem] transition-all opacity-40 hover:opacity-100"
      ...
      <StandardModal
        ...
        footer={
          <div className="flex w-full gap-4">
            <Button variant="outline" onClick={() => setIsOpen(false)} className="flex-1 h-16 rounded-[0.1rem] font-black text-[10px] tracking-widest uppercase border-2">조사_취소</Button>
            <Button 
                onClick={form.handleSubmit((v) => onFormSubmit(v, 'R'))}
                disabled={loading}
                className="flex-1 h-16 bg-rose-50 text-rose-500 rounded-[0.1rem] font-black text-[10px] tracking-widest uppercase hover:bg-rose-500 hover:text-white transition-all active:scale-95 border-2 border-rose-100 flex items-center justify-center gap-3"
            >
            ...
            <Button
                ...
                disabled={loading}
                className="flex-[2] h-16 bg-slate-900 border-none text-white rounded-[0.1rem] font-black text-[10px] tracking-widest uppercase shadow-2xl flex items-center justify-center gap-3 hover:-translate-y-2 hover:bg-primary transition-all active:scale-95 group"
            >
                ...
                <FormItem className="space-y-4">
                  ...
                  <FormControl>
                    <textarea
                      ...
                      className="w-full min-h-[200px] p-10 rounded-[0.1rem] border-2 bg-slate-50 font-bold text-lg outline-none focus:bg-white focus:ring-[12px] focus:ring-primary/5 focus:border-primary/20 transition-all shadow-inner leading-relaxed resize-none placeholder:text-slate-300"
                    />
                  </FormControl>
