      ...
      >
        <div>
          <div className="flex items-center gap-3 mb-2">
            <Badge className="bg-primary/10 text-primary border-none font-bold px-4 py-1 rounded-full uppercase tracking-tight">System Design Engine</Badge>
            <span className="text-slate-300">|</span>
            <span className="text-sm font-bold text-slate-400">v2.0 Beta</span>
          </div>
          <h1 className="text-4xl font-bold tracking-tight flex items-center gap-4 text-slate-900">
            <Settings2 className="w-10 h-10 text-primary" />
            �ý��� �׸� �� ������ ��ū ����
          </h1>
          <p className="mt-3 text-slate-500 font-bold text-lg">�÷����� �ð��� �ϰ����� �����ϱ� ���� ���� ����(Edge) ��� �� �귣�� �÷� ��ū�� �����մϴ�.</p>
        </div>
        ...
        <div className="col-span-12 lg:col-span-4 space-y-10">
          ...
          <div className="p-8 bg-amber-50 rounded-lg border-2 border-dashed border-amber-200 space-y-3">
            ...
            <p className="text-sm font-bold text-amber-600/80 leading-relaxed">
              �� ���������� �����ϴ� ���� �÷��� ��ü�� ������ ���̵���ο� ��� ����ȭ�˴ϴ�. <br/>
              <b>���θ�� ��� �� �˾� �ڻ�</b> ������ ���� �޴��� <span className="underline decoration-2">[������ �]</span> ���� �̿��� �ּ���.
            </p>
          </div>
        </div>
        ...
        <div className="col-span-12 lg:col-span-8">
          <div className="h-full min-h-[700px] bg-slate-100/40 rounded-lg border-4 border-dashed border-slate-200 flex flex-col items-center justify-center p-12 relative overflow-hidden group">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="space-y-5">
                  <h3 className="text-5xl font-bold tracking-tight" style={{ color: themeConfig.primaryColor }}>
                    UX ��ū �̸�����
                  </h3>
                  <p className="text-slate-500 font-bold text-xl leading-relaxed">
                    �����Ͻ� <span className="text-slate-900">����� �׸� �÷�</span>�� <br/>
                    ���� �÷��� ������Ʈ�� ������ ����Դϴ�.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-6 w-full">
                  {[1, 2].map(i => (
                    <div 
                      key={i} 
                      className="h-20 bg-slate-50 flex items-center justify-center font-bold text-slate-400 border border-slate-100 text-lg" 
                ...
                <Button 
                  className="w-full h-20 text-2xl font-bold gap-4 shadow-2xl transition-all hover:scale-[1.02] active:scale-95 px-10"
                  style={{ 
                ...
                >
                  �ùķ��̼� �Ϸ� �� ���� <ChevronRight size={32} strokeWidth={3} />
                </Button>
              </motion.div>
            </AnimatePresence>
            ...
            <div className="mt-16 flex items-center gap-3 text-slate-400 font-bold">
              <Info size={18} />
              <span>���� �ð�ȭ�� ���� ��� ��ġ: {((parseFloat(themeConfig.borderRadius) || 0) * 3.5).toFixed(1)} rem</span>
            </div>
          </div>
        </div>
      </div>
