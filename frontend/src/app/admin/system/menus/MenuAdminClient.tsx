          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="flex items-center gap-3">
                <span className="text-[9px] bg-black/5 px-2 py-0.5 rounded font-mono font-black tracking-widest tabular-nums border border-black/5">
                  #{item.menuNo}
                </span>
                {item.progrmFileNm && (
                  <span className="text-[9px] flex items-center gap-1.5 text-primary/60 font-black uppercase tracking-widest">
                    <LinkIcon size={10} strokeWidth={3} /> {item.progrmFileNm}
                  </span>
                )}
                {item.modernRoute && (
                  <span className="text-[9px] flex items-center gap-1.5 text-emerald-600/60 font-black uppercase tracking-widest">
    ...
    <div className="max-w-5xl mx-auto space-y-10 pb-20 animate-in fade-in slide-in-from-bottom-8 duration-1000">
          ...
          <div className="flex gap-4">
            <div className="flex bg-slate-100 p-2 rounded-[1.5rem] gap-2">
              <Button
                ...
                className="h-10 px-4 rounded-xl font-black text-[10px] uppercase tracking-widest gap-2 hover:bg-white hover:shadow-sm"
              >
                <ChevronsUpDown size={14} /> Full Map
              </Button>
              <Button
                variant="ghost"
            ...
            {hasChanges ? (
              <Button
                ...
                className="bg-emerald-600 text-white hover:bg-emerald-700 h-14 px-8 rounded-2xl font-black shadow-2xl shadow-emerald-200 gap-3 italic uppercase tracking-widest text-xs"
              >
            ...
            <Button
              ...
              className="h-14 px-10 rounded-2xl font-black shadow-2xl shadow-primary/20 gap-3 hover:-translate-y-1 transition-all italic uppercase tracking-widest text-xs"
            >
              <Plus size={20} /> Create Root Domain
            </Button>
          </div>
        }
      />
      ...
      <div className="p-10 bg-slate-900 text-white rounded-[3rem] shadow-2xl flex flex-col md:flex-row items-center gap-8 relative overflow-hidden group">
        ...
        <div className="space-y-2 flex-1">
          <h4 className="text-2xl font-black italic tracking-tighter uppercase">Hierarchical Matrix Control</h4>
      ...
      <div className="space-y-8">
        ...
        >
          ...
          <p className="text-xs font-black text-slate-400 uppercase tracking-[0.2em]">Drop here to move to Root Domain</p>
        </div>
      </div>
        ...
        <StandardForm onSubmit={handleSave} className="bg-transparent border-0 shadow-none">
          <div className="space-y-8 p-4">
            <div className="space-y-4">
              <Label className="text-xs font-black text-slate-500 uppercase tracking-[0.2em] px-2">Entity Name</Label>
              <Input
            ...
            <div className="grid grid-cols-2 gap-8">
              <div className="space-y-4">
                <Label className="text-xs font-black text-slate-500 uppercase tracking-[0.2em] px-2">Parent Node ID</Label>
              ...
              <div className="space-y-4">
                <Label className="text-xs font-black text-slate-500 uppercase tracking-[0.2em] px-2">Display Sequence</Label>
                <Input
                  type="number"
            ...
            <div className="space-y-4">
              <Label className="text-xs font-black text-slate-500 uppercase tracking-[0.2em] px-2">Program Asset</Label>
              <Select
            ...
            <div className="space-y-4">
              <Label className="text-xs font-black text-slate-500 uppercase tracking-[0.2em] px-2">Modern Route</Label>
              <Input
            ...
            <div className="flex gap-4 pt-10">
              <Button type="button" variant="outline" onClick={() => setIsOpen(false)} className="flex-1 h-16 rounded-2xl font-black uppercase text-[10px] tracking-widest">Cancel</Button>
              <Button type="submit" className="flex-[2] h-16 rounded-2xl font-black italic uppercase tracking-[0.2em] text-[10px]">
                {mode === 'create' ? 'Complete Extraction' : 'Sync Matrix'}
              </Button>
            </div>
          </div>
        </StandardForm>
