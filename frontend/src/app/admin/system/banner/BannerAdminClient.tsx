    ...
    <div className="space-y-12 pb-24 animate-in fade-in duration-1000">
      ...
      <div className="grid grid-cols-12 gap-12">
        <div className="col-span-12 lg:col-span-3 h-full">
          <div className="rounded-[0.1rem] bg-white border-2 border-slate-100 shadow-xl h-full p-4 flex flex-col gap-4">
            <button
            ...
            <div className="mt-auto p-8 rounded-[0.1rem] bg-slate-900 text-white space-y-4 relative overflow-hidden group">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    ...
                    <ShadcnFormField
                      ...
                      render={({ field }) => (
                        <FormItem className="space-y-1.5 p-0.5">
                          ...
                          <FormControl>
                            <Input {...field} className="h-14 rounded-[0.1rem] text-md font-black tracking-tight shadow-inner" placeholder="배너 이름 입력" />
                          </FormControl>
                      ...
                      render={({ field }) => (
                        <FormItem className="space-y-1.5 p-0.5">
                          ...
                          <div className="relative group/link">
                            ...
                            <FormControl>
                              <Input {...field} className="h-14 pl-16 rounded-[0.1rem] font-mono text-xs font-black shadow-inner" placeholder="/pages/..." />
                            </FormControl>
                          </div>
                      ...
                      <ShadcnFormField
                        ...
                        render={({ field }) => (
                          <FormItem className="space-y-1.5 p-0.5">
                            ...
                            <FormControl>
                              <Input {...field} type="number" onChange={(e) => field.onChange(Number(e.target.value))} className="h-14 rounded-[0.1rem] font-black shadow-inner" />
                            </FormControl>
                            <FormMessage className="text-[10px] font-bold text-rose-600 px-1 mt-1" />
                          </FormItem>
                        )}
                        ...
                        render={({ field }) => (
                          <FormItem className="space-y-1.5 p-0.5">
                            ...
                            <Select onValueChange={field.onChange} value={field.value}>
                              <FormControl>
                                <SelectTrigger className="h-14 rounded-[0.1rem] border-2 border-slate-100 bg-slate-50 font-black text-[10px] tracking-widest uppercase shadow-inner">
                                  <SelectValue />
                                </SelectTrigger>
                              </FormControl>
                              <SelectContent className="rounded-[0.1rem] shadow-2xl">
                                <SelectItem value="Y" className="h-12 rounded-[0.1rem] text-[10px] font-black tracking-widest uppercase">--- 활성 (Live) ---</SelectItem>
                                <SelectItem value="N" className="h-12 rounded-[0.1rem] text-[10px] font-black tracking-widest uppercase text-rose-500">--- 대기 (Staging) ---</SelectItem>
                              </SelectContent>
                            </Select>
                            <FormMessage className="text-[10px] font-bold text-rose-600 px-1 mt-1" />
                          </FormItem>
                  ...
                  <div className="space-y-12">
                    <FormItem className="space-y-1.5 p-0.5">
                      ...
                      <div className="p-4 border-4 border-dashed border-slate-100 rounded-[0.1rem] bg-slate-50/50 hover:bg-slate-50 transition-colors shadow-inner relative group/upload">
                    ...
                    {(editingItem as Banner)?.bannerImageFile && (
                      <div className="p-8 rounded-[0.1rem] bg-slate-900 text-white space-y-3 shadow-2xl relative overflow-hidden group">
                        <span className="text-[9px] font-black text-white/30 tracking-[0.4em] uppercase">기존 파일 식별자</span>
                        <div className="flex items-center gap-4">
                          <div className="w-10 h-10 rounded-[0.1rem] bg-white/10 flex items-center justify-center shadow-inner group-hover:rotate-12 transition-transform">
              ...
              <form onSubmit={popupForm.handleSubmit(onPopupSubmit) as any} className="space-y-12">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    ...
                    <ShadcnFormField
                      ...
                      render={({ field }) => (
                        <FormItem className="space-y-1.5 p-0.5">
                          ...
                          <FormControl>
                            <Input {...field} className="h-14 rounded-[0.1rem] text-md font-black tracking-tight shadow-inner" placeholder="팝업 제목 입력" />
                          </FormControl>
                          <FormMessage className="text-[10px] font-bold text-rose-600 px-1 mt-1" />
                        </FormItem>
                      )}
                      ...
                      <ShadcnFormField
                        ...
                        render={({ field }) => (
                          <FormItem className="space-y-1.5 p-0.5">
                            ...
                            <FormControl>
                              <Input {...field} type="date" className="h-14 rounded-[0.1rem] text-xs font-black shadow-sm" />
                            </FormControl>
                            <FormMessage className="text-[10px] font-bold text-rose-600 px-1 mt-1" />
                          </FormItem>
                        )}
                  ...
                  <div className="space-y-12">
                    ...
                    <div className="grid grid-cols-1 gap-8 p-10 bg-indigo-50/30 border-2 border-indigo-100/50 rounded-[0.1rem] shadow-sm">
                        ...
                        <ShadcnFormField
                          ...
                          render={({ field }) => (
                            <FormItem className="space-y-1.5 p-0.5">
                              ...
                              <Select onValueChange={field.onChange} value={field.value}>
                                <FormControl>
                                  <SelectTrigger className="h-14 rounded-[0.1rem] border-2 border-indigo-100 bg-white font-black text-[10px] tracking-widest uppercase shadow-sm">
                                    <SelectValue />
                                  </SelectTrigger>
                                </FormControl>
                                <SelectContent className="rounded-[0.1rem]">
