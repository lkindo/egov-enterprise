...
export default function BannerAdminClient({ initialBanners, initialPopups }: BannerAdminClientProps) {
 ...
 <div className="w-56 h-24 bg-slate-900 rounded-xl overflow-hidden border-2 border-slate-100 shadow-xl relative group/img cursor-zoom-in transition-all duration-500 hover:scale-[1.05] hover:z-50">
 ...
 {item.linkUrl && (
 <span className="text-[9px] font-black text-primary/60 flex items-center gap-1.5 lowercase">
 ...
 header: '우선순위',
 accessor: (item: Banner) => (
 <div className="w-12 h-12 rounded-xl bg-slate-50 border-2 border-slate-100 flex items-center justify-center shadow-inner group-hover:bg-slate-900 group-hover:text-white transition-all duration-500">
 ...
 <span className="text-[10px] font-black text-muted-foreground/60 font-mono tracking-tighter tabular-nums uppercase ">
 ...
 <span className="text-[9px] font-bold text-muted-foreground/40 ">Coordinates: (X:{item.popupWidthLocation}, Y:{item.popupHeightLocation})</span>
 </div>
 </div>
 ),
 className: 'w-64'
 ...
 <div className="rounded-xl bg-white border-2 border-slate-100 shadow-xl h-full p-4 flex flex-col gap-4">
 <button
 ...
 >
 <div className={cn("w-12 h-12 rounded-xl flex items-center justify-center transition-all shadow-lg relative z-10", activeTab === 'banner' ? "bg-white/10 text-white shadow-black/20" : "bg-white text-slate-300 group-hover:bg-primary group-hover:text-white")}>
 <ImageIcon size={22} />
 </div>
 ...
 >
 <div className={cn("w-12 h-12 rounded-xl flex items-center justify-center transition-all shadow-lg relative z-10", activeTab === 'popup' ? "bg-white/10 text-white shadow-black/20" : "bg-white text-slate-300 group-hover:bg-indigo-500 group-hover:text-white")}>
 <Monitor size={22} />
 </div>
 <div className="flex flex-col text-left relative z-10">
 ...
 <div className="mt-auto p-8 rounded-xl bg-slate-900 text-white space-y-4 relative overflow-hidden group">
 ...
 <Button variant="outline" onClick={() => setIsOpen(false)} className="flex-1 h-14 rounded-xl font-black text-[10px] tracking-widest border-2">취소</Button>
 <Button
 ...
 className="flex-[2] h-14 rounded-xl bg-slate-900 border-none text-white font-black text-[10px] tracking-widest shadow-2xl hover:bg-primary transition-all hover:-translate-y-2 group"
 >
 ...
 <FormControl>
 <Input {...field} className="h-14 rounded-xl text-md font-black tracking-tight shadow-inner" placeholder="배너 이름 입력" />
 </FormControl>
 ...
 <FormControl>
 <Input {...field} className="h-14 pl-16 rounded-xl font-mono text-xs font-black shadow-inner" placeholder="/pages/..." />
 </FormControl>
 </div>
 ...
 <FormControl>
 <Input {...field} type="number" onChange={(e) => field.onChange(Number(e.target.value))} className="h-14 rounded-xl font-black shadow-inner" />
 </FormControl>
 <FormMessage className="text-[10px] font-bold text-rose-600 px-1 mt-1" />
 </FormItem>
 )}
 ...
 <FormControl>
 <SelectTrigger className="h-14 rounded-xl border-2 border-slate-100 bg-slate-50 font-black text-[10px] tracking-widest uppercase shadow-inner">
 <SelectValue />
 </SelectTrigger>
 </FormControl>
 ...
 <FormControl>
 <textarea {...field} className="w-full min-h-[120px] p-6 rounded-xl border-2 border-slate-100 bg-slate-50 text-xs font-bold focus:ring-4 focus:ring-primary/10 outline-none resize-none shadow-inner" placeholder="배너 자산 용도 및 노출 조건 설명" />
 </FormControl>
 <FormMessage className="text-[10px] font-bold text-rose-600 px-1 mt-1" />
 </FormItem>
 )}
 ...
 <div className="p-4 border-4 border-dashed border-slate-100 rounded-xl bg-slate-50/50 hover:bg-slate-50 transition-colors shadow-inner relative group/upload">
 ...
 <div className="p-8 rounded-xl bg-slate-900 text-white space-y-3 shadow-2xl relative overflow-hidden group">
 ...
 <FormControl>
 <Input {...field} className="h-14 rounded-xl text-md font-black tracking-tight shadow-inner" placeholder="팝업 제목 입력" />
 </FormControl>
 <FormMessage className="text-[10px] font-bold text-rose-600 px-1 mt-1" />
 </FormItem>
 )}
 />
 <div className="grid grid-cols-2 gap-8 p-10 bg-slate-50 border-2 border-dashed border-slate-100 rounded-xl shadow-inner">
 <ShadcnFormField
 control={popupForm.control}
 ...
 <div className="grid grid-cols-1 gap-8 p-10 bg-indigo-50/30 border-2 border-indigo-100/50 rounded-xl shadow-sm">
 ...
 <Select onValueChange={field.onChange} value={field.value}>
 <FormControl>
 <SelectTrigger className="h-14 rounded-xl border-2 border-indigo-100 bg-white font-black text-[10px] tracking-widest uppercase shadow-sm">
 <SelectValue />
 </SelectTrigger>
 </FormControl>
