...
const UserLogAdminPage = () => {
    ...
    return (
        <div className="space-y-12 pb-24 animate-in fade-in duration-1000">
            <PageHeader title="?¬ìš©??ë¡œê·¸" breadcrumbs={[{ label: '?œìŠ¤?œê?ë¦? }, { label: 'ë¡œê·¸ê´€ë¦? }, { label: '?¬ìš©??ë¡œê·¸' }]} />

            <HubHeader title="?‰ì • ?´ë ¥" highlight="?¬ìš©??ë¡œê·¸" subtitle="?œìŠ¤???¬ìš©?ì˜ ?œë¹„??ëª¨ë“ˆë³??í˜¸?‘ìš© ë°??‘ì—… ?˜í–‰ ?´ë ¥??ëª…í™•?˜ê²Œ ê´€ë¦¬í•©?ˆë‹¤." icon={History} />
