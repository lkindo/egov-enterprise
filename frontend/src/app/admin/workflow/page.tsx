            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div className="space-y-2">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-xs font-black text-primary uppercase tracking-widest">Workflow Engine</span>
                    </div>
                ...
                <div className="flex items-center gap-3">
                    <button className="flex items-center gap-2 px-6 py-3 bg-muted rounded-full font-black text-xs uppercase tracking-widest hover:bg-muted/80 transition-all">
                        <History size={16} /> History
                    </button>
                    <button className="flex items-center gap-2 px-6 py-3 bg-primary text-white rounded-full font-black text-xs uppercase tracking-widest shadow-xl hover:bg-primary/90 transition-all">
                    ...
                    <div className="flex items-center justify-between px-6">
                        <div className="flex items-center gap-6">
                            <div className="flex items-center gap-2">
                                <span className="text-xs font-black text-foreground">WORKFLOW:</span>
                                <span className="text-xs font-bold text-muted-foreground italic">연차/휴가 결재 프로세스_v1.2</span>
                            </div>
                ...
                <div className="space-y-6">
                    <div className="p-8 border rounded-[3rem] bg-card shadow-lg space-y-8">
                        <div className="flex items-center justify-between">
                            <h3 className="text-sm font-black text-foreground uppercase tracking-widest">Step Details</h3>
                            ...
                            <div className="space-y-8 animate-in slide-in-from-right-4 duration-500">
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[10px] font-black text-muted-foreground uppercase mt-1 tracking-widest">{selectedNode.id} / {selectedNode.type}</p>
                                    </div>
                                </div>

                                <div className="space-y-6">
                                    <div className="space-y-2">
                                        <span className="text-[9px] font-black text-muted-foreground uppercase tracking-[0.2em]">현재 담당자</span>
                                        <div className="flex items-center gap-3 p-4 bg-muted/30 rounded-2xl border border-white/5">
                                            <div className="w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center text-primary font-black text-xs italic">
                                    ...
                                    <div className="space-y-2">
                                        <span className="text-[9px] font-black text-muted-foreground uppercase tracking-[0.2em]">처리 로그</span>
                                        <div className="space-y-4 border-l-2 border-muted ml-2 pl-6 pt-2">
                                            <div className="relative">
                                                ...
                                                <p className="text-xs font-black">신청서 수신 완료</p>
                                            ...
                                            <div className="relative opacity-50">
                                                ...
                                                <p className="text-xs font-black">팀장 내부 상신</p>
                                ...
                                <button className="w-full py-5 bg-primary text-white rounded-full font-black text-sm uppercase tracking-widest shadow-xl shadow-primary/20 hover:scale-[1.02] active:scale-95 transition-all">
                                    승인 처리하기
                                </button>
                            </div>
                        ) : (
