      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-left">
        {loading ? (
          ...
          contents.map((item) => (
            <div
              key={item.cntntsId}
              className={`p-10 bg-white border-2 rounded-[3rem] shadow-sm hover:shadow-2xl transition-all duration-500 group ${
          ...
          <div className="col-span-full py-32 text-center bg-slate-50 rounded-[4rem] border-4 border-dashed border-slate-200 flex flex-col items-center gap-6">
