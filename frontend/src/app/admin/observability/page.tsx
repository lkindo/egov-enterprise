...
export default function ObservabilityPage() {
  return (
    <div className="space-y-12 pb-24 animate-in fade-in duration-1000">
      ...
      <HubMetricGrid>
        <HubMetricCard title="Global Traffic" value="2.4k" unit="Req/s" icon={BarChart3} color="primary" status="+12.4%" />
        <HubMetricCard title="System Latency" value="42" unit="ms" icon={Clock} color="emerald" status="-4ms" />
        <HubMetricCard title="Error Rate" value="0.02" unit="%" icon={AlertTriangle} color="rose" status="Stable" />
        <HubMetricCard title="Node Load" value="68.4" unit="%" icon={Activity} color="amber" />
      </HubMetricGrid>
