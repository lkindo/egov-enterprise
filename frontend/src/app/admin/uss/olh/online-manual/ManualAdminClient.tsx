      ...
      accessor: (item: ManualDto) => (
        <div className="flex items-center gap-4 py-2">
          ...
          <div className="flex flex-col text-left">
            ...
            <span className="text-[10px] font-bold text-muted-foreground mt-1 tracking-widest uppercase opacity-40">
              ID: {item.onlineMnlId}
            </span>
          </div>
        </div>
            ...
            <form onSubmit={form.handleSubmit(onFormSubmit)}>
              ...
              <div className="p-8 space-y-8 text-left">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="space-y-3">
                      <FormLabel className="text-[10px] font-black text-slate-400 tracking-[0.2em] uppercase ml-2">매뉴얼 명칭</FormLabel>
                      <FormControl>
                        <Input
                          {...field}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="space-y-3">
                      <FormLabel className="text-[10px] font-black text-slate-400 tracking-[0.2em] uppercase ml-2">상세 설명</FormLabel>
                      <FormControl>
                        <Textarea
                          {...field}
