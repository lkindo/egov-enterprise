  ...
  const columns = [
    {
      ...
      accessor: (item: ManualDto) => (
        <div className="flex items-center gap-3">
          ...
          <div>
            <span className="font-black italic uppercase tracking-tighter text-slate-900 block">{item.onlineMnlNm}</span>
            <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest italic">{item.onlineMnlId}</span>
          </div>
        </div>
      )
    },
    ...
    },
    {
        ...
        accessor: (item: ManualDto) => (
          <span className="text-[11px] font-bold text-slate-500 italic max-w-[200px] truncate block">
            {item.onlineMnlDc || 'No description.'}
          </span>
        )
    },
    {
      ...
      <div className="responsive-card p-6 md:p-12 border-2 border-slate-100 bg-white/50 backdrop-blur-xl relative overflow-hidden group">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12 relative z-10">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h3 className="text-xl md:text-2xl font-black text-slate-900 uppercase tracking-tighter italic">Knowledge Assets</h3>
                    <p className="text-[9px] font-black text-slate-400 uppercase tracking-[0.3em]">Managed Online Manuals</p>
                </div>
            </div>
            <div className="flex items-center gap-4">
        ...
        <DialogContent className="sm:max-w-[500px] rounded-[3rem] p-10 border-none shadow-2xl bg-white">
          <DialogHeader className="space-y-4">
            ...
            <DialogTitle className="text-3xl font-black text-slate-900 uppercase tracking-tighter italic text-center">
                {selectedManual ? 'Modify Guide' : 'New Guide'}
            </DialogTitle>
          ...
          <div className="space-y-8 py-8">
            <div className="space-y-3">
              <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest italic ml-2">Manual Designation</label>
              <Input
            ...
            <div className="space-y-3">
              <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest italic ml-2">Resource Path</label>
              <Input
