                ...
                <div className="relative z-10 space-y-8 text-center md:text-left">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                        <div className="space-y-2">
                            ...
                            <p className="text-slate-400 font-medium text-lg">?úÏä§???ÑÏ≤¥?êÏÑú ?ÑÏöî???ïÎ≥¥Î•??ïÎ??òÍ≤å Ï∞æÏïÑ?ÖÎãà??</p>
                        </div>
                        <div className="flex items-center gap-3 bg-white/10 px-5 py-2.5 rounded-2xl border border-white/10 backdrop-blur-xl">
                            <Clock className="text-primary" size={18} />
                            <span className="text-sm font-black text-white tracking-tight">?§ÏãúÍ∞??∏Îç±???úÏÑ±??/span>
                        </div>
                    </div>
                ...
                <div className="w-full md:w-64 space-y-8 shrink-0">
                    ...
                    <div className="p-8 bg-slate-900 rounded-[2.5rem] text-white shadow-2xl relative overflow-hidden group">
                        ...
                        <div className="relative z-10 space-y-4">
                            <h4 className="text-sm font-black tracking-tight text-primary">?ÑÎ°ú ??/h4>
                            <p className="text-sm text-slate-400 font-bold leading-relaxed">
                                ?®Ï∂ï??<kbd className="px-1.5 py-0.5 bg-white/10 rounded border border-white/10">Ctrl + K</kbd> Î•??ÑÎ•¥Î©??¥Îîî?úÎì† Ïª§Îß®???ºÌÑ∞Î•??????àÏäµ?àÎã§.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 min-h-[500px]">
                        {loading ? (
                            ...
                            <div className="flex flex-col items-center justify-center py-32 text-center space-y-6">
                                ...
                                <div className="space-y-2">
                                    <h3 className="text-2xl font-black text-foreground/60">?ºÏπò?òÎäî Í≤∞Í≥ºÍ∞Ä ?ÜÏäµ?àÎã§.</h3>
...
function UserResultItem({ item }: any) {
    return (
        <div className="p-6 bg-card border-2 border-primary/5 rounded-[2rem] flex items-center gap-5 hover:border-primary/20 transition-all shadow-sm">
            ...
            <Badge variant="secondary" className="rounded-lg font-black text-[10px] ">ÏßÅÏõê</Badge>
        </div>
    );
}
        ...
        <Link href={item.path} className="flex items-center justify-between p-6 bg-muted/20 border-2 border-transparent hover:border-primary/20 hover:bg-card rounded-2xl transition-all group">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <span className="text-[10px] font-bold text-muted-foreground tracking-tight">{item.category} Î™®Îìà</span>
                </div>
            </div>
