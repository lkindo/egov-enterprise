        ...
        <Suspense fallback={
            <div className="min-h-[80vh] flex flex-col items-center justify-center gap-10 p-20 text-center animate-in fade-in duration-1000">
                <div className="relative group">
                    ...
                    <div className="relative w-32 h-32 bg-white rounded-[0.1rem] border-2 border-slate-100 flex items-center justify-center shadow-2xl transition group-hover:rotate-12 group-hover:scale-110">
                ...
                <div className="space-y-4 relative">
                    <div className="flex items-center justify-center gap-3 mb-2">
                        ...
                        <span className="text-[10px] font-black text-primary uppercase tracking-[0.4em] font-mono">Neural Search Indexing</span>
                    </div>
                    <h2 className="text-4xl font-black tracking-tighter text-slate-900 leading-tight">데이터 인구조사 분석 중...</h2>
