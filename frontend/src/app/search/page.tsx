        ...
        <Suspense fallback={
            <div className="min-h-[80vh] flex flex-col items-center justify-center gap-10 p-20 text-center animate-in fade-in duration-1000">
                <div className="relative group">
                    ...
                    <div className="relative w-32 h-32 bg-white rounded-lg border-2 border-slate-100 flex items-center justify-center shadow-2xl transition-all group-hover:rotate-12 group-hover:scale-110">
