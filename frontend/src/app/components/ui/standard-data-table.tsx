    ...
    <div className={cn("space-y-6", isPremium ? "animate-in fade-in slide-in-from-bottom-4 duration-700" : "", className)}>
      ...
      {search && (
        <form onSubmit={handleSearchSubmit} className="relative group max-w-md">
          ...
          <Input
            placeholder={search.placeholder || 'Í≤Ä?âÏñ¥ ?ÖÎ†•...'}
        ...
        >
          <div className="flex items-center gap-6">
            <div className="flex flex-col">
              <span className="text-[10px] font-black opacity-60 tracking-widest uppercase">?†ÌÉù Î™®Îìú</span>
              <span className="text-sm font-black">{selectedIds.size}Í∞úÏùò ??™© ?†ÌÉù??/span>
            </div>
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-6 animate-in fade-in zoom-in-95 duration-700 py-12">
      ...
      <div className="space-y-2">
        <p className="text-xl font-black text-rose-900 tracking-tighter uppercase whitespace-pre-line">?∞Ïù¥??Î°úÎìú ?§Ìå®</p>
        ...
        <p className="text-xs text-muted-foreground font-black tracking-tight max-w-[360px] mx-auto leading-relaxed opacity-60 mt-4">
          ?∞Ïù¥?∞Î≤†?¥Ïä§ ?∏ÏÖò?ºÎ°úÎ∂Ä??Í∞úÏ≤¥ ?ïÎ≥¥Î•??òÏã†?òÏ? Î™ªÌñà?µÎãà?? <br />?§Ìä∏?åÌÅ¨ ?∞Í≤∞ ?ÅÌÉúÎ•??ïÏù∏?òÍ±∞???ÑÎûò Î≤ÑÌäº???µÌï¥ ?¨Ïãú?ÑÌïò??ãú??
        </p>
      </div>
    ...
    <div className="flex flex-col items-center justify-center gap-6 animate-in fade-in zoom-in-95 duration-700 py-12">
      ...
      <div className="space-y-2">
        ...
        <p className="text-xs text-muted-foreground font-black tracking-tight max-w-[320px] mx-auto leading-relaxed opacity-60">
          ?úÏä§?úÏóê???∞Ïù¥?∞Î? Ï°∞Ìöå?òÏ? Î™ªÌñà?µÎãà?? <br />Í≤Ä??Ï°∞Í±¥??Ï°∞Ï†ï?òÍ±∞???§Ïãú Ï¥àÍ∏∞?îÌï¥ Î≥¥Ïã≠?úÏò§.
        </p>
      </div>
      <Button
        variant="outline"
