  ...
  return (
    <div className="flex flex-col items-center justify-center gap-6 animate-in fade-in zoom-in-95 duration-700 py-12">
      ...
      <div className="space-y-2">
        <p className="text-xl font-bold text-rose-900 tracking-tight uppercase whitespace-pre-line">데이터 로드 실패</p>
...
function EmptyStateDisplay({ emptyMessage }: { emptyMessage: string }) {
  return (
    <div className="flex flex-col items-center justify-center gap-6 animate-in fade-in zoom-in-95 duration-700 py-12">
      ...
      <div className="space-y-2">
        <p className="text-xl font-bold text-foreground tracking-tight uppercase">{emptyMessage}</p>
