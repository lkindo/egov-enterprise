...
export function StandardSummaryCard({
  ...
  return (
    <div className={cn(
      "p-8 rounded-[var(--radius-hub-item)] border transition-all hover:scale-[1.05] group overflow-hidden relative shadow-lg",
      variantStyles[variant],
      className
    )}>
      <div className="flex justify-between items-start mb-6 relative z-10">
        <div className={cn(
          "w-12 h-12 rounded-[var(--radius-hub-widget)] flex items-center justify-center group-hover:rotate-6 transition-transform shadow-lg", 
