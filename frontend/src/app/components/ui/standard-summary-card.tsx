  ...
  return (
    <div className={cn(
      ...
      <div className="flex justify-between items-start mb-6 relative z-10">
        ...
        {trend && (
          <div className="flex items-center gap-1.5 px-3 py-1 bg-white/10 rounded-lg text-xs font-bold tracking-widest uppercase backdrop-blur-md border border-white/10">
             {trend.value}
          </div>
        )}
      </div>
      <div className="relative z-10 ">
        ...
        <h4 className="text-3xl font-bold tracking-tighter tabular-nums">
          {typeof value === 'number' ? value.toLocaleString() : (value || '0')}
