...
export function StandardOnboardingTour() {
 ...
 >
 <div className="relative max-w-lg w-full bg-background/80 backdrop-blur-2xl border-2 border-primary/10 rounded-xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-500 ring-1 ring-white/20">
 {/* Progress Bar */}
 ...
 <div className="w-20 h-20 bg-muted/50 rounded-xl flex items-center justify-center mx-auto shadow-inner animate-in slide-in-from-bottom-2 duration-700" aria-hidden="true">
