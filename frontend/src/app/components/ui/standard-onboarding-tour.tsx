...
export function StandardOnboardingTour() {
 ...
 <div className="w-20 h-20 bg-muted/50 rounded-lg flex items-center justify-center mx-auto shadow-inner animate-in slide-in-from-bottom-2 duration-700" aria-hidden="true">
