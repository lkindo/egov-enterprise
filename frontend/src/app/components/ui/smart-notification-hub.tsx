      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="space-y-1">
          <div className="flex items-center gap-3">
             ...
             <h2 className="text-3xl font-bold tracking-tighter uppercase text-slate-900 dark:text-white">Smart Notification Hub</h2>
          </div>
                 ...
                 <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                       ...
                       <div className="grid grid-cols-5 gap-1">
                          {[1, 2, 3, 4, 5].map((i) => (
                            <div key={i} className={cn("h-1 rounded-lg", i <= 4 ? "bg-emerald-500" : "bg-emerald-500/20")} />
                          ))}
                       </div>
                    </div>
                 </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                 {[
                   ...
                   >
                     ...
                     <span className="text-xs font-bold uppercase text-slate-500 tracking-tighter">{cmd.label}</span>
                   </Button>
                 ))}
              </div>
