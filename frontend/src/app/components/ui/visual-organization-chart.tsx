    ...
    children: [
        {
            ...
            status: 'busy',
            children: [
                { id: 'o-3', name: '박팀장', role: 'Dev Lead', dept: '백엔드개발팀', email: 'p@c.com', phone: '010-1', status: 'online' },
        ...
        },
        {
            ...
            status: 'offline',
            children: [
                { id: 'o-6', name: '강팀장', role: 'Audit Lead', dept: '보안점검팀', email: 'k@c.com', phone: '010-3', status: 'online' },
            ]
        }
    ]
};
            ...
            <div key={node.id} className="flex flex-col gap-3">
                ...
                >
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[10px] font-bold text-muted-foreground uppercase opacity-60 tracking-widest">{node.role}</p>
                    </div>
        ...
        <div className="flex flex-col md:flex-row gap-8 h-[calc(100vh-12rem)] animate-in fade-in duration-700">
            ...
            <div className="w-full md:w-96 flex flex-col gap-6">
                <div className="p-8 bg-card border-2 border-primary/5 rounded-[3rem] shadow-xl flex flex-col gap-6">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-bold text-muted-foreground uppercase opacity-50 tracking-widest">Organization & Hierarchy</p>
                        </div>
                    </div>
                    ...
                    <div className="relative">
                        ...
                        <input
                            className="w-full bg-muted/40 border-none rounded-2xl py-3 pl-12 pr-4 text-xs font-bold outline-none ring-2 ring-transparent focus:ring-primary/20 transition-all font-medium"
                            placeholder="Search members or depts..."
                            value={search}
                        ...
                        {[
                            ...
                            <button key={dept.id} className="w-full flex items-center justify-between p-4 rounded-2xl hover:bg-primary/5 transition-all group">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-xs font-black text-muted-foreground group-hover:text-foreground">{dept.name}</span>
                                </div>
                ...
                <div className="mt-auto p-8 rounded-[3rem] bg-gradient-to-br from-indigo-500 to-purple-600 text-white shadow-2xl relative overflow-hidden group">
                    ...
                    <h4 className="relative z-10 text-sm font-black uppercase tracking-widest opacity-80 mb-2">Corporate Stats</h4>
                    <div className="relative z-10 grid grid-cols-2 gap-4 mt-6">
                        <div>
                            <p className="text-[10px] uppercase font-black opacity-60">Total Staff</p>
                            <p className="text-2xl font-black tracking-tighter">1,204</p>
                        </div>
                        <div>
                            <p className="text-[10px] uppercase font-black opacity-60">Departments</p>
                            <p className="text-2xl font-black tracking-tighter">24</p>
                        </div>
                    </div>
                    <Button className="relative z-10 mt-8 w-full bg-white/10 hover:bg-white/20 border-none rounded-2xl font-black text-[10px] uppercase tracking-widest h-12">
                        Download Full Chart
                    </Button>
                </div>
            </div>
                            ...
                            <div className="flex items-center gap-6">
                                ...
                                <div className="space-y-1">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="text-[10px] font-black text-emerald-500 px-3 py-1 bg-emerald-500/10 rounded-full border border-emerald-500/20 uppercase tracking-widest">{selectedNode.status}</span>
                                    </div>
