        ...
        <div className="grid grid-cols-1 xl:grid-cols-4 gap-8 h-full animate-in fade-in slide-in-from-right-8 duration-700">
                ...
                <div className="p-10 bg-card border-2 border-primary/5 rounded-[4rem] shadow-2xl relative overflow-hidden group min-h-[600px]">
                    <div className="flex items-center justify-between mb-10">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h3 className="text-xl font-black tracking-tight uppercase">Smart Scheduling Canvas</h3>
                                <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest opacity-60 italic">Real-time resource allocation engine</p>
                            </div>
                        </div>
                        <div className="flex gap-2">
                             {[1, 2, 3, 4, 5].map(day => (
                                 <button key={day} className={cn(
                                     "w-12 h-16 rounded-2xl border-2 font-black text-xs flex flex-col items-center justify-center transition-all",
                                     ...
                                     <span className="opacity-40 uppercase text-[8px] mb-1">Mar</span>
                                     {day + 10}
                                 </button>
                             ))}
                        </div>
            ...
            <div className="space-y-8">
                <div className="p-8 bg-slate-900 text-white rounded-[3.5rem] shadow-2xl relative overflow-hidden group">
                    ...
                    <h3 className="relative z-10 text-xs font-black uppercase tracking-[0.3em] opacity-50 mb-6 italic">Active Capacity</h3>
                    <div className="relative z-10 space-y-2">
                        <div className="flex items-end justify-between">
                            <p className="text-5xl font-black italic tracking-tighter tabular-nums">78%</p>
                            <span className="text-[10px] font-black uppercase tracking-widest text-primary">+12% vs last week</span>
                        </div>
                ...
                <div className="p-8 bg-card border-2 border-primary/5 rounded-[3.5rem] shadow-xl space-y-6">
                    <div className="flex items-center justify-between">
                        <h4 className="text-sm font-black uppercase tracking-widest italic">Room Matrix</h4>
                        ...
                        {MOCK_ROOMS.map(room => (
                            <div key={room.id} className="flex items-center justify-between p-4 rounded-2xl hover:bg-primary/5 transition-all">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-xs font-black truncate max-w-[100px]">{room.name}</span>
                                </div>
                ...
                <div className="p-10 bg-primary rounded-[3rem] text-white shadow-2xl shadow-primary/20 text-center space-y-4">
                    ...
                    <h4 className="text-xl font-black tracking-tight leading-none uppercase">Instant <br />Reservation</h4>
                    <p className="text-[10px] font-bold opacity-80 uppercase tracking-widest leading-relaxed">AI analyzes your schedule to find the perfect slot</p>
                    <Button variant="secondary" className="w-full h-12 rounded-xl font-black text-[10px] uppercase tracking-widest mt-4">Fast Book</Button>
                </div>
            </div>
        </div>
    );
