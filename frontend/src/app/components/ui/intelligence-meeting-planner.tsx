...
export function IntelligenceMeetingPlanner() {
 ...
 <h4 className="text-xl font-black tracking-tight leading-none ">Instant <br />Reservation</h4>
 <p className="text-[10px] font-bold opacity-80 tracking-tight leading-relaxed">AI analyzes your schedule to find the perfect slot</p>
 <Button variant="secondary" className="w-full h-12 rounded-xl font-black text-[10px] tracking-tight mt-4">Fast Book</Button>
 </div>
 </div>
 </div>
 );
