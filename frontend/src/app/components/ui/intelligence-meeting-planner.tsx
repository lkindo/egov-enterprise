...
export function IntelligenceMeetingPlanner() {
 ...
 <div className="p-10 bg-card border-2 border-primary/5 rounded-[0.1rem] shadow-2xl relative overflow-hidden group min-h-[600px]">
 ...
 <Button variant="ghost" size="icon" className="rounded-[0.1rem] h-10 w-10"><Star size={14} /></Button>
 </div>
 </div>
 ))}
 </div>
 ...
 <div className="p-8 bg-slate-900 text-white rounded-[0.1rem] shadow-2xl relative overflow-hidden group">
 ...
 <div className="p-8 bg-card border-2 border-primary/5 rounded-[0.1rem] shadow-xl space-y-6">
 ...
 <div className="p-10 bg-primary rounded-[0.1rem] text-white shadow-2xl shadow-primary/20 text-center space-y-4">
 ...
 <Button variant="secondary" className="w-full h-12 rounded-[0.1rem] font-black text-[10px] tracking-tight mt-4">빠른 예약</Button>
 </div>
 </div>
 </div>
 );
