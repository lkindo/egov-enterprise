...
export function IntelligenceMeetingPlanner() {
 ...
 <div className="p-10 bg-card border-2 border-primary/5 rounded-xl shadow-2xl relative overflow-hidden group min-h-[600px]">
 ...
 "w-12 h-16 rounded-xl border-2 font-black text-sm flex flex-col items-center justify-center transition-all",
 ...
 "group p-6 rounded-xl border-2 transition-all flex items-center justify-between",
 ...
 <Button className="absolute bottom-10 right-10 h-16 w-16 rounded-xl bg-slate-900 text-white shadow-2xl shadow-slate-900/40 hover:-translate-y-2 transition-all active:scale-95 group">
 ...
 <div className="p-8 bg-card border-2 border-primary/5 rounded-xl shadow-xl space-y-6">
 ...
 <div className="space-y-4">
 {MOCK_ROOMS.map(room => (
 <div key={room.id} className="flex items-center justify-between p-4 rounded-xl hover:bg-primary/5 transition-all">
 ...
 <div className="p-10 bg-primary rounded-xl text-white shadow-2xl shadow-primary/20 text-center space-y-4">
