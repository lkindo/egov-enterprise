...
export function IntelligenceMeetingPlanner() {
 ...
 <div>
 <h3 className="text-xl font-black tracking-tight ">?¤ë§ˆ???¤ì?ì¤„ë§ ìº”ë²„??/h3>
 <p className="text-[10px] font-black text-muted-foreground tracking-tight opacity-60 ">?¤ì‹œê°?ë¦¬ì†Œ??? ë‹¹ ?”ì§„</p>
 </div>
 </div>
 ...
 <h3 className="relative z-10 text-sm font-black tracking-[0.3em] opacity-50 mb-6 ">?œì„± ?©ëŸ‰</h3>
 ...
 <h4 className="text-sm font-black tracking-tight ">?Œì˜??ë§¤íŠ¸ë¦?Š¤</h4>
 ...
 <h4 className="text-xl font-black tracking-tight leading-none ">Instant <br />?ˆì•½</h4>
 <p className="text-[10px] font-bold opacity-80 tracking-tight leading-relaxed">AIê°€ ?¼ì •??ë¶„ì„?˜ì—¬ ìµœì ???œê°„??ì°¾ìŠµ?ˆë‹¤</p>
 <Button variant="secondary" className="w-full h-12 rounded-xl font-black text-[10px] tracking-tight mt-4">ë¹ ë¥¸ ?ˆì•½</Button>
 </div>
 </div>
 </div>
 );
