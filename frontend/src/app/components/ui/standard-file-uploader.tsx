...
export function StandardFileUploader({
 ...
 <p className="mb-1 text-sm text-foreground font-semibold">?´ë¦­?˜ê±°???Œì¼???œë˜ê·¸í•˜?¸ìš”</p>
 <p className="text-sm text-muted-foreground">ìµœë? {maxFiles}ê°? ?Œì¼??{maxSizeMB}MB ?œí•œ</p>
 </div>
