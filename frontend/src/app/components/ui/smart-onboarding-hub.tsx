...
export function SmartOnboardingHub() {
 ...
 <span className="text-[10px] font-black text-white/50 tracking-[0.4em]">Feature Spotlight</span>
 </div>
 </div>
 ...
 <span className="text-[10px] font-black text-primary tracking-[0.3em]">Module Guide</span>
 </div>
