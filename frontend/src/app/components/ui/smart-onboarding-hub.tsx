...
export function SmartOnboardingHub() {
 ...
 description: "李⑥꽭? 怨듦났 ?됱젙 ?쒖님님좊룄?섎뒗 吏?ν삎 ?댁쁺 ?뚮옯?쇱뿉 ?ㅼ떊 寃껋쓣 ?섏쁺?⑸땲님 ?명봽님愿?쒕님?鍮꾩쫰?덉뒪 ?뚰겕?뚮줈?곌퉴吏, ?곗씠님以묒떖님업무 ?섍꼍님?뱀떊님湲곕떎由쎈땲님",
 ...
 {
 title: "?뚰겕?뚮줈님?꾨줈?몄뒪 罹붾쾭님,
 description: "蹂듭옟님鍮꾩쫰?덉뒪 濡쒖쭅님?쒓컖?붾맂 罹좊쾭?ㅼ뿉님愿由ы븯?몄슂. ?꾨찓님?대깽님湲곕컲님?ㅻ쭏님?붿쭊님?뱀떊님업무 ?꾨줈?몄뒪瑜님좎뿰?섍쾶 ?곌껐?⑸땲님",
 icon: <Layout className="text-indigo-500" size={40} />
 },
 {
 title: "?섏씠님?곗씠님洹몃━님,
 description: "?뷀꽣?꾨씪?댁쫰湲님?⑸웾 ?곗씠?곕? 怨좎꽦님洹몃━?쒕줈 ?꾨꼍님?쒖뼱?⑸땲님 而щ읆 怨좎젙, ?ㅼ떆媛님꾪꽣留? ?몃씪님?섏젙님?듯빐 ?곗씠님?듭같?μ쓣 洹밸님뷀븯?몄슂.",
 ...
 <span className="text-sm font-bold text-white/80">吏곴님곸씤 ?ъ슜님?명꽣?섏씠님/span>
 </div>
 <div className="flex items-center gap-3">
 <CheckCircle2 size={16} className="text-emerald-500" />
 <span className="text-sm font-bold text-white/80">?ㅼ떆媛님곗씠님?곕룞 諛?분석</span>
 </div>
 </div>
 </div>
