                ...
                <div className="space-y-10">
                    <div>
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h2 className="text-3xl font-black tracking-tighter uppercase italic">Dispatch Center</h2>
                        </div>
                    ...
                    <div className="space-y-6">
                        <label className="text-[10px] font-black text-primary uppercase tracking-[0.3em] ml-2">Channel Selection</label>
                        ...
                        <div className="p-6 rounded-[2.5rem] bg-muted/40 border-2 border-dashed border-primary/10 flex items-center justify-between hover:border-primary/30 transition-colors cursor-pointer group/target">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] font-bold text-muted-foreground opacity-50 uppercase tracking-widest">1,204 Recipients found</p>
                                </div>
                            </div>
                    ...
                    <div className="flex gap-4 pt-6">
                        <div className="flex-1 p-6 rounded-[2rem] bg-indigo-500/5 border border-indigo-500/10">
                            <div className="flex items-center gap-2 text-indigo-600 mb-2">
                                <ShieldCheck size={16} />
                                <span className="text-[9px] font-black uppercase tracking-widest leading-none">Integrity Pass</span>
                            </div>
                ...
                <div className="flex flex-col gap-6">
                    <div className="flex-1 flex flex-col p-10 bg-card border-2 border-primary/10 rounded-[3.5rem] shadow-2xl relative group/editor">
                        <div className="flex items-center justify-between mb-8">
                            <div className="flex items-center gap-4">
                                ...
                                <span className="text-xs font-black uppercase tracking-widest">Composer</span>
                            </div>
                            <Button
                                variant="ghost"
                                onClick={simulateAIGenerate}
                                disabled={isGenerating}
                                className="rounded-xl h-10 px-6 gap-2 bg-gradient-to-r from-indigo-500 to-purple-600 text-white font-black text-[10px] uppercase tracking-widest shadow-lg shadow-indigo-500/20 hover:scale-105 active:scale-95 transition-all"
                            >
                        ...
                        <div className="pt-6 border-t border-primary/5 flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-3">
                                <span className="text-[10px] font-black text-muted-foreground uppercase opacity-40">Words: {message.length}</span>
                                <Button className="h-14 px-10 rounded-2xl font-black text-xs uppercase tracking-[0.2em] shadow-2xl shadow-primary/30 gap-3 group/send">
                    ...
                    <div className="p-6 bg-slate-900 rounded-[2rem] text-white flex items-center justify-between shadow-xl">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <p className="text-[10px] font-black uppercase tracking-widest opacity-60">Visual Preview</p>
                                <p className="text-xs font-bold">Mobile Lockscreen Widget (Mockup)</p>
                            </div>
                        </div>
