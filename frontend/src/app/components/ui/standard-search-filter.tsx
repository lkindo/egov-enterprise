      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="text-base font-black text-foreground tracking-tighter leading-none uppercase">Í≤Ä??Ï°∞Í±¥ ?§Ï†ï</h3>
              <p className="text-[10px] font-black text-muted-foreground/50 mt-1.5 uppercase tracking-widest">Í≥†Í∏â ?ÑÌÑ∞Îß??úÏä§??/p>
            </div>
          </div>
          <Button
            type="button"
          ...
          >
            ...
            <span className="text-[10px] tracking-widest font-black uppercase">?ÑÌÑ∞ {isExpanded ? '?ëÍ∏∞' : '?ºÏπòÍ∏?}</span>
          </Button>
        </div>
                ...
                {field.type === 'select' ? (
                  ...
                  >
                    <SelectTrigger className="h-12 rounded-xl border border-input bg-background focus:ring-4 focus:ring-primary/10 hover:border-primary/50 transition-all font-bold text-sm ring-offset-background shadow-sm">
                      <SelectValue placeholder={field.placeholder || "?ÑÏ≤¥"} />
                    </SelectTrigger>
                    ...
                    <PopoverTrigger asChild>
                      ...
                      >
                        ...
                        {values[field.name]?.from ? (
                          ...
                          <span className="tracking-tight uppercase text-[10px] font-black tracking-widest">?†Ïßú Î≤îÏúÑ ?†ÌÉù</span>
                        )}
                      </Button>
                    </PopoverTrigger>
