    ...
    <div className="w-full space-y-4">
      <div className="flex items-center justify-between mb-2 px-2">
        ...
        <div className="flex items-center gap-2">
          <div className="w-2 h-2 rounded-lg" style={{ backgroundColor: color }} />
      ...
      <div className="grid grid-cols-2 gap-x-8 gap-y-2 mt-4 w-full px-4">
        {(data || []).map((item, index) => (
          <div key={`legend-${index}`} className="flex items-center gap-2">
            <div className="w-2.5 h-2.5 rounded-lg shrink-0" style={{ backgroundColor: colors[index % colors.length] }} />
