...
/**
 * 1. GaugeChart
 * DB Ïª§ÎÑ•??Î∞?Î¶¨ÏÜå???¨Ïö©Î•†ÏùÑ Í≥ÑÍ∏∞???ïÌÉúÎ°??úÍ∞Å?? */
...
/**
 * 2. RealtimeSparkline
 * CPU/MEM Ï∂îÏù¥Î•?Î≥¥Ïó¨Ï£ºÎäî Ï¥àÏÜå??ÎØ∏ÏÑ∏ Ï∂îÏÑ∏?? */
...
/**
 * 3. SystemStatusRadar
 * Í∞Ä?©ÏÑ±, Î≥¥Ïïà, ?±Îä•, ?àÏ†ï???±Ïùò ?§Ï∞®??Î∂ÑÏÑù
 */
...
/**
 * 4. ActivityAreaChart
 * ?úÎèô ?∏Î†å???? ÏµúÍ∑º 7??Î°úÍ∑∏????Î•??îÎ†§??Í∑∏Îùº?∞Ïù¥??Î©¥Ï†Å Ï∞®Ìä∏Î°??úÍ∞Å?? */
    ...
    <div className="w-full space-y-4">
      <div className="flex items-center justify-between mb-2 px-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] font-bold text-foreground opacity-60">?µÍ≥Ñ ?ÑÎ°úÎ∏?/span>
        </div>
      </div>
 ...
 * ?∞Ïù¥??Î∂ÑÌè¨(?? ?¨Ïö©????ï† Íµ¨ÏÑ±)Î•??∏Î†®??Îß??ïÌÉú???ÑÎÑõ Ï∞®Ìä∏Î°??úÍ∞Å?? */
