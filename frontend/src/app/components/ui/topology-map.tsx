          ...
          >
            <div className="flex flex-col items-center gap-4">
               <div className={cn(
                 ...
                 <div className={cn(
                    "absolute -top-1 -right-1 w-4 h-4 rounded-lg border-4 border-slate-950",
                    getNodeColor(node.status)
                 )} />
               </div>
               
               <div className="text-center">
                 <p className="text-xs font-bold tracking-tighter text-white uppercase opacity-100 group-hover:opacity-100 transition-opacity">
                   {node.label}
                 </p>
                 <p className={cn(
