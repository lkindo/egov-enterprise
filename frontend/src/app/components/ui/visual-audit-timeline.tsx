            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-6 pb-6 border-b border-primary/5">
                <div className="flex items-center gap-5">
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-3 mt-1">
                            ...
                            <span className="text-[10px] font-bold text-muted-foreground uppercase opacity-50 tracking-widest leading-none">Real-time threat monitoring</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-3 w-full md:w-auto">
                    <div className="relative flex-1 md:w-64">
                        ...
                        <input
                            className="w-full bg-muted/40 border-none rounded-2xl py-3 pl-12 pr-4 text-xs font-bold outline-none ring-2 ring-transparent focus:ring-primary/20 transition-all"
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        {log.changes.map((change, cIdx) => (
                                            <div key={cIdx} className="space-y-3 p-5 rounded-2xl bg-background border border-primary/5 shadow-sm group/change">
                                                <label className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">{change.field}</label>
                                                <div className="flex items-center gap-4">
                                                    <div className="flex-1 p-3 rounded-xl bg-rose-50/50 border border-rose-100/50 text-xs font-medium text-rose-600 line-through decoration-rose-300 opacity-60">
                                                        {change.before}
                                                    </div>
                                                    <ArrowRight size={14} className="text-muted-foreground/30 animate-pulse" />
                                                    <div className="flex-1 p-3 rounded-xl bg-emerald-50/50 border border-emerald-100/50 text-xs font-bold text-emerald-600 transition-all group-hover/change:bg-emerald-100">
                                                        {change.after}
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between pt-6 border-t border-primary/5">
                <div className="flex items-center gap-6">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">Master Ledger Synced</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <div className="w-2 h-2 rounded-full bg-blue-500 animate-pulse" />
                        <span className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">Encryption Key: NIST-P384</span>
                    </div>
                </div>
                <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest opacity-40 mt-4 md:mt-0">
