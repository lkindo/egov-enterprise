...
const MobileDomainNode = ({
 ...
 onClick={onSelect}
 className={cn(
 "flex items-center justify-between w-full px-4 py-3.5 rounded-2xl transition-all duration-500 border font-black text-sm tracking-tight",
 isActive
...
export function Sidebar({ initialMenus = [] }: { initialMenus?: any[] }) {
 ...
 <span className="text-base font-black tracking-tighter leading-none">엔터프라이즈</span>
 ...
 <div className="text-[11px] font-black text-muted-foreground/40 tracking-[0.25em]">
 서비스 모듈
 </div>
 </div>
 ...
 <span className="text-[10px] font-black text-primary tracking-tighter">eGovFrame 5.0</span>
 </div>
 <p className="text-[9px] font-bold text-muted-foreground/50 leading-relaxed tracking-tight">
 현대화된 엔터프라이즈 UI 키트
 <br />
 최종 버전 1.0.2
 </p>
