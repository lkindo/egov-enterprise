...
import {
  ...
  ApiResponseBoardMetaDtoResponseSchema,
  ...
  ApiResponseListMenuBookmarkDtoResponseSchema,
...
export const getPostOperation = /*#__PURE__*/ defineGeneratedOperation({
  ...
  querySchema: z.object({ "countView": z.boolean().optional() }).strict(),
  requestSchema: null,
...
export const getMyBookmarksOperation = /*#__PURE__*/ defineGeneratedOperation({
  ...
  querySchema: null,
  requestSchema: null,
  responseSchema: z.array(z.lazy(() => MenuBookmarkDtoResponseSchema)),
...
export const getBoardMetaOperation = /*#__PURE__*/ defineGeneratedOperation({
  ...
  querySchema: null,
  requestSchema: null,
  responseSchema: z.lazy(() => BoardMetaDtoResponseSchema),
...
export const getPendingOperation = /*#__PURE__*/ defineGeneratedOperation({
  ...
  multipartParts: null,
  pathSchema: null,
  querySchema: z.object({ "keyword": z.string().optional(), "fromYmd": z.string().optional(), "toYmd": z.string().optional(), "page": z.number().int().min(0).optional(), "size": z.number().int().min(1).optional(), "sort": z.array(z.string()).optional() }).strict(),
  requestSchema: null,
  responseSchema: z.lazy(() => PageResponseInformalSanctionDtoResponseSchema),
  envelopeSchema: ApiResponsePageResponseInformalSanctionDtoResponseSchema,
  requestForbiddenPaths: [],
