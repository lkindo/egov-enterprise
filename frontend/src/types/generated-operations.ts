...
import {
  ...
  ApiResponseCatalogResponseSchema,
  ...
  ApiResponseListDepartmentChoiceResponseSchema,
  ApiResponseListDeptManageDtoResponseSchema,
  ApiResponseListFileDtoResponseSchema,
  ApiResponseListGroupSummaryResponseSchema,
  ...
  ApiResponsePageResponseChangeResponseSchema,
  ...
  ApiResponsePageResponseUserChoiceResponseSchema,
  ...
  CommunityBoardDtoResponseSchema,
  ...
  PageResponseChangeResponseSchema,
  ...
  PageResponseUserChoiceResponseSchema,
...
export const updatePollOperation = /*#__PURE__*/ defineGeneratedOperation({
  ...
  pathSchema: z.object({ "pollSn": z.number().int() }).strict(),
  querySchema: null,
  requestSchema: OnlinePollManageRequestRequestSchema.strict(),
  responseSchema: null,
  envelopeSchema: ApiResponseVoidResponseSchema,
  requestForbiddenPaths: [],
  responseForbiddenPaths: [],
...
export const updateEventOperation = /*#__PURE__*/ defineGeneratedOperation({
  ...
  pathSchema: z.object({ "evntSn": z.number().int() }).strict(),
  querySchema: null,
  requestSchema: EventInfoRequestRequestSchema.strict(),
  responseSchema: null,
  envelopeSchema: ApiResponseVoidResponseSchema,
  requestForbiddenPaths: [],
  responseForbiddenPaths: [],
...
export const authzMembershipsOperation = /*#__PURE__*/ defineGeneratedOperation({
  ...
  querySchema: null,
  requestSchema: null,
  responseSchema: z.lazy(() => MembershipSnapshotResponseSchema),
...
export const authzReplaceMembershipsOperation = /*#__PURE__*/ defineGeneratedOperation({
  ...
  pathSchema: z.object({ "userId": z.string() }).strict(),
  querySchema: null,
  requestSchema: ReplaceGroupsRequestSchema.strict(),
  responseSchema: null,
  envelopeSchema: ApiResponseVoidResponseSchema,
  requestForbiddenPaths: [],
  responseForbiddenPaths: [],
...
export const authzDeleteGroupOperation = /*#__PURE__*/ defineGeneratedOperation({
  ...
  multipartParts: null,
  pathSchema: z.object({ "code": z.string() }).strict(),
  querySchema: z.object({ "version": z.string() }).strict(),
  requestSchema: null,
  responseSchema: null,
  envelopeSchema: ApiResponseVoidResponseSchema,
  requestForbiddenPaths: [],
...
export const authzDepartmentMembershipsOperation = /*#__PURE__*/ defineGeneratedOperation({
  ...
  requestRequired: false,
  multipartParts: null,
  pathSchema: z.object({ "departmentId": z.string() }).strict(),
  querySchema: null,
  requestSchema: null,
  responseSchema: z.lazy(() => DepartmentSnapshotResponseSchema),
...
export const authzUpdateDepartmentMembershipsOperation = /*#__PURE__*/ defineGeneratedOperation({
  ...
  pathSchema: z.object({ "departmentId": z.string() }).strict(),
  querySchema: null,
  requestSchema: ChangeDepartmentGroupsRequestSchema.strict(),
  responseSchema: z.lazy(() => DepartmentSnapshotResponseSchema),
  envelopeSchema: ApiResponseDepartmentSnapshotResponseSchema,
  requestForbiddenPaths: [],
  responseForbiddenPaths: [],
...
export const authzGroupsOperation = /*#__PURE__*/ defineGeneratedOperation({
  ...
  querySchema: null,
  requestSchema: null,
  responseSchema: z.array(z.lazy(() => GroupSummaryResponseSchema)),
...
export const getCommunityBoardsOperation = /*#__PURE__*/ defineGeneratedOperation({
  ...
  querySchema: null,
  requestSchema: null,
  responseSchema: z.array(z.lazy(() => CommunityBoardDtoResponseSchema)),
...
export const authzUsersOperation = /*#__PURE__*/ defineGeneratedOperation({
  ...
  multipartParts: null,
  pathSchema: null,
  querySchema: z.object({ "keyword": z.string().optional(), "page": z.number().int().optional(), "size": z.number().int().optional() }).strict(),
  requestSchema: null,
...
export const authzHistoryOperation = /*#__PURE__*/ defineGeneratedOperation({
  ...
  multipartParts: null,
  pathSchema: null,
  querySchema: z.object({ "page": z.number().int().optional(), "size": z.number().int().optional(), "groupCode": z.string().optional(), "userId": z.string().optional(), "actorId": z.string().optional(), "fromDate": z.string().optional(), "toDate": z.string().optional() }).strict(),
  requestSchema: null,
...
export const authzDepartmentsOperation = /*#__PURE__*/ defineGeneratedOperation({
  ...
  querySchema: null,
  requestSchema: null,
  responseSchema: z.array(z.lazy(() => DepartmentChoiceResponseSchema)),
...
export const authzCatalogOperation = /*#__PURE__*/ defineGeneratedOperation({
  ...
  querySchema: null,
  requestSchema: null,
  responseSchema: z.lazy(() => CatalogResponseSchema),
