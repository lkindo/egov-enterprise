...
export interface paths {
    ...
    "/api/v1/admin/digital-assets/{knoId}": {
        ...
        /**
         * 지식정보 상세 조회
         * @description 지식정보 상세 정보를 조회합니다.
         */
        get: operations["getKnowledge"];
        /**
         * 지식정보 수정
         * @description 지식정보를 수정합니다.
         */
        put: operations["updateKnowledge"];
        post?: never;
        /**
         * 지식정보 삭제
         * @description 지식정보를 삭제합니다.
         */
    ...
    "/api/v1/admin/system/users": {
        ...
        /**
         * 사용자 다중 삭제
         * @description 시스템에서 여러 명의 사용자를 한꺼번에 삭제합니다.
         */
    ...
    "/api/v1/admin/digital-assets": {
        ...
        /**
         * 지식정보 목록 조회
         * @description 지식정보(디지털 자산) 목록을 페이징하여 조회합니다.
         */
        get: operations["getKnowledgeList"];
        put?: never;
        /**
         * 지식정보 등록
         * @description 새로운 지식정보를 등록합니다.
         */
    ...
    "/api/v1/users": {
        ...
        /**
         * 사용자 목록 조회 (전체)
         * @description 페이징 없이 모든 사용자 목록을 조회합니다.
         */
    ...
    "/api/v1/admin/system/comments": {
        ...
        /**
         * ?꾩껜 ?볤? 紐⑸줉 議고쉶
         * @description ?쒖뒪???댁쓽 紐⑤뱺 ?볤? 紐⑸줉??議고쉶?⑸땲??
         */
