...
export const UserDtoSchema = z.object({
  ...
  pswdCnsr: z.string().min(0).max(100).optional(),
  ...
  baseAddr: z.string().min(0).max(300).optional(),
  dtlAddr: z.string().min(0).max(300).optional(),
  ...
  crtfcDnValue: z.string().min(0).max(255).optional(),
