...
// [하향 래칫 2026-09-20(7)] 386 -> 382. 게시글 상세의 삭제 버튼 4건. 아이콘만 있는 80px 버튼이
//   팔레트 리터럴로 조판돼 hover 하면 흰 글자가 되는 조합이었다 — destructive 토큰 + '삭제'
//   라벨로 바꿨다(아이콘만 있는 파괴적 버튼은 무엇이 지워지는지 말하지 않는다).
// [하향 래칫 2026-09-20(8)] 382 -> 324. 모니터링 허브와 그 패널 모음에서 58건. 이 두 파일이
...
// [하향 래칫 2026-09-20(10)] 308 -> 292. 기관코드 관리의 16건. 사용 중·완료·대기·변경 구분
...
// [하향 래칫 2026-09-20(12)] 277 -> 224. 워크플로 분석 배치 53건 — 감사 타임라인 20, 게시판 마스터 15,
//   온라인 투표 관리 12, 투표 참여 6. 네 화면 모두 상태 배지·심각도 배지·선택 표시가 팔레트
//   리터럴이었고 여러 조합이 AA 미달이었다(감사 타임라인 선택 노드 1.39:1, 투표 상태 2.15~3.67:1,
//   마스터 비활성 hover 2.15:1). success/warning/destructive 틴트 + 전경 토큰으로 옮겼다.
// [하향 래칫 2026-09-20(13)] 224 -> 193. 배치 2 의 31건 — 세션 만료 경고 17, 파일 업로더 8,
//   쪽지함 2, 정책 관리 2, 행사·포상 2. 세션 경고는 파일 전체가 팔레트 리터럴이었고 닫기
//   컨트롤이 라이트에서 1.61:1 이었다. 업로더는 완료 칩이 약 2.4:1 인 고정 라이트 틴트였다.
