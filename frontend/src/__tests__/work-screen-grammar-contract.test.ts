...
/**
 * 2026-09-23 동결. 남은 `h-11` 은 VRT 기준선 화면·공통 레이아웃, 정사각 아이콘 버튼, 큰 글꼴 입력칸,
 * `size` 변형과 겹치는 버튼이라 화면별로 판단해야 한다(GAP-UIDENSITY-001). 나머지는 `h-10`·`h-8` 등
 * 다른 고정 높이다. 파일의 수가 줄면 여기서도 내리고, 0 이 되면 항목을 지운다.
 */
const CONTROL_HEIGHT_OVERRIDES: Readonly<Record<string, number>> = {
  'app/admin/collaboration/mail-send/MailSendHubClient.tsx': 5,
  'app/admin/collaboration/scraps/selectScrapList/ScrapListClient.tsx': 2,
  'app/admin/community/board/CommunityBoardClient.tsx': 3,
  'app/admin/community/boards/select-board-list/components/BoardPagination.tsx': 2,
  'app/admin/community/templates/TemplateAdminClient.tsx': 4,
  ...
  'app/admin/security/authority/components/SecurityMatrixVisualizer.tsx': 1,
  ...
  'app/admin/survey/manage/[id]/SurveyManageDetailClient.tsx': 1,
  ...
  'app/admin/system/layout/LayoutManagerClient.tsx': 1,
  ...
  'app/admin/uss/ion/sms/SmsAdminClient.tsx': 2,
  'app/admin/uss/olh/online-manual/ManualAdminClient.tsx': 3,
  ...
  'app/components/ui/standard-search-filter.tsx': 3,
  ...
  'components/admin/system/ProgramForm.tsx': 2,
