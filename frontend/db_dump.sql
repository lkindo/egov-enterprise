...
INSERT INTO public."nmenuinfo" ("menu_nm", "progrm_file_nm", "menu_no", "upper_menu_no", "menu_ordr", "menu_dc", "relate_image_path", "relate_image_nm", "route_updated_at", "modern_route", "frst_register_id", "last_updusr_id", "frst_regist_pnttm", "last_updt_pnttm") VALUES
  ...
  ('마이페이지관리', 'EgovIndvdlpgeCntntsList', '2030100', '2030000', '5', '마이페이지관리', '/', '/', NULL, '/admin/workspace/mypage', NULL, NULL, NULL, NULL),
  ...
  ('설문관리', 'EgovQustnrManageList', '2010100', '2010000', '20', '설문관리', '/', '/', NULL, '/admin/survey/manage', NULL, NULL, NULL, NULL),
  ...
  ('설문템플릿관리', 'EgovQustnrTmplatManageList', '2010300', '2010000', '22', '설문템플릿관리', '/', '/', NULL, '/admin/survey/templates', NULL, NULL, NULL, NULL),
  ('응답자관리', 'EgovQustnrRespondManageList', '2010400', '2010000', '23', '응답자관리', '/', '/', NULL, '/admin/survey/respondents', NULL, NULL, NULL, NULL),
  ('질문관리', 'EgovQustnrQestnManageList', '2010500', '2010000', '24', '질문관리', '/', '/', NULL, '/admin/survey/questions', NULL, NULL, NULL, NULL),
  ('항목관리', 'EgovQustnrItemManageList', '2010600', '2010000', '25', '항목관리', '/', '/', NULL, '/admin/survey/items', NULL, NULL, NULL, NULL),
  ('그룹관리', 'EgovGroupList', '9020210', '9020200', '3', '그룹관리', '/', '/', NULL, '/admin/security/group', NULL, NULL, NULL, NULL),
  ('롤관리', 'EgovRoleList', '9020220', '9020200', '4', '롤관리', '/', '/', NULL, '/admin/security/role', NULL, NULL, NULL, NULL),
  ('ROOT', 'dir', '800000000', '800000000', '0', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
  ('외부인사정보', 'EgovTnextrlHrInfoList', '2030200', '2030000', '33', '외부인사정보', '/', '/', NULL, '/admin/operation/external-hr', NULL, NULL, NULL, NULL),
  ('사용자부재관리', 'selectUserAbsnceListView', '2030500', '2030000', '43', '사용자부재관리', '/', '/', NULL, '/admin/user/absences', NULL, NULL, NULL, NULL),
  ...
  ('포상관리', 'selectRwardManageList', '2030300', '2030000', '34', '포상관리', '/', '/', NULL, '/admin/operation/rewards', NULL, NULL, NULL, NULL),
  ...
  ('부서권한관리', 'EgovDeptAuthorList', '9020230', '9020200', '5', '부서권한관리', '/', '/', NULL, '/admin/security/dept-authority', NULL, NULL, NULL, NULL),
  ...
  ('온라인poll관리', 'listOnlinePollManage', '2010700', '2010000', '27', '온라인poll관리', '/', '/', NULL, '/admin/survey/polls/manage', NULL, NULL, NULL, NULL),
  ('온라인poll참여', 'listOnlinePollPartcptn', '2010800', '2010000', '28', '온라인poll참여', '/', '/', NULL, '/admin/survey/polls/participate', NULL, NULL, NULL, NULL),
