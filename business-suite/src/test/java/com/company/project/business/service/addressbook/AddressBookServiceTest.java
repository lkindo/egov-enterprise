...
class AddressBookServiceTest {
    ...
    void createAddressBook_WithUsers_Success() throws Exception {
        ...
        com.company.project.business.service.addressbook.dto.AddressBookUserDto userDto = 
            com.company.project.business.service.addressbook.dto.AddressBookUserDto.builder().emplyrId("EMP_1").nm("User").build();
        ...
        // Then
        verify(addressBookRepository).save(any(AddressBook.class));
        verify(addressBookUserRepository).save(any(com.company.project.business.domain.addressbook.AddressBookUser.class));
    }
    ...
    void updateAddressBook_WithUserUpdates_Success() throws Exception {
        ...
        com.company.project.business.domain.addressbook.AddressBookUser existingUser = 
            com.company.project.business.domain.addressbook.AddressBookUser.builder().emplyrId("REMOVE_ME").adbkId(adbkId).build();
        ...
        com.company.project.business.service.addressbook.dto.AddressBookUserDto newUserDto = 
            com.company.project.business.service.addressbook.dto.AddressBookUserDto.builder().emplyrId("ADD_ME").nm("New User").build();
    ...
    void searchUsers_Success() {
        // Given
        com.company.project.business.domain.addressbook.AddressBookUserSearchResult view = mock(com.company.project.business.domain.addressbook.AddressBookUserSearchResult.class);
        given(view.getEmplyrId()).willReturn("EMP_1");
        given(view.getNm()).willReturn("Name");
        Page<com.company.project.business.domain.addressbook.AddressBookUserSearchResult> page = new PageImpl<>(List.of(view));
        given(addressBookRepository.searchAddressBookUsers(any(), any(Pageable.class))).willReturn(page);

        // When
        Page<com.company.project.business.service.addressbook.dto.AddressBookUserDto> result = 
