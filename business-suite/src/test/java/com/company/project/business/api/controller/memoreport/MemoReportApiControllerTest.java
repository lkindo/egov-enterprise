package com.company.project.business.api.controller.memoreport;

import com.company.project.business.service.memoreport.EgovMemoReportService;
...
class MemoReportApiControllerTest {
    ...
    void getMemoReport_success() throws Exception {
        when(memoReportService.getMemoReport("R1")).thenReturn(MemoReportDto.builder().reprtId("R1").build());
    ...
    void createMemoReport_success() throws Exception {
        MemoReportDto dto = MemoReportDto.builder().reprtSj("Subject").build();
    ...
    void updateMemoReport_success() throws Exception {
        MemoReportDto dto = MemoReportDto.builder().reprtSj("Update").build();
