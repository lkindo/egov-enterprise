...
class InstitutionCodeTest {
    ...
    void testBuilderAndGetter() {
        ...
        assertEquals("하위기관명", code.getLwtrkInstNm());
        ...
        assertEquals("UP", code.getUpInstCd());
        assertEquals("RPRS", code.getRprsInstCd());
        ...
        assertEquals(1, code.getSortSeq());
        assertEquals("admin", code.getCreatedBy());
    }
    ...
    void testUpdate() {
        ...
        assertEquals("N_LOW", code.getLwtrkInstNm());
        ...
        assertEquals("U2", code.getUpInstCd());
        assertEquals("R2", code.getRprsInstCd());
        ...
        assertEquals(2, code.getSortSeq());
        assertEquals("user", code.getLastModifiedBy());
    }
