...
public class BoardDto {
    ...
    public static BoardDto from(com.company.project.business.domain.board.BoardSearchResult result) {
        return BoardDto.builder()
                .id(result.getNttId())
    ...
    public static BoardDto from(com.company.project.business.domain.board.BoardDetailResult detail) {
        return BoardDto.builder()
                .id(detail.getNttId())
