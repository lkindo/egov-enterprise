...
public interface BoardMapper {
    ...
    @Mapping(target = "knoId", source = "nttId", qualifiedByName = "longToString")
    @Mapping(target = "knoNm", source = "nttSj")
    @Mapping(target = "knoCn", source = "nttCn")
    ...
    @Mapping(target = "blogAt", source = "blogId", qualifiedByName = "blogIdToYn")
    @Mapping(target = "commentCo", source = "commentCo", defaultValue = "0")
    @Mapping(target = "eventDateStr", source = "eventDate", qualifiedByName = "formatDateTime")
    @Mapping(target = "isExpired", source = "ntceEndde", qualifiedByName = "calculateExpired")
    ...
    @Mapping(target = "replyAt", constant = "N")
    @Mapping(target = "replyLc", constant = "0")
    @Mapping(target = "useAt", source = "request.useAt", defaultValue = "Y")
    ...
    @Mapping(target = "commentCo", constant = "0")
    @Mapping(target = "fileCo", constant = "0")
    ...
    @Mapping(target = "replyAt", constant = "Y")
    @Mapping(target = "replyLc", source = "replyLc")
    @Mapping(target = "useAt", source = "request.useAt", defaultValue = "Y")
    @Mapping(target = "qnaStatus", source = "request.qnaStatus", defaultValue = "OPEN")
    @Mapping(target = "eventDate", source = "request.eventDate", qualifiedByName = "parseDateTime")
    @Mapping(target = "inqireCo", constant = "0")
