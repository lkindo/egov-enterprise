...
CREATE TABLE NEMPLYRINFO (
  ...
  KEY NEMPLYRINFO_ibfk_2 (GROUP_ID),
  KEY NEMPLYRINFO_ibfk_1 (ORGNZT_ID),
...
CREATE TABLE NEMPLYRSCRTYESTBS (
  ...
  KEY NEMPLYRSCRTYESTBS_ibfk_4 (AUTHOR_CODE),
...
CREATE TABLE NENTRPRSMBER (
  ...
  KEY NENTRPRSMBER_ibfk_1 (GROUP_ID),
