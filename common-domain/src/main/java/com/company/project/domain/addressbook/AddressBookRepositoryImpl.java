...
public class AddressBookRepositoryImpl implements AddressBookRepositoryCustom {
    ...
    @Override
    public Page<AddressBook> searchAddressBooks(String userId, String orgnztId, String searchCondition, String searchKeyword, Pageable pageable) {
        ...
        List<AddressBook> content = queryFactory
                ...
                .where(addressBook.useAt.eq("Y")
                        .and(addressBook.othbcScope.eq("회사")
                                ...
                                .or(addressBook.othbcScope.eq("부서").and(addressBook.trgetOrgnztId.eq(orgnztId)))),
                        searchPredicate)
    ...
    public Page<AddressBookUserSearchResult> searchAddressBookUsers(String searchKeyword, Pageable pageable) {
        ...
        combinedResults.addAll(queryFactory
                .select(Projections.fields(AddressBookUserSearchResult.class,
                        enterpriseUser.enterpriseMberId.as("emplyrId"),
        ...
        // Note: Real implementation would handle proper offset/limit across 3 queries or use a view.
