...
public interface BackupResultRepository extends JpaRepository<BackupResult, String> {
     ...
     default Page<BackupResult> searchBackupResults(String sttus, String searchKeywordFrom, String searchKeywordTo,
               String searchCondition, String searchKeyword, Pageable pageable) {
          return selectBackupResultList(sttus, searchKeywordFrom, searchKeywordTo, searchCondition, searchKeyword,
                    pageable)
