...
public class LoginScrinImage {
    ...
    @Builder
    public LoginScrinImage(String imageId, String imageNm, String image, String imageFile, String imageDc,
            String reflctAt, String frstRegisterId) {
