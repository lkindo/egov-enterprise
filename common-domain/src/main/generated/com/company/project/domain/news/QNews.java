...
public class QNews extends EntityPathBase<News> {
    ...
    private static final long serialVersionUID = -815761961L;
    ...
    public final StringPath newsCn = createString("newsCn");

    public final StringPath newsId = createString("newsId");

    public final StringPath newsOrigin = createString("newsOrigin");

    public final StringPath newsSj = createString("newsSj");

    public final StringPath ntceDe = createString("ntceDe");
