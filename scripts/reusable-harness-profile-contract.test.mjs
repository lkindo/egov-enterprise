...
test('generated harness adaptation matches current source selectors and rejects census or display-name drift', (t) => {
  ...
  for (const [from, to] of [
    [`EXPECTED_MIGRATION_TEST_COUNT = ${generatedProfile ? 0 : 44};`, 'EXPECTED_MIGRATION_TEST_COUNT = 45;'],
    [`@DisplayName("${generatedProfile ? '' : '44개 '}migration 검증은`, '@DisplayName("45개 migration 검증은'],
  ]) {
