...
@WebMvcTest(OnlinePollAdminController.class)
@AutoConfigureMockMvc(addFilters = false)
@DisplayName("OnlinePollAdminController 테스트")
class OnlinePollAdminControllerTest {
    ...
    void getPolls_Success() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/admin/system/polls")
                ...
                .andExpect(jsonPath("$.data.resultList[0].pollId").value("P1"));
    }
}
