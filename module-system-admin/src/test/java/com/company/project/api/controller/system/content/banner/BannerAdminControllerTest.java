...
@DisplayName("BannerAdminController 테스트")
class BannerAdminControllerTest {
    ...
    void getBanners_Success() throws Exception {
        ...
        // When & Then
        mockMvc.perform(get("/api/v1/admin/system/banners")
                .param("keyword", "test")
    ...
    void getBanner_Success() throws Exception {
        ...
        // When & Then
        mockMvc.perform(get("/api/v1/admin/system/banners/B1")
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.success").value(true))
    ...
    void deleteBanner_Success() throws Exception {
        // When & Then
        mockMvc.perform(delete("/api/v1/admin/system/banners/B1")
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.success").value(true));
    ...
    void getReflectedBanners_Success() throws Exception {
        ...
        // When & Then
        mockMvc.perform(get("/api/v1/admin/system/banners/reflected")
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.success").value(true))
