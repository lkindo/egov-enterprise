...
public class BackupResultDto {
        ...
        public static BackupResultDto from(BackupResult entity) {
                return BackupResultDto.builder()
                                ...
                                .backupOpertNm(entity.getBackupOpert() != null
                                                ? entity.getBackupOpert().getBackupOpertNm()
                                                : null)
                                ...
                                .backupOrginlDrctry(
                                                entity.getBackupOpert() != null
                                                                ? entity.getBackupOpert().getBackupOrginlDrctry()
                                                                : null)
                                .backupStreDrctry(
                                                entity.getBackupOpert() != null
                                                                ? entity.getBackupOpert().getBackupStreDrctry()
                                                                : null)
