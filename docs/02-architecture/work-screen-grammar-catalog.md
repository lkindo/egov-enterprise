...
| 그중 `WorkListPage` 셸 경유 | **24** | W3 wave 1~4 — 되돌리기는 게이트가 red |
| 그중 셸 없이 직접 조립 | **25** | 신규 유입은 게이트가 red. 화면이 맞는 archetype 셸로 이행하면 함께 내려간다 |
