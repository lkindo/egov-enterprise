...
이 폴더는 [AGENTS.md](../../AGENTS.md#documentation-and-memory)의 문서 분류 규칙이 규정하는 **기획 문서**의 자리다.
...
---
*Last Updated: 2026-08-18 (AGENTS.md 공통 규칙 SSOT 연결 현행화. 2026-08-16 신설 — 규칙에만 있고 물리적으로 부재하던 폴더를 생성.)*
