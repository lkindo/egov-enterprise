...
- **미결 D 항목** — 2026-08-05 기준 **10건 중 3건 해소, 7건 잔여**. 해소분은 취소선으로 남긴다(원장에서 지우면 무엇이 왜 사라졌는지 추적이 끊긴다).
  ...
  - **D-4 설문 도메인** — `questions`·`items`·`respondents` 배선 vs 껍데기 라우트 삭제(실데이터 존재 — 스키마 확인 선행).
