...
| **Workers** | 1 | 2 | 로컬은 격리 스택의 자원 사용을 제한하기 위해 1 유지. CI는 2026-09-01 실측으로 2를 채택한 설정을 유지하고 추가 병렬성은 실행시간 기반 2-shard로 확보. 재편 뒤 재측정 필요 |
