...
ALTER TABLE tb_cmnty_info 
    ...
    RENAME COLUMN cmmnty_intrcn TO cmnty_intro_cn,
    ALTER COLUMN cmnty_intro_cn TYPE VARCHAR(4000),
...
ALTER TABLE tb_club_info 
    ...
    RENAME COLUMN clb_intrcn TO club_intro_cn,
    ALTER COLUMN club_intro_cn TYPE VARCHAR(4000),
    RENAME COLUMN regist_se_code TO reg_se_cd,
    ALTER COLUMN reg_se_cd TYPE VARCHAR(12),
    ALTER COLUMN use_yn TYPE CHAR(1),
    RENAME COLUMN creat_dt TO crt_dt;
...
ALTER TABLE tb_blog_info 
    ...
    RENAME COLUMN blog_intrcn TO blog_intro_cn,
    ALTER COLUMN blog_intro_cn TYPE VARCHAR(4000),
    RENAME COLUMN regist_se_code TO reg_se_cd,
    ALTER COLUMN reg_se_cd TYPE VARCHAR(12),
    RENAME COLUMN creat_dt TO crt_dt;
