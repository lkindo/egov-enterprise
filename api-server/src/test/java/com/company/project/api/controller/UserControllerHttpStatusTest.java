...
class UserControllerHttpStatusTest {
        ...
        @Test
        @DisplayName("POST /api/v1/users/signup - ?±Í≥µ ??200 OK Î∞òÌôò")
        ...
        @Test
        @DisplayName("POST /api/v1/users/signup - Ï§ëÎ≥µ ?¨Ïö©??IDÎ°??∏Ìïú 400 Bad Request Î∞òÌôò")
        ...
        @Test
        @DisplayName("GET /api/v1/users - ?±Í≥µ ??200 OK Î∞òÌôò")
        ...
        @Test
        @DisplayName("GET /api/v1/users/paged - ?±Í≥µ ??200 OK Î∞òÌôò")
        ...
        @Test
        @DisplayName("GET /api/v1/users/paged - ?òÎ™ª???òÏù¥ÏßÄ Î≤àÌò∏Î°??∏Ìïú 400 Bad Request Î∞òÌôò")
        ...
        @Test
        @DisplayName("POST /api/v1/users/signup - ?†Ìö®??Í≤Ä???§Ìå®Î°??∏Ìïú 400 Bad Request Î∞òÌôò")
        ...
        @Test
        @DisplayName("POST /api/v1/users/signup - ?úÎ≤Ñ ?¥Î? ?§Î•òÎ°??∏Ìïú 500 Internal Server Error Î∞òÌôò")
