...
/**
 * ?µí•© ?ŒìŠ¤?¸ë? ?„í•œ ìµœì†Œ ?¤ì •
 * ?ˆê±°??eGovFrame ì»´í¬?ŒíŠ¸ë¥??œì™¸?˜ê³  ?µì‹¬ ê¸°ëŠ¥ë§?ë¡œë“œ
 */
...
public class MinimalTestConfig {
    ...
    /**
     * ?ˆê±°??ì»´í¬?ŒíŠ¸?ì„œ ?”êµ¬?˜ëŠ” ë¹ˆë“¤??Mock?¼ë¡œ ?œê³µ
     * ?¤ì œ ?ŒìŠ¤?¸ì—?œëŠ” ?¬ìš©?˜ì? ?Šì?ë§?ApplicationContext ë¡œë”©???„í•´ ?„ìš”
     */
