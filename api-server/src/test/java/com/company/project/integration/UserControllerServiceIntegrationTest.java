...
class UserControllerServiceIntegrationTest {
    ...
    void registerUser_api_callsService() throws Exception {
        ...
        // Verify service method was called
        verify(userService, times(1)).registerUser(anyString(), anyString(), anyString(), anyString(), anyString(), any());
    }
    ...
    void dataTransfer_accuracyBetweenApiAndService() throws Exception {
        ...
        verify(userService, times(1)).signup(argThat(req ->
                req.userId().equals("accuracyTestUser") &&
