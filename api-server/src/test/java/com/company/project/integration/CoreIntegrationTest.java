...
class CoreIntegrationTest {
    ...
    void userSignupAndRetrieval_integrationTest() {
        ...
        UserDto newUser = userList.stream()
                .filter(u -> "coreIntegrationUser".equals(u.userId()))
                .findFirst()
                .orElse(null);
        assertThat(newUser).isNotNull();
        assertThat(newUser.userNm()).isEqualTo("핵심 통합 테스트 사용자");
    }
    ...
    void getUserById_integrationTest() {
        ...
        assertThat(retrievedUser.userId()).isEqualTo("coreIntegrationUser");
        assertThat(retrievedUser.userNm()).isEqualTo("핵심 통합 테스트 사용자");
        assertThat(retrievedUser.role()).isEqualTo("USER");
    }
    ...
    void multipleUsers_signupAndListRetrieval_integrationTest() {
        ...
        assertThat(userList).extracting(UserDto::userId)
                .contains("multiUser1", "multiUser2");
        assertThat(userList).extracting(UserDto::userNm)
