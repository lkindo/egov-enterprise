...
import nuri.business.service.group.GroupManageService;
...
public class GroupApiController {
    ...
    @GetMapping
    @org.springframework.security.access.prepost.PreAuthorize("@permissionPolicy.allowed(authentication, 'nuri.api.controller.foundation.controller.system.GroupApiController#getGroups')")
    ...
    @GetMapping("/{groupId}")
    @org.springframework.security.access.prepost.PreAuthorize("@permissionPolicy.allowed(authentication, 'nuri.api.controller.foundation.controller.system.GroupApiController#getGroup')")
    ...
    @PostMapping
    @org.springframework.security.access.prepost.PreAuthorize("@permissionPolicy.allowed(authentication, 'nuri.api.controller.foundation.controller.system.GroupApiController#createGroup')")
    ...
    @PutMapping("/{groupId}")
    @org.springframework.security.access.prepost.PreAuthorize("@permissionPolicy.allowed(authentication, 'nuri.api.controller.foundation.controller.system.GroupApiController#updateGroup')")
    ...
    @org.springframework.security.access.prepost.PreAuthorize("@permissionPolicy.allowed(authentication, 'nuri.api.controller.foundation.controller.system.GroupApiController#deleteGroup')")
    ...
    @DeleteMapping
    @org.springframework.security.access.prepost.PreAuthorize("@permissionPolicy.allowed(authentication, 'nuri.api.controller.foundation.controller.system.GroupApiController#deleteGroups')")
