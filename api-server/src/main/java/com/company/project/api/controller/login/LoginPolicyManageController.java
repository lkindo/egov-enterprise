...
/**
 * Î°úÍ∑∏???ïÏ±Ö Í¥ÄÎ¶¨Î? ?ÑÌïú Ïª®Ìä∏Î°§Îü¨ ?¥Îûò?? */
@Slf4j
@RestController
...
public class LoginPolicyManageController {
    ...
    /**
     * Î°úÍ∑∏???ïÏ±Ö Î™©Î°ù??Ï°∞Ìöå?úÎã§ (REST API)
     */
    @Operation(summary = "Î°úÍ∑∏???ïÏ±Ö Î™©Î°ù Ï°∞Ìöå")
    ...
    /**
     * Î°úÍ∑∏???ïÏ±Ö ?ÅÏÑ∏ ?ïÎ≥¥Î•?Ï°∞Ìöå?úÎã§ (REST API)
     */
    @Operation(summary = "Î°úÍ∑∏???ïÏ±Ö ?ÅÏÑ∏ Ï°∞Ìöå")
    ...
    /**
     * Î°úÍ∑∏???ïÏ±Ö???Ä???êÎäî ?òÏ†ï?úÎã§ (REST API)
     */
    @Operation(summary = "Î°úÍ∑∏???ïÏ±Ö ?Ä??)
    ...
    /**
     * Î°úÍ∑∏???ïÏ±Ö Î™©Î°ù ?îÎ©¥?ºÎ°ú ?¥Îèô?úÎã§
     */
    ...
    /**
     * Î°úÍ∑∏???ïÏ±Ö ?ÅÏÑ∏ ?ïÎ≥¥Î•?Ï°∞Ìöå?úÎã§ (JSP)
     */
