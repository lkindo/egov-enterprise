...
public class AnniversaryController {
    ...
    @Operation(summary = "기념일 목록 조회", description = "등록된 모든 기념일 목록을 페이징하여 조회합니다.")
    @GetMapping
    ...
    @Operation(summary = "내 기념일 목록 조회", description = "내가 등록한 기념일 목록을 조회합니다.")
    @GetMapping("/my")
    ...
    @Operation(summary = "기념일 삭제", description = "특정 기념일을 삭제합니다.")
    @DeleteMapping("/{annId}")
