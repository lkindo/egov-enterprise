...
public class RecentSrchwrdController {
    ...
    @Operation(summary = "검색어 관리 목록 조회", description = "최근 검색어 관리 설정 목록을 페이징하여 조회합니다.")
    @GetMapping("/manages")
    ...
    @Operation(summary = "검색어 관리 상세 조회", description = "특정 검색어 관리 설정의 상세 정보를 조회합니다.")
    ...
    @Operation(summary = "검색어 관리 등록", description = "새로운 최근 검색어 관리 설정을 등록합니다.")
    @PostMapping("/manages")
    ...
    @Operation(summary = "검색어 관리 수정", description = "기존 최근 검색어 관리 설정을 수정합니다.")
    ...
    @Operation(summary = "검색어 관리 삭제", description = "특정 최근 검색어 관리 설정을 삭제합니다.")
    ...
    @Operation(summary = "검색어 이력 목록 조회", description = "특정 관리 설정에 따른 최근 검색어 이력 목록을 조회합니다.")
    ...
    @Operation(summary = "최근 검색어 등록", description = "사용자가 검색한 단어를 최근 검색어 이력으로 등록합니다.")
    ...
    @Operation(summary = "최근 검색어 삭제", description = "특정 최근 검색어 이력을 삭제합니다.")
