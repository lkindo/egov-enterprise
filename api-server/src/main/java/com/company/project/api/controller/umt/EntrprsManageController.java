...
public class EntrprsManageController {
    ...
    @Operation(summary = "기업 회원 목록 조회", description = "등록된 기업 회원 목록을 페이징하여 조회합니다.")
    @GetMapping
    ...
    @Operation(summary = "기업 회원 상세 조회", description = "특정 기업 회원의 상세 정보를 조회합니다.")
    @GetMapping("/{esntlId}")
    ...
    @Operation(summary = "기업 회원 등록", description = "새로운 기업 회원을 등록합니다.")
    @PostMapping
    ...
    @Operation(summary = "기업 회원 수정", description = "기존 기업 회원 정보를 수정합니다.")
    @PutMapping("/{esntlId}")
    ...
    @Operation(summary = "기업 회원 삭제", description = "특정 기업 회원을 삭제합니다.")
    ...
    @Operation(summary = "기업 회원 비밀번호 변경", description = "기업 회원의 비밀번호를 변경합니다.")
