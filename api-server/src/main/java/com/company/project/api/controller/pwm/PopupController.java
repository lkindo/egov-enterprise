...
public class PopupController {
    ...
    @Operation(summary = "팝업 목록 조회", description = "팝업 목록을 페이징하여 조회합니다.")
    @GetMapping
    ...
    @Operation(summary = "활성 팝업 목록 조회", description = "현재 일시를 기준으로 게시 기간 내에 있는 활성 팝업 목록을 조회합니다.")
    @GetMapping("/active")
    ...
    @Operation(summary = "팝업 수정", description = "기존 팝업 정보를 수정합니다.")
    @PutMapping("/{popupId}")
    ...
    @Operation(summary = "팝업 삭제", description = "특정 팝업을 삭제 처리합니다.")
