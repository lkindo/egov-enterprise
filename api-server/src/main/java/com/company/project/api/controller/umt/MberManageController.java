...
public class MberManageController {
    ...
    @Operation(summary = "일반 회원 목록 조회", description = "등록된 일반 회원 목록을 페이징하여 조회합니다.")
    @GetMapping
    ...
    @Operation(summary = "일반 회원 상세 조회", description = "특정 일반 회원의 상세 정보를 조회합니다.")
    @GetMapping("/{esntlId}")
    ...
    @Operation(summary = "일반 회원 등록", description = "새로운 일반 회원을 등록합니다.")
    @PostMapping
    ...
    @Operation(summary = "일반 회원 수정", description = "기존 일반 회원 정보를 수정합니다.")
    @PutMapping("/{esntlId}")
    ...
    @Operation(summary = "일반 회원 삭제", description = "특정 일반 회원을 삭제합니다.")
    ...
    @Operation(summary = "일반 회원 비밀번호 변경", description = "일반 회원의 비밀번호를 변경합니다.")
