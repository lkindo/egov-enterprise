...
public class WikiBookmarkController {
    ...
    @Operation(summary = "내 위키 북마크 목록 조회", description = "내가 등록한 위키 북마크 목록을 페이징하여 조회합니다.")
    @GetMapping
    ...
    @Operation(summary = "위키 북마크 삭제", description = "특정 위키 북마크를 삭제합니다.")
    ...
    @Operation(summary = "위키 북마크 중복 체크", description = "동일한 북마크 명이 이미 존재하는지 확인합니다.")
