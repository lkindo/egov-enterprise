...
public class HolidayController {
    ...
    @Operation(summary = "휴일 목록 조회", description = "휴일 목록을 페이징하여 조회합니다.")
    @GetMapping
    ...
    @Operation(summary = "월별 휴일 조회", description = "특정 연월의 휴일 목록을 조회합니다.")
    @GetMapping("/calendar")
    ...
    public ResponseEntity<ApiResponse<HolidayDto>> getHoliday(
            @Parameter(description = "휴일 번호") @PathVariable Integer restdeNo) {
    ...
    @Operation(summary = "휴일 삭제", description = "특정 휴일을 삭제 처리합니다.")
