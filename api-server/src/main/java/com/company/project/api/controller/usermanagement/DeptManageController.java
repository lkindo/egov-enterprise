...
@Tag(name = "Department", description = "부서/조직 관리 API")
@RestController
...
public class DeptManageController {
    ...
    @Operation(summary = "부서 목록 조회", description = "시스템에 등록된 부서 목록을 페이징하여 조회합니다.")
    @GetMapping
    ...
    public ResponseEntity<ApiResponse<DeptManageDto>> getDepartment(
            @Parameter(description = "부서 ID") @PathVariable String orgnztId) {
