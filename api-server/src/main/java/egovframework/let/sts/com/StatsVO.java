 ...
 * @version 1.0
 */
@Schema(description = "통계 결과 정보")
public class StatsVO {

	/** 결과통계수 */
	@Schema(description = "결과 통계 수", example = "100")
	private int statsCo;

	/** 결과일자 */
	@Schema(description = "결과 일자", example = "20231221")
	private String statsDate;

	/** 최대통계수 */
	@Schema(description = "최대 통계 수", example = "500")
	private int maxStatsCo;

	/** 최소통계수 */
	@Schema(description = "최소 통계 수", example = "10")
	private int minStatsCo;

	/** 생성글수 */
	@Schema(description = "생성 글 수", example = "5")
	private int creatCo;

	/** 총조회수 */
	@Schema(description = "총 조회 수", example = "1000")
	private int totInqireCo;

	/** 평균조회수 */
	@Schema(description = "평균 조회 수", example = "50.5")
	private float avrgInqireCo;

	/** 최대조회게시물ID */
	@Schema(description = "최대 조회 게시물 ID", example = "BBS_001")
	private String mxmmInqireBbsId;

	/** 최대조회게시물제목 */
	@Schema(description = "최대 조회 게시물 제목", example = "공지사항1")
	private String mxmmInqireBbsNm;

	/** 최소조회게시물ID */
	@Schema(description = "최소 조회 게시물 ID")
	private String mummInqireBbsId;

	/** 최소조회게시물제목 */
	@Schema(description = "최소 조회 게시물 제목")
	private String mummInqireBbsNm;

	/** 최고게시자ID */
	@Schema(description = "최고 게시자 ID", example = "USER001")
	private String topNtcepersonId;

	/** 최고게시글수 */
	@Schema(description = "최고 게시 글 수", example = "10")
	private int topNtcepersonCo;

	/** 접속프로그램메소드 */
	@Schema(description = "접속 방법")
	private String conectMethod;

	/** 수정글수 */
	@Schema(description = "수정 글 수")
	private int updtCo;

	/** 조회글수 */
	@Schema(description = "조회 글 수")
	private int inqireCo;

	/** 삭제글수 */
	@Schema(description = "삭제 글 수")
	private int deleteCo;

	/** 출력횟수 */
	@Schema(description = "출력 횟수")
	private int outptCo;

	/** 에러횟수 */
	@Schema(description = "에러 횟수")
	private int errorCo;

	/** 시작일자 */
	@Schema(description = "조회 시작 일자", example = "2023-01-01")
	private String fromDate;

	/** 종료일자 */
	@Schema(description = "조회 종료 일자", example = "2023-12-31")
	private String toDate;

	/** 기간구분 */
	@Schema(description = "기간 구분 (D:일별, M:월별, Y:년별)", example = "D")
	private String pdKind;

	/** 통계구분 */
	@Schema(description = "통계 구분 코드", example = "COM101")
	private String statsKind;

	/** 세부통계구분 */
	@Schema(description = "세부 통계 구분")
	private String detailStatsKind;

	/** 탭구분 */
	@Schema(description = "탭 구분", example = "tab1")
	private String tabKind;

	/** 그래프길이 */
	@Schema(description = "그래프 길이")
