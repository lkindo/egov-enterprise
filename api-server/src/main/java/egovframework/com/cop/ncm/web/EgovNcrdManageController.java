...
public class EgovNcrdManageController {
    ...
    public String insertNcrdItem(@ModelAttribute("searchVO") NameCardVO ncrdVO,
            @Valid @ModelAttribute("nameCard") NameCard nameCard,
    ...
    public String updateNcrdItem(@ModelAttribute("searchVO") NameCardVO ncrdVO, @RequestParam("ncrdNm") String ncrdNm,
            @Valid @ModelAttribute("nameCard") NameCard nameCard, BindingResult bindingResult, SessionStatus status,
            ModelMap model) throws Exception {
        LoginVO user = (LoginVO) EgovUserDetailsHelper.getAuthenticatedUser();
        Boolean isAuthenticated = EgovUserDetailsHelper.isAuthenticated();
        // KISA 보안취약점 조치 (2018-12-10, 신용호)
    ...
    public String insertNcrdUseInf(@ModelAttribute("ncrdUser") NameCardUser ncrdUser,
            @ModelAttribute("ncrdVO") NameCardVO ncrdVO,
