...
public class EgovInfrmlSanctnController {
	...
	public String selectSanctnerListPopup(@ModelAttribute("searchVO") SanctnerVO sanctnerVO, ModelMap model)
			throws Exception {
	...
	public String selectSanctnerList(@ModelAttribute("searchVO") SanctnerVO sanctnerVO, ModelMap model)
			throws Exception {
	...
	public String selectSanctnerListNew(@ModelAttribute("searchVO") SanctnerVO sanctnerVO, ModelMap model)
			throws Exception {
		// LoginVO user = (LoginVO)EgovUserDetailsHelper.getAuthenticatedUser();
	...
	public String selectInfrmlSanctn(
		...
		if (infrmlSanctn.getInfrmlSanctnId() != null) {
			if (infrmlSanctn.getInfrmlSanctnId().indexOf(",") > 0) {
				infrmlSanctn.setInfrmlSanctnId(
						infrmlSanctn.getInfrmlSanctnId().substring(0, infrmlSanctn.getInfrmlSanctnId().indexOf(",")));
			}
		}
