...
public class EgovWordDicaryController {
	...
	public String selectWordDicaryList(@ModelAttribute("searchVO") WordDicaryVO searchVO, ModelMap model)
			throws Exception {
	...
	public String selectWordDicaryDetail(WordDicaryVO wordDicaryVO, @ModelAttribute("searchVO") WordDicaryVO searchVO,
	...
	public String insertWordDicaryView(@ModelAttribute("searchVO") WordDicaryVO searchVO, Model model)
			throws Exception {
	...
	public String updateWordDicaryView(@RequestParam("wordId") String wordId,
			@ModelAttribute("searchVO") WordDicaryVO searchVO, ModelMap model) throws Exception {
	...
	public String deleteWordDicary(WordDicaryVO wordDicaryVO, @ModelAttribute("searchVO") WordDicaryVO searchVO)
			throws Exception {
