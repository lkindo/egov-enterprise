...
/**
 * 요청 통계 Controller (JPA 전환)
 */
@Controller
@RequiredArgsConstructor
public class EgovReqStatsController {
     ...
     * 요청 통계 조회
     */
    @IncludedInfo(name = "요청통계", order = 230, gid = 30)
    @RequestMapping(value = "/sts/rst/selectReqStats.do")
    public String selectReqStats(@ModelAttribute("statsVO") StatsVO statsVO, ModelMap model) throws Exception {
        ...
        List<StatsDto> dtoList = egovStatsService.getRequestStats(
                statsVO.getFromDate(),
                statsVO.getToDate(),
        ...
        return "egovframework/com/sts/rst/EgovReqStats";
    }
}
