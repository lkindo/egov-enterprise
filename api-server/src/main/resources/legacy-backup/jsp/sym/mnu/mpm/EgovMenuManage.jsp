<%-- Class Name : EgovMenuManage.jsp Description : 메뉴관리 조회 화면 Modification Information 수정일 수정자 수정내용 ------- --------
    --------------------------- 2009.03.10 이용 최초 생성 2011.08.31 JJY 경량환경 버전 생성 author : 공통서비스 개발팀 이용 since : 2009.03.10
    --%>
            ...
            <%@ taglib prefix="ui" uri="http://egovframework.gov/ctl/ui" %>
                <%@ taglib uri="jakarta.tags.functions" prefix="fn" %>
                    <%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
                        <% /* Image Path 설정 */ String imagePath_icon="/images_old/egovframework/sym/mpm/icon" ; String
                            imagePath_button="/images_old/egovframework/sym/mpm/button" ; %>
                            <!DOCTYPE html
                                                ...
                                                <div class="layout">
                                                    ...
                                                    <div class="content_wrap">
                                                        <div id="contents" class="content">
                                                            ...
                                                            <form name="menuManageForm"
                                                                action="<c:url value='/sym/mnu/mpm/EgovMenuManageSelect.do'/>"
                                                                method="post">
                                                                ...
                                                                <div class="condition2">
                                                                    ...
                                                                    <span class="item f_search">
                                                                        <input id="searchKeyword" class="f_input w_350"
                                                                            name="searchKeyword" type="text"
                                                                            value="<c:out value='${searchVO.searchKeyword}'/>"
                                                                            maxlength="60" title="검색조건" />
                                                                        <button class="btn" type="submit"
                                                                            onclick="javascript:selectMenuManageList(); return false;">
                                                                ...
                                                                <div class="board_list_top">
                                                                    ...
                                                                    <div class="right_col">
                                                                        <a href="<c:url value='/sym/mnu/mpm/EgovMenuBndeRegist.do'/>"
                                                                            class="btn btn_blue_46 w_100"
                                                                            onclick="bndeInsertMenuManage(); return false;">일괄등록</a><!-- 일괄등록 -->
                                                                        <a href="<c:url value='/sym/mnu/mpm/EgovMenuRegistInsert.do'/>"
                                                                            class="btn btn_blue_46 w_100"
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <c:forEach var="result"
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <a href="<c:url value='/sym/mnu/mpm/EgovMenuManageListDetailSelect.do?req_menuNo='/>${result.menuNo}"
                                                                                            class="lnk"
                                                                                            onclick="selectUpdtMenuManageDetail('<c:out value="
                                                                                            ${result.menuNo}" />');
                                                                                        return false;">
                                                                                        <c:out
                                                                                            value="${result.menuNm}" />
