...
-->
                            ...
                            <body>
                                ...
                                <form name="listForm" action="<c:url value='/uss/umt/EgovEntrprsMberManage.do'/>"
                                    method="post">
                                    <div class="board">
                                        <h1>${pageTitle}
                                            <spring:message code="title.list" />
                                        ...
                                        <ul>
                                            ...
                                            <li><!-- 議곌굔 -->
                                                ...
                                                <option value="1" <c:if
                                                    test="${empty userSearchVO.searchCondition || userSearchVO.searchCondition == '1'}">
                                                    selected="selected"</c:if> >
                                                    <spring:message
                                        ...
                                        <c:forEach var="result" items="${resultList}" varStatus="status">
                                            <tr>
                                                ...
                                                <td><a href="<c:url value='/uss/umt/EgovEntrprsMberSelectUpdtView.do'/>?selectedId=<c:out value="
                                                    ...
                                                    <c:out value="${result.entrprsmberId}" /></a>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <c:out value="${result.applcntEmailAdres}" />
                                                </td>
                                                <td>
                                                    <c:out value="${result.areaNo}" />)
                                                    <c:out value="${result.entrprsMiddleTelno}" />-
                                                    <c:out value="${result.entrprsEndTelno}" />
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <c:forEach var="entrprsMberSttus_result"
                                                        ...
                                                        <c:if
                                                            test="${result.entrprsMberSttus == entrprsMberSttus_result.code}">
