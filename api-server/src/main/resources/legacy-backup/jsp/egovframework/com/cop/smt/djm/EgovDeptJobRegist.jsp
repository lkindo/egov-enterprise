<% /** * @Class Name : EgovDeptJobRegist.jsp * @Description : 부서업무 등록 * @Modification Information * @ * @ 수정일 수정자 수정내용 *
	@ ---------- -------- --------------------------- * @ 2010.07.12 장철호 최초 생성 * @ 2018.09.10 최두영 V3.8 퍼블리싱 점검 * @
	2018.09.14 최두영 다국어처리&퍼블리싱처리 * @ 2019.12.09 신용호 KISA 보안약점 조치 (위험한 형식 파일 업로드) * * @author 공통컴포넌트개발팀 장철호 * @since
	2010.07.12 * @version 1.0 * @see * */ %>
					...
					<%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
						<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
							...
							<head>
								...
								<title>
									<spring:message code="comCopSmtDjm.deptJobRegist.title" />
								</title><!-- 부서업무 등록 -->
							...
							<body onLoad="fn_egov_init_DeptJob()" style="margin-top:0">
								...
								<form:form modelAttribute="deptJobVO" name="deptJobVO" method="post"
									action="${pageContext.request.contextPath}/cop/smt/djm/insertDeptJob.do"
									...
									<div class="wTableFrm">
										...
										<table class="wTable">
											...
											<tr>
												...
												<td class="left">
													<input id="deptNm" type="text" name="deptNm"
														value="${deptJobVO.deptNm}" maxlength="20" title="부서"
														readonly="readonly" style="width:188px" />
													<div>
											...
											<tr>
												<th>
													<spring:message code="comCopSmtDjm.deptJobVO.validate.deptJobNm" />
													<span class="pilsu">*</span>
												</th><!-- 제목 -->
												<td class="left">
											...
											<tr>
												<th>
													<spring:message code="comCopSmtDjm.deptJobVO.validate.deptJobCn" />
													<span class="pilsu">*</span>
												</th><!-- 내용 -->
												<td class="left">
											...
											<tr>
												<th>
													<spring:message code="comCopSmtDjm.deptJobVO.validate.chargerNm" />
													<span class="pilsu">*</span>
												</th>
												<td class="left">
													<form:input path="chargerNm" size="73" cssClass="txaIpt"
														readonly="true" maxlength="10" title="담당자"
														cssStyle="width:188px" />
											...
											<tr>
												...
												<td class="left">
													...
													<spring:message code="comCopSmtDjm.deptJobRegist.high" /><!-- 높음 -->
													...
													<form:radiobutton path="priort" value="3"
														cssStyle="margin-left:10px" />
													<spring:message code="comCopSmtDjm.deptJobRegist.low" /><!-- 낮음 -->
													<div>
											...
											<tr>
												...
												<td class="left">
													<table width="580px" cellspacing="0" cellpadding="0" border="0"
														align="center" class="UseTable">
														<tr>
															<td><input name="file_1" id="egovComFileUploader"
																	type="file" title="파일첨부" multiple /></td>
														</tr>
														<tr>
															<td>
