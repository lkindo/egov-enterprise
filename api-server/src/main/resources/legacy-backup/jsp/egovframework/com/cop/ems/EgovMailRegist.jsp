<% /** * @Class Name : EgovMailRegist.jsp * @Description : 발송메일 등록 화면 * @Modification Information * @ * @ 수정일 수정자 수정 내용
	* @ ---------- -------- --------------------------- * @ 2009.03.11 박지욱 최초 생성 * @ 2011.12.06 이기하 첨부파일 기능
	추가(fileStreCours) * 2016.06.13 장동한 표준프레임워크 v3.6 개선 * 2019.12.11 신용호 KISA 보안약점 조치 (크로스사이트 스크립트) * * @author 공통서비스 개발팀
	박지욱 * @since 2009.03.11 * @version 1.0 * @see * */ %>
									...
									<div class="wTableFrm">
										...
										<form:form name="sndngMailVO" method="post" enctype="multipart/form-data"
											...
											<input type="hidden" name="link"
												value="<c:out value='${resultInfo.link}'/>" />
											...
											<table class="wTable"
												...
												<tbody>
													...
													<tr>
														...
														<td class="left">
															<input name="recptnPerson" id="recptnPerson" type="text"
																size="74"
																value="<c:out value='${resultInfo.recptnPerson}'/>"
																maxlength="60" style="ime-mode: disabled;" tabindex="1"
																title="<c:out value='${title}'/> <c:out value='${inputTxt}'/>" />
															<div>
													...
													<tr>
														<th>${title} <span class="pilsu">*</span></th>
														<td class="nopd">
															<input name="sj" id="sj" type="text" size="74"
																value="<c:out value='${resultInfo.sj}'/>"
													...
													<tr>
														...
														<td class="nopd">
															<table>
																<tr>
																	<td width="600"><input name="file_1"
													...
													<tr>
														<th>${title} </th>
														<td class="nopd">
															<textarea id="emailCn" name="emailCn" cols="75" rows="25"
																tabindex="4" title="${title} ${inputTxt}" /></textarea>
														</td>
													</tr>
												</tbody>
											</table>
