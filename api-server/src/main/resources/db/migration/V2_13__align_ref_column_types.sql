...
--   non-null 값 0건 실측(2026-07-16, db-bridge)이라 무손실·즉시 완료된다. 린터의 라인 단위
--   'linter:ignore' 는 주석 선제거 구현 특성상 동작하지 않아(하네스 개선 대상, V2_7 선례)
--   파일 단위 예외를 적용하며, 우회 범위 최소화를 위해 본 파일은 이 2건+자가치유 1건만 담는다.
...
ALTER TABLE tb_schdl_info ALTER COLUMN atch_file_id TYPE varchar(20);
ALTER TABLE tb_user_info  ALTER COLUMN group_id     TYPE varchar(20);
