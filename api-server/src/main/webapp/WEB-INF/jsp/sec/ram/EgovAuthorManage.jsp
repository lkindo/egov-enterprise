<% /** * @Class Name : EgovAuthorManage.java * @Description : EgovAuthorManage List 화면 * @Modification Information * @ *
    @ 수정일 수정자 수정내용 * @ ------- -------- --------------------------- * @ 2009.03.01 Lee.m.j 최초 생성 * 2016.06.13 장동한
    표준프레임워크 v3.6 개선 * @ 2024.10.29 LeeBaekHaeng 검색조건 유지 * * @author 실행환경 개발팀 홍길동 * @since 2009.02.01 * @version 1.0 *
    @see * */ %>
		...
		alert(message);
                            ...
                            <body onload="fn_egov_onload();">
                                ...
                                <form:form name="listForm"
                                    action="${pageContext.request.contextPath}/sec/ram/EgovAuthorList.do" method="get">
                                    <div class="board">
                                        <h1>${pageTitle}
                                            <spring:message code="title.list" />
                                        </h1><!-- 권한관리 목록 -->
