<% /** * @Class Name : egovAuthorUpdate.java * @Description : egovAuthorUpdate jsp * @Modification Information * @ * @
	    ...
	    varFrom.submit();
								...
								<body>
									...
									<form:form modelAttribute="authorManage"
										action="${pageContext.request.contextPath}/sec/ram/EgovAuthorUpdate.do"
										method="post" onSubmit="fncAuthorUpdate(document.forms[0]); return false;">
										<div class="wTableFrm">
											<!-- 타이틀 -->
											<h2>${pageTitle}
												<spring:message code="title.update" />
											...
											<div class="btn">
												<input type="submit" class="s_submit"
													...
													title='<spring:message code="button.update" /> <spring:message code="input.button" />' /><!-- 수정 -->
