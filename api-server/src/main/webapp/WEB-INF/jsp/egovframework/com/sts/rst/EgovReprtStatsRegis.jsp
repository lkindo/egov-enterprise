<%-- /** * @Class Name : EgovReprtStatsRegis.java * @Description : EgovReprtStatsRegis jsp * @Modification Information *
    @ * @ 수정일 수정자 수정내용 * @ ------- -------- --------------------------- * @ 2009.02.01 lee.m.j 최초 생성 * @ 2011.07.17 이기하
    패키지 분리(sts -> sts.rst)
    *
    * @author lee.m.j
    * @since 2009.07.01
...
function fncSelectReprtStatsList() {
    var varFrom = document.getElementById("reprtStatsVO");
...
function fncReprtStatsDelete() {
    ...
    if(confirm("삭제 하시겠습니까?")){
        varFrom.submit();
                                ...
                                <body>
                                    <noscript class="noScriptTitle">자바스크립트를 지원하지 않는 브라우저에서는 일부 기능을 사용하실 수
                                        없습니다.</noscript>

                                    <!-- Changed modelAttribute from reprtStats to reprtStatsVO to match Controller -->
                                    ...
                                    <form:form modelAttribute="reprtStatsVO" method="post"
                                        ...
                                        <div class="wTableFrm">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <th><label for="reprtNm">보고서명 <span class="pilsu">*</span></label>
                                                    </th>
                                                    <td class="nopd">
                                                ...
                                                <tr>
                                                    <th><label for="reprtTy">보고서유형 <span class="pilsu">*</span></label>
                                                    </th>
                                                    <td class="left">
                                                ...
                                                <tr>
                                                    <th><label for="reprtSttus">진행상태 <span
                                            ...
                                            <div class="btn">
                                                ...
                                                return false;" />
                                                <span class="btn_s"><a
                                                        href="<c:url value='/sts/rst/selectReprtStatsList.do'/>?pageIndex=<c:out value='${reprtStatsVO.pageIndex}'/>&amp;pmReprtTy=<c:out value="
                                                        ${reprtStatsVO.pmReprtTy}" />&amp;pmDateTy=
                                                    <c:out value="${reprtStatsVO.pmDateTy}" />&amp;pmFromDate=
                                                    <c:out value="${reprtStatsVO.pmFromDate}" />&amp;pmToDate=
                                                    <c:out value="${reprtStatsVO.pmToDate}" />"
                                                    onclick="fncSelectReprtStatsList(); return false;">
                                                    <spring:message code="button.list" /></a></a>
                                                </span>
                                            </div>
