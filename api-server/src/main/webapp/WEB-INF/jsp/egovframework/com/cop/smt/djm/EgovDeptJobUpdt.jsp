<% /** * @Class Name : EgovDeptJobUpdt.jsp * @Description : 부서업무 수정 * @Modification Information * @ * @ 수정일 수정자 수정내용 * @
	------- -------- --------------------------- * @ 2010.07.12 장철호 최초 생성 * @ 2018.09.10 최두영 V3.8 퍼블리싱 점검 * @ 2018.09.15
	최두영 다국어처리 * * @author 공통컴포넌트개발팀 장철호 * @since 2010.07.12 * @version 1.0 * @see * */ %>
						...
						<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
							<%@ taglib prefix="egovc" uri="/WEB-INF/tlds/egovc.tld" %>
								...
								<head>
									...
									<title>
										<spring:message code="comCopSmtDjm.deptJobUpdt.title" />
									</title><!-- 부서업무 수정 -->
									...
									<%-- <script type="text/javascript"
										...
										<script type="text/javascript" src="<c:url value="
											/js/egovframework/com/cmm/EgovValidation.js" />"></script>
										<script type="text/javascript">
								...
								<body>
									...
									<form:form modelAttribute="deptJobVO" name="deptJobVO" method="post"
										action="${pageContext.request.contextPath}/cop/smt/djm/updateDeptJob.do"
										...
										<div class="wTableFrm">
											...
											<table class="wTable">
												...
												<tr>
													<th>
														<spring:message code="comCopSmtDjm.deptJobVO.validate.deptNm" />
														<span class="pilsu">*</span>
													</th><!-- 부서 -->
													<td class="left">
														<input id="deptNm" class="readOnlyClass" type="text"
															name="deptNm" value="${deptJobVO.deptNm}" maxlength="20"
															title="부서" readonly="readonly" style="width:188px" />
														<div>
												...
												<tr>
													<th>
														<spring:message
															code="comCopSmtDjm.deptJobVO.validate.deptJobBxNm" /> <span
															class="pilsu">*</span>
													</th><!-- 부서업무함명 -->
													<td class="left">
														<form:input path="deptJobBxNm" size="30" readonly="true"
															maxlength="255" title="부서업무함명" cssStyle="width:188px" />
														<a href="<c:url value='/cop/smt/djm/selectDeptJobBxListPopup.do' />"
															target="_blank" title="새 창으로 이동"
															onclick="fn_egov_dept_DeptJobBx('typeDeptJobBx');return false;">
															<img alt="부서업무함"
												...
												<tr>
													<th>
														<spring:message
															code="comCopSmtDjm.deptJobVO.validate.deptJobNm" /> <span
															class="pilsu">*</span>
													</th><!-- 부서업무명 -->
													<td class="left">
														<form:input path="deptJobNm" size="75" maxlength="255"
															title="제목" />
														<div>
												...
												<tr>
													<th>
														<spring:message
															code="comCopSmtDjm.deptJobVO.validate.deptJobCn" /> <span
															class="pilsu">*</span>
													</th><!-- 부서업무내용 -->
													<td class="left">
												...
												<tr>
													<th>
														<spring:message
															code="comCopSmtDjm.deptJobVO.validate.chargerNm" /> <span
															class="pilsu">*</span>
													</th><!-- 업무담당자 -->
													<td class="left">
														<form:input path="chargerNm" cssClass="txaIpt" readonly="true"
															maxlength="10" title="담당자" cssStyle="width:188px" />
														<a href="<c:url value='/cop/smt/djm/selectChargerListPopup.do' />"
															target="_blank" title="새 창으로 이동"
															onclick="fn_egov_charger_DeptJob('담당자', 'chargerId', '', 'chargerNm', '');return false;">
															<img alt="담당자"
																src="<c:url value='/images/egovframework/com/cmm/btn/btn_search.gif' />"
																title="담당자">
														</a>
												...
												<tr>
													<th>
														<spring:message code="comCopSmtDjm.deptJobVO.validate.priort" />
														<span class="pilsu">*</span>
													</th><!-- 우선순위 -->
													<td class="left">
														<form:radiobutton path="priort" value="1" />
														<spring:message code="comCopSmtDjm.deptJobRegist.high" />
														<!-- 높음 -->
														<form:radiobutton path="priort" value="2"
															cssStyle="margin-left:10px" />
														<spring:message code="comCopSmtDjm.deptJobRegist.medium" />
														<!-- 보통 -->
														<form:radiobutton path="priort" value="3"
															cssStyle="margin-left:10px" />
														<spring:message code="comCopSmtDjm.deptJobRegist.low" />
														<!-- 낮음 -->
														<div>
												...
												<c:if
													test="${deptJobVO.atchFileId ne null && deptJobVO.atchFileId ne ''}">
													<tr>
														<th>
															<spring:message
																code="comCopSmtDjm.deptJobRegist.fileAttach" /> <span
																class="pilsu">*</span>
														</th><!-- 파일첨부 -->
														<td class="left">
															<c:import charEncoding="utf-8"
																...
																<c:param name="param_atchFileId"
																	value="${egovc:encrypt(deptJobVO.atchFileId)}" />
															</c:import>
														</td>
													</tr>
												</c:if>
												<tr>
													<th>
														<spring:message code="comCopSmtDjm.deptJobRegist.fileAttach" />
														<span class="pilsu">*</span>
													</th><!-- 파일첨부 -->
													<td class="left">
														<input name="file_1" id="egovComFileUploader" type="file"
															title="<spring:message code="
															comCopSmtDjm.deptJobRegist.fileAttach" />"
														multiple/><!-- 첨부파일 -->
											...
											<div class="btn">
												<input class="s_submit" type="submit" value="<spring:message code="
													button.save" />" onclick="fn_egov_update_deptjob(); return false;"
												/>
												<span class="btn_s"><a
											...
											<input type="hidden" name="returnUrl"
												value="<c:url value='/cop/smt/djm/modifyDeptJob.do' />" />
											...
											<input type="hidden" name="searchWrd"
												value="<c:out value='${deptJobVO.searchWrd}'/>" />
											<input type="hidden" name="searchCnd"
												value="<c:out value='${deptJobVO.searchCnd}'/>" />
											<input type="hidden" name="pageIndex"
												value="<c:out value='${deptJobVO.pageIndex}'/>" />
											<input type="hidden" name="searchDeptId"
												value="<c:out value='${deptJobVO.searchDeptId}'/>" />
											<input type="hidden" name="searchDeptJobBxId"
												value="<c:out value='${deptJobVO.searchDeptJobBxId}'/>" />
											<!-- 검색조건 유지 -->
										</div>
									</form:form>
