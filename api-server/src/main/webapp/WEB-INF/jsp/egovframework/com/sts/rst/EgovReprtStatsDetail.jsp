<%-- /** * @Class Name : EgovReprtStatsDetail.java * @Description : EgovReprtStatsDetail jsp * @Modification Information
    * @ * @ 수정일 수정자 수정내용 * @ ------- -------- --------------------------- * @ 2009.08.01 lee.m.j 최초 생성 * @ 2011.07.17
    이기하 패키지 분리(sts -> sts.rst)
    *
    * @author lee.m.j
    * @since 2009.08.17
    * @version 1.0
    ...
    if(confirm("삭제 하시겠습니까?")){
        varFrom.submit();
                                ...
                                <body>
                                    ...
                                    <form:form modelAttribute="reprtStats" method="post"
                                        action="${pageContext.request.contextPath}/sts/rst/selectReprtStatsList.do">
                                            ...
                                            <tbody>
                                                <c:forEach var="reprt" items="${reprtStats}" varStatus="status">
                                                    <tr>
                                                        <td></td>
                                                        <td>
                                                            <c:out value="${reprt.reprtId}" />
                                                        </td>
                                                        <td>
                                                            <c:out value="${reprt.reprtNm}" />
                                                        </td>
                                                        <td>
                                                            <c:out value="${reprt.reprtTyNm}" />
                                                        </td>
                                                        <td>
                                                            <c:out value="${reprt.reprtSttusNm}" />
                                                        </td>
                                                        <td>
                                                            <c:out value="${reprt.regDate}" />
                                                        </td>
                                                        <td></td>
                                                    </tr>
                                                </c:forEach>
