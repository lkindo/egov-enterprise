<%-- /** * @Class Name : EgovTroblReqstRegist.java * @Description : EgovTroblReqstRegist jsp * @Modification Information
	* @ * @ 수정일 수정자 수정내용 * @ ---------- -------- --------------------------- * @ 2010.07.01 lee.m.j 최초 생성 * 2018.09.07
	신용호 공통컴포넌트 3.8 개선 * 2024.10.29 권태성 validateTroblReqst 함수 추가 * 2026.01.06 Antigravity 레이아웃 및 UI 표준화 적용 * * @author
	lee.m.j * @since 2010.07.01 * @version 1.0 * @see * * Copyright (C) 2009 by MOPAS All rights reserved. */ --%>
					...
					<%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
						<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
							...
							<head>
								...
								<title>
									<spring:message code="comSymTbmTbr.troblReqstRegist.title" />
								</title><!-- 장애신청 등록 -->
													...
													<div class="content_wrap">
														<div id="contents" class="content">
															...
															<div class="wTableFrm">
																...
																<h2 class="tit_2">
																	<spring:message
																		code="comSymTbmTbr.troblReqstRegist.pageTop.title" />
																</h2><!-- 장애신청 등록 -->

																<form name="troblReqst" id="troblReqst" method="post"
																	action="${pageContext.request.contextPath}/sym/tbm/tbr/addTroblReqst.do">
																	<!-- 등록폼 -->
																	<table class="wTable">
																		<colgroup>
																			<col style="width:16%" />
																		...
																		<tr>
																			<th>
																				<spring:message
																					code="comSymTbmTbr.troblReqstRegist.troblNm" />
																				<span class="pilsu">*</span>
																			</th><!-- 장애명 -->
																			<td class="left">
																				<label for="troblNm"><input
																						name="troblNm" id="troblNm"
																		...
																		<tr>
																			<th>
																				<spring:message
																					code="comSymTbmTbr.troblReqstRegist.troblKnd" />
																				<span class="pilsu">*</span>
																			</th><!-- 장애종류 -->
																			<td class="left">
																				<label for="troblKnd">
																		...
																		<tr>
																			<th>
																				<spring:message
																					code="comSymTbmTbr.troblReqstRegist.troblDc" />
																				<span class="pilsu">*</span>
																			</th><!-- 장애설명 -->
																			<td class="left">
																				<label for="troblDc"><textarea
																						...
																						cols="80"
																						title="<spring:message code="
																						comSymTbmTbr.troblReqstRegist.troblDc" />"></textarea>&nbsp;
																		...
																		<tr>
																			<th>
																				<spring:message
																					code="comSymTbmTbr.troblReqstRegist.troblOccrrncTime" />
																				<span class="pilsu">*</span>
																			</th><!-- 장애발생시간 -->
																			<td class="left">
																				...
																				<label for="troblOccrrncD"><input
																						type="text" name="troblOccrrncD"
																						id="troblOccrrncD"
																						maxlength="10"
																						title="<spring:message code="
																						comSymTbmTbr.troblReqstRegist.troblOccrrncTime" />"
																					style="width:70px"
																					/></label><!-- 장애발생시간 -->
																				<input type="hidden"
																					name="troblOccrrncDate" value="" />
																				<label for="troblOccrrncH"><select
																						name="troblOccrrncH"
																						id="troblOccrrncH">
																						<c:forEach var="i" begin="0"
																							end="23" step="1"
																							varStatus="status">
																							<option value="<c:if test="
																								${i < 10}">0</c:if>
																								<c:out value="${i}" />">
																								<c:if test="${i < 10}">0
																								</c:if>
																					...
																					<spring:message
																						code="comSymTbmTbr.troblReqstRegist.hour" />
																					<!-- 시 -->&nbsp;
																				</label>
																				<label for="troblOccrrncM"><select
																						name="troblOccrrncM"
																						id="troblOccrrncM">
																						<c:forEach var="i" begin="0"
																							end="59" step="1"
																					...
																					<spring:message
																						code="comSymTbmTbr.troblReqstRegist.minute" />
																					<!-- 분 -->&nbsp;
																				</label>
																				<label for="troblOccrrncS"><select
																						name="troblOccrrncS"
																						id="troblOccrrncS">
																						<c:forEach var="i" begin="0"
																							end="59" step="1"
																					...
																					<spring:message
																						code="comSymTbmTbr.troblReqstRegist.second" />
																					<!-- 초 -->
																				</label>
																				<input type="hidden"
																					name="troblOccrrncTime" value="" />
																			</td>
																		</tr>
																		<tr>
																			<th>
																				<spring:message
																					code="comSymTbmTbr.troblReqstRegist.troblRqesterNm" />
																				<span class="pilsu">*</span>
																			</th><!-- 장애등록자 -->
																			<td class="left">
																				<label for="troblRqesterNm"><input
																						name="troblRqesterNm"
																	...
																	<div class="btn">
																		<input class="s_submit" type="submit"
																			...
																			onclick="fncTroblReqstInsert(); return false;" /><!-- 저장 -->
																		<span class="btn_s"><a
