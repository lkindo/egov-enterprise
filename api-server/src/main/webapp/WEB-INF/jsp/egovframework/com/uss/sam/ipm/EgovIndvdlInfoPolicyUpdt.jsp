<%-- Class Name : EgovIndvdlInfoPolicyModify.jsp Description : 개인정보보호정책 수정 페이지 Modification Information 수정일 수정자 수정내용
						...
						<%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
							<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
								<%--@ taglib prefix="ckeditor" uri="http://ckeditor.com" --%>
									...
									<c:set var="pageTitle">
										<spring:message code="ussSamIpm.indvdlInfoPolicyUpdt.indvdlInfoPolicyUpdt" />
									</c:set>
									<c:set var="msgIndvdlInfoNm">
										<spring:message code="ussSamIpm.indvdlInfoPolicyUpdt.indvdlInfoNm" />
									</c:set>
									<c:set var="msgIndvdlInfoYn">
										<spring:message code="ussSamIpm.indvdlInfoPolicyUpdt.indvdlInfoYn" />
									</c:set>
									<c:set var="msgIndvdlInfoDc">
										<spring:message code="ussSamIpm.indvdlInfoPolicyUpdt.indvdlInfoDc" />
									</c:set>
									...
									<head>
										...
										<title>${pageTitle}</title><!-- 개인정보보호정책 수정 -->
			...
			varFrom.submit();
									...
									<body onLoad="fn_egov_init_IndvdlInfoPolicy();">
										<form:form modelAttribute="indvdlInfoPolicy" name="indvdlInfoPolicy"
											action="${pageContext.request.contextPath}/uss/sam/ipm/updtIndvdlInfoPolicy.do"
											method="post" enctype="multipart/form-data">
											<div class="wTableFrm">
												<!-- 타이틀 -->
												<h2>${pageTitle}</h2><!-- 개인정보보호정책 관리 수정 -->
												...
												<table class="wTable">
													...
													<tr>
														...
														<!-- 개인정보보호정책 명  -->
														<td class="left">
															<form:input path="indvdlInfoNm" cssClass="txaIpt"
																maxlength="255" />
													...
													<tr>
														...
														<td class="left">
															<select title="${msgIndvdlInfoYn}" name="indvdlInfoYn"
																id="indvdlInfoYn">
																<option value="Y" <c:if
																	test="${indvdlInfoPolicy.indvdlInfoYn == 'Y'}">
																	selected</c:if>>
																	<spring:message code="input.yes" />
																</option><!-- 예 -->
																<option value="N" <c:if
																	test="${indvdlInfoPolicy.indvdlInfoYn == 'N'}">
																	selected</c:if>>
											...
											<input name="indvdlInfoId" type="hidden"
												value="${indvdlInfoPolicy.indvdlInfoId}">
