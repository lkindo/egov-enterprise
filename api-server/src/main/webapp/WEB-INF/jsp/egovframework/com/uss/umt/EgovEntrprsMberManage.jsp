                                        ...
                                        <div class="sub_layout">
                                            <div class="sub_in">
                                                <div class="layout">
                                                    ...
                                                    <form name="listForm"
                                                        action="<c:url value='/uss/umt/EgovEntrprsMberManage.do'/>"
                                                        method="post">
                                                        <div class="board">
                                                            <h1>${pageTitle}
                                                                <spring:message code="title.list" />
                                                            ...
                                                            <ul>
                                                                <li style="margin:3px 0 0 0;">
                                                                    <div>사용자수 <strong>
                                                                            <c:out
                                                                                value="${paginationInfo.totalRecordCount}" />
                                                                        </strong></div>
                                                                </li>
                                                                <li><!-- 상태-->
                                                                    ...
                                                                    <option value="0" <c:if
                                                                        test="${empty entrprsUserSearchVO.sbscrbSttus || entrprsUserSearchVO.sbscrbSttus == '0'}">
                                                                        selected="selected"</c:if> >
                                                                        <spring:message
                                                                            code="comUssUmt.userManageSsearch.sbscrbSttusAll" />
                                                                    </option><!-- 상태(전체) -->
                                                                    <option value="A" <c:if
                                                                        test="${entrprsUserSearchVO.sbscrbSttus == 'A'}">
                                                                        selected="selected"</c:if> >
                                                                        <spring:message
                                                                            code="comUssUmt.userManageSsearch.sbscrbSttusA" />
                                                                    </option><!-- 가입신청 -->
                                                                    <option value="D" <c:if
                                                                        test="${entrprsUserSearchVO.sbscrbSttus == 'D'}">
                                                                        selected="selected"</c:if> >
                                                                        <spring:message
                                                                            code="comUssUmt.userManageSsearch.sbscrbSttusD" />
                                                                    </option><!-- 삭제 -->
                                                                    <option value="P" <c:if
                                                                        test="${entrprsUserSearchVO.sbscrbSttus == 'P'}">
                                                                        selected="selected"</c:if> >
                                                                        <spring:message
                                                                ...
                                                                <li><!-- 조건 -->
                                                                    ...
                                                                    <option value="0" <c:if
                                                                        test="${entrprsUserSearchVO.searchCondition == '0'}">
                                                                        selected="selected"</c:if> >
                                                                        <spring:message
                                                                            code="comUssUmt.userManageSsearch.searchConditionId" />
                                                                    </option><!-- ID  -->
                                                                    <option value="1" <c:if
                                                                        test="${empty entrprsUserSearchVO.searchCondition || entrprsUserSearchVO.searchCondition == '1'}">
                                                                        selected="selected"</c:if> >
                                                                        <spring:message
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <c:out
                                                                        value="${entrprsUserSearchVO.searchKeyword}" />'
                                                                    maxlength="255" >
                                                        ...
                                                        <table class="board_list" summary="<spring:message code="
                                                            common.summary.list" arguments="${pageTitle}" />">
                                                        <caption>${pageTitle}
                                                            <spring:message code="title.list" />
                                                        </caption>
                                                        <colgroup>
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="board_th_link">
                                                                    <spring:message
                                                                        code="comUssUmt.entrprsUserManageList.id" />
                                                                </th><!--아이디 -->
                                                                <th>
                                                                    <spring:message
                                                                        code="comUssUmt.entrprsUserManageList.company" />
                                                                </th><!-- 회사명 -->
                                                                <th>
                                                                    <spring:message
                                                                        code="comUssUmt.entrprsUserManageList.name" />
                                                                </th><!-- 신청자이름 -->
                                                                <th>
                                                                    <spring:message
                                                                        code="comUssUmt.entrprsUserManageList.email" />
                                                                </th><!-- 사용자이메일 -->
                                                                <th>
                                                                    <spring:message
                                                                        code="comUssUmt.entrprsUserManageList.phone" />
                                                                </th><!-- 전화번호 -->
                                                                <th>
                                                                ...
                                                                <th>
                                                                    <spring:message
                                                                        code="comUssUmt.entrprsUserManageList.sbscrbSttus" />
                                                                </th><!-- 가입상태 -->
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="checkbox" name="checkField"
                                                                            class="check2" title="선택" />
                                                                        <input name="checkId" type="hidden"
                                                                            value="<c:out value='${result.userTy}'/>:<c:out value='${result.uniqId}'/>" />
                                                                    </td>
                                                                    <td><a href="<c:url value='/uss/umt/EgovEntrprsMberSelectUpdtView.do'/>?selectedId=<c:out value="
                                                                            ${result.uniqId}" />"
                                                                        onclick="javascript:fnSelectUser('
                                                                        <c:out value="${result.userTy}" />:
                                                                        <c:out value="${result.uniqId}" />'); return
                                                                        false;">
                                                                    ...
                                                                    <td>
                                                                        <c:out
                                                                            value="${fn:substring(result.sbscrbDe,0,10)}" />
                                                                    </td>
                                                                    <td>
                                                                        <c:forEach var="entrprsMberSttus_result"
                                                                            items="${entrprsMberSttus_result}"
                                                                            varStatus="status">
                                                                            <c:if
                                                                                test="${result.sttus == entrprsMberSttus_result.code}">
                                                                                <c:out
                                                                                    value="${entrprsMberSttus_result.codeNm}" />
                                                                            </c:if>
                                                                        </c:forEach>
                                                                    </td>
                                                                </tr>
                                                        ...
                                                        <div class="pagination">
                                                            <ul>
                                                                <ui:pagination paginationInfo="${paginationInfo}"
                                                                    type="image" jsFunction="fnLinkPage" />
                                                            </ul>
                                                        </div>
                                                        ...
                                                        <input name="pageIndex" type="hidden"
                                                            value="<c:out value='${entrprsUserSearchVO.pageIndex}'/>" />
                                                </div>
                                                </form>
