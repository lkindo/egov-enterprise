<%-- Class Name : EgovMainView.jsp Description : 메인화면 Modification Information 수정일 수정자 수정내용 ------- --------
                                                            ...
                                                            <ul class="list">
                                                                <c:forEach var="result" items="${bbsList}"
                                                                    ...
                                                                    <c:if
                                                                        ...
                                                                        <li>
                                                                            <a
                                                                                href="<c:url value='/cop/bbs/selectBoardArticle.do?bbsId=BBSMSTR_CCCCCCCCCCCC&nttId=${result.nttId}'/>">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <c:if test="${result.replyLc!=0}">
                                                                                        ...
                                                                                        <img src="<c:url value='/images/ico_reply.png'/>"
                                                                                            alt="reply arrow">
                                                                                    </c:if>
                                                                                    <a
                                                                                        href="<c:url value='/cop/bbs/selectBoardArticle.do?bbsId=BBSMSTR_AAAAAAAAAAAA&nttId=${result.nttId}'/>">
                                                                                        <c:out
                                                                                            value="${result.nttSj}" />
                                                                                    </a>
                                                                                    <span>NEW</span>
