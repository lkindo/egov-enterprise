...
| 5 | 수동 PK 59엔티티와 eGov 암호 호환 단계 축소 | BE 단순성·키관리 개선 | 주소록 2종은 V2_49, 도움말은 V2_50, 인터넷 서비스 안내는 V2_51, 온라인 매뉴얼은 V2_52로 완료. 나머지는 20260813 BIGINT PK 실행 원장의 위험도 Wave 순서로 진행 |
