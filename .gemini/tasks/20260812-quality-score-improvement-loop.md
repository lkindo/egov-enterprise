...
| 5 | 수동 PK 56엔티티와 eGov 암호 호환 단계 축소 | BE 단순성·키관리 개선 | 주소록 2종은 V2_49, 도움말은 V2_50, 인터넷 서비스 안내는 V2_51, 온라인 매뉴얼은 V2_52, 팝업은 V2_53, 마이페이지 콘텐츠는 V2_54, 부서업무함은 V2_55로 완료. Template은 자연키 유지로 재판정. 나머지는 20260813 BIGINT PK 실행 원장의 위험도 Wave 순서로 진행 |
