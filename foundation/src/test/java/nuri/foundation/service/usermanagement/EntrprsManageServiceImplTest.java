...
import nuri.foundation.domain.user.repository.EnterpriseUserRepository;
import nuri.foundation.service.usermanagement.dto.EnterpriseUserDto;
...
@DisplayName("EntrprsManageService (기업 사용자 관리) 테스트")
