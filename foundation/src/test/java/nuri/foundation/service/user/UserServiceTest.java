...
class UserServiceTest {
    ...
    void updateUsersRoleSuccessTest() {
        try (var mockedSecurity = mockStatic(nuri.foundation.security.util.SecurityUtil.class)) {
            ...
            userService.updateUsersRole(List.of("user1"), nuri.foundation.domain.user.entity.Role.ADMIN);
    ...
    void updateUsersRoleNoAuthTest() {
        try (var mockedSecurity = mockStatic(nuri.foundation.security.util.SecurityUtil.class)) {
            ...
            assertThrows(BusinessException.class, () -> userService.updateUsersRole(List.of("user1"), nuri.foundation.domain.user.entity.Role.ADMIN));
        }
    }
