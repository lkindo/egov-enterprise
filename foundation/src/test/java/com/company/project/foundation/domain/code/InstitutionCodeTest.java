...
@DisplayName("InstitutionCode ?îÌã∞???åÏä§??)
class InstitutionCodeTest {

    @Test
    @DisplayName("InstitutionCode ?îÌã∞??ÎπåÎçî Î∞?Ï¥àÍ∏∞???åÏä§??)
    void builderTest() {
    ...
    @Test
    @DisplayName("InstitutionCode ?îÌã∞???òÏ†ï ?åÏä§??)
    void updateTest() {
        InstitutionCode code = InstitutionCode.builder()
                .insttCode("INST01")
                .allInsttNm("Old Name")
    ...
    @Test
    @DisplayName("InstitutionCode ?îÌã∞???åÌîÑ????†ú ?åÏä§??)
    void softDeleteTest() {
        InstitutionCode code = InstitutionCode.builder()
                .insttCode("INST01")
                .ablEnnc("0")
