...
class CryptoUtilTest {
    ...
    @Nested
    @DisplayName("encrypt ë©”ì„œ???ŒìŠ¤??)
    class EncryptTests {

        @Test
        @DisplayName("?•ìƒ ?°ì´???”í˜¸???±ê³µ")
    ...
    @Nested
    @DisplayName("decrypt ë©”ì„œ???ŒìŠ¤??)
    class DecryptTests {

        @Test
        @DisplayName("?•ìƒ ?°ì´??ë³µí˜¸???±ê³µ")
        ...
        @Test
        @DisplayName("null ?°ì´??ë³µí˜¸????null ë°˜í™˜")
        ...
        @Test
        @DisplayName("?˜ëª»??Base64 ë¬¸ìž??ë³µí˜¸?????ˆì™¸ ë°œìƒ")
    ...
    @Nested
    @DisplayName("?¹ìˆ˜ ëª©ì  ?”í˜¸??ë©”ì„œ???ŒìŠ¤??)
    class SpecialEncryptTests {

        @Test
        @DisplayName("encryptSession - ?¸ì…˜ ID ?€ ?¨ê»˜ ?”í˜¸??)
        ...
        @Test
        @DisplayName("encryptSession - null ?°ì´?????€??ë°˜í™˜")
    ...
    @Nested
    @DisplayName("?ˆì™¸ ?í™© ?ŒìŠ¤??)
    class ExceptionTests {

        @Test
        @DisplayName("?”í˜¸???œë¹„???¤ë¥˜ ??RuntimeException ë°œìƒ")
        ...
        @Test
        @DisplayName("ë³µí˜¸???œë¹„???¤ë¥˜ ??RuntimeException ë°œìƒ")
