...
@DisplayName("AuthorRoleManageService ?åÏä§??)
class AuthorRoleManageServiceTest {
    ...
    @Nested
    @DisplayName("Í∂åÌïúÎ≥?Î°?Î™©Î°ù Ï°∞Ìöå ?åÏä§??)
    ...
    @Nested
    @DisplayName("Í∂åÌïú??Î°??†Îãπ ?åÏä§??)
    class InsertAuthorRoleTests {

        @Test
        @DisplayName("Í∂åÌïú??Î°??†Îãπ ?±Í≥µ")
        ...
        @Test
        @DisplayName("Îπ?Î°?Î™©Î°ù ?ÑÎã¨ ??Í∏∞Ï°¥ ?ïÎ≥¥ ??†úÎß??òÌñâ")
