package nuri.foundation.api.auth;
...
public class AuthApiController {
    ...
    private final nuri.foundation.service.user.UserService userService;
    ...
    public ApiResponse<Map<String, Object>> getCurrentUser() {
        ...
        if (auth != null && auth.isAuthenticated() && !auth.getPrincipal().equals("anonymousUser")) {
            ...
            nuri.foundation.service.user.dto.UserDto userDto = userService.getUserById(userId);
