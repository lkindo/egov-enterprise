...
public class EventInfoDto {
    ...
    public static EventInfoDto from(EventInfo entity) {
        return EventInfoDto.builder()
                ...
                .eventSvcBgnde(entity.getEventSvcBgnde() != null ? entity.getEventSvcBgnde().toString() : null)
                .eventSvcEndde(entity.getEventSvcEndde() != null ? entity.getEventSvcEndde().toString() : null)
                ...
                .eventConfmDe(entity.getEventConfmDe() != null ? entity.getEventConfmDe().toString() : null)
