...
public class CommonCodeService extends EgovAbstractServiceImpl implements EgovCommonCodeService {
    ...
    public CommonCodeDto createCode(@NonNull CommonCodeSaveRequest request) {
        ...
        if (commonCodeRepository
                .findById(new com.company.project.foundation.domain.code.CommonCodeId(request.codeGroupId(), request.code()))
                .isPresent()) {
    ...
    private CmmnDetailCodeDto toDto(com.company.project.foundation.domain.code.CommonCodeDetailProjection projection) {
