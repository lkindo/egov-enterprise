package com.company.project.foundation.api.controller.menu;
...
public class MenuUserApiController {
    ...
    public ResponseEntity<Map<String, Object>> getPrograms() {
        ...
        try {
            List<com.company.project.foundation.domain.program.Program> programs = menuService.getAllPrograms();
