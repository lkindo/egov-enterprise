...
### Backend
- **Core**: Spring Boot 3.4.1, Java 21 (LTS)
...
├── frontend/               # Next.js 16 프런트엔드 애플리케이션
...
#### 3. 데이터베이스 마이그레이션
```bash
# 스키마는 Flyway 마이그레이션으로 관리됩니다.
#   application.yml: flyway.enabled=true, spring.jpa.hibernate.ddl-auto=validate
# 애플리케이션 기동 시 db/migration/V*.sql 이 자동 적용되며, 엔티티는 스키마 검증만 수행합니다.
```
...
*Last Updated: 2026-07-04 (Stack sync: Next.js 16.2.4 / Spring Boot 3.4.1 / PostgreSQL 17; Flyway migration flow)*
