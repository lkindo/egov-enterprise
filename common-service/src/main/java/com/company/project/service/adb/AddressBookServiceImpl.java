...
public class AddressBookServiceImpl implements AddressBookService {
    ...
    @Override
    public Page<AddressBookDto> getAddressBookList(String wrterId, String trgetOrgnztId, String searchCnd, String searchWrd, Pageable pageable) {
    ...
    @Override
    public Page<AddressBookUserDto> searchUsers(String searchWrd, Pageable pageable) {
