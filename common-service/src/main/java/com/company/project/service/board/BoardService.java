...
/**
 * JPA Í∏∞Î∞ò Í≤åÏãú??ÎπÑÏ¶à?àÏä§ Î°úÏßÅ Íµ¨ÌòÑ ?¥Îûò?? * - ?ÑÏûê?ïÎ? ?úÏ? ?ÑÎ†à?ÑÏõå??5.0 Î™ÖÏÑ∏??ÎßûÏ∂ò Í∏∞Îä• Íµ¨ÌòÑ
 * - EgovAbstractServiceImpl ?ÅÏÜç Î∞?BoardService ?∏ÌÑ∞?òÏù¥??Íµ¨ÌòÑ
 */
...
public class BoardService extends EgovAbstractServiceImpl implements EgovBoardService {
        ...
        public Long createPost(@NonNull String userId, @NonNull BoardSaveRequest request) {
                ...
                // ?úÎπÑ???∞ÏΩî?àÏù¥???®ÌÑ¥ ?êÎäî Î™®ÎìàÍ∞??úÎπÑ???∏Ï∂ú (?¥Î≤§??Í∂åÏû•)
                UserDto author = null;
                try {
                ...
                Board board = Board.builder()
                                ...
                                .ntcrId(userId)
                                .ntcrNm(author != null ? author.getUserNm() : "?µÎ™Ö")
                ...
                // Point 22: ?¥Î≤§??Î∞úÌñâ (?µÍ≥Ñ ?ôÍ∏∞????Î™©Ï†Å)
