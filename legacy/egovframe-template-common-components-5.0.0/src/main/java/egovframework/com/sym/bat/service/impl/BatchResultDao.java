...
public class BatchResultDao extends EgovComAbstractDAO {
	 ...
	 * 諛곗튂寃곌낵???깅줉?쒕떎.
	 *
	 * @param batchResult ??ν븷 諛곗튂寃곌낵 VO
	 * @exception Exception Exception
	 */
	 ...
	 * @return 諛곗튂寃곌낵?뺣낫
	 *
	 * @param batchResult    議고쉶??KEY媛 ?덈뒗 諛곗튂寃곌낵 VO
	 * @exception Exception Exception
	 */
	 ...
	 * 諛곗튂寃곌낵?뺣낫瑜??섏젙?쒕떎.
	 *
	 * @param batchResult    ?섏젙???諛곗튂寃곌낵 VO
	 * @exception Exception Exception
	 */
