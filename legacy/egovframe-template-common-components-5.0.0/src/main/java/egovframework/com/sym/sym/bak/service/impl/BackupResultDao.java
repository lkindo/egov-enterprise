...
public class BackupResultDao extends EgovComAbstractDAO {
	 ...
	 * 諛깆뾽寃곌낵????젣?쒕떎.
	 *
	 * @param backupResult    ??젣??諛깆뾽寃곌낵 VO
	 ...
	 * 諛깆뾽寃곌낵???깅줉?쒕떎.
	 *
	 * @param backupResult ??ν븷 諛깆뾽寃곌낵 VO
	 * @exception Exception Exception
	 */
	 ...
	 * @return 諛깆뾽寃곌낵?뺣낫
	 *
	 * @param backupResult    議고쉶??KEY媛 ?덈뒗 諛깆뾽寃곌낵 VO
	 * @exception Exception Exception
	 */
	 ...
	 * 諛깆뾽寃곌낵?뺣낫瑜??섏젙?쒕떎.
	 *
	 * @param backupResult    ?섏젙???諛깆뾽寃곌낵 VO
	 * @exception Exception Exception
	 */
