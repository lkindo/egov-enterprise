...
public class EgovCcmCmmnCodeManageController {
	...
	public String updateCmmnCode(@ModelAttribute("loginVO") LoginVO loginVO,
		...
		if ((cmmnCode.getClCodeNm() == null || cmmnCode.getClCodeNm().isEmpty()) 
			...
			try {
				egovframework.let.sym.ccm.ccc.service.CmmnClCode tempClCode = new egovframework.let.sym.ccm.ccc.service.CmmnClCode();
				tempClCode.setClCode(cmmnCode.getClCode());
				egovframework.let.sym.ccm.ccc.service.CmmnClCode clCodeData = cmmnClCodeManageService.selectCmmnClCodeDetail(tempClCode);
				if (clCodeData != null) {
