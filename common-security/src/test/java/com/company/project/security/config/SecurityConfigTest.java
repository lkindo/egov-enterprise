...
class SecurityConfigTest {
    ...
    void anonymousAccess_toPublicEndpoint_returns200() throws Exception {
        ...
        mockMvc.perform(get("/auth/login")
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().is(200)); // May return 405 Method Not Allowed or 200 depending on implementation
    }
    ...
    void anonymousAccess_toStaticResources_returns200() throws Exception {
        ...
        mockMvc.perform(get("/css/style.css"))
                .andExpect(status().is(404)); // Resource may not exist but should not be blocked by security
    ...
    void csrf_disabled() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/users")
                .contentType(MediaType.APPLICATION_JSON)
                .content("{}"))
                .andExpect(status().isUnauthorized()); // Should return 401 instead of 403 due to authentication, not CSRF
    }
