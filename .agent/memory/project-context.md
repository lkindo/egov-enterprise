...
| CTX-002 | 백엔드는 Java 21, Spring Boot 3.5.16, eGovFrame 5.0.0 축이다. Boot 3.5 라인의 OSS 지원은 2026-06-30에 끝났고 3.5.16(2026-06-25 공개)이 마지막 공개 패치다. 후속 라인 결정은 GAP-DEP-002가 추적한다. | [build.gradle](../../build.gradle), [version catalog](../../gradle/libs.versions.toml), [GAP-DEP-002](known-gaps.md) | 2026-09-22 |
