...
| CTX-008 | 중앙 gate registry가 governance JUnit 35개·ArchUnit 10개·schema-validation 38개, runner catalog 5개, execution profile 6개, quality population 3개와 ratchet 15개를 source·task·실행 tier·CI 소비자에 exact-match한다. | [gate registry](../../config/governance/gates.json), [registry contract](../../scripts/governance-gates-contract.mjs) | 2026-08-23 |
