...
| CTX-008 | 중앙 gate registry가 governance JUnit 37개·ArchUnit 10개·schema-validation 39개, runner catalog 7개(2026-09-01 크로스 스택 계약 카탈로그 신설 포함), execution profile 6개, quality population 3개와 ratchet 15개를 source·task·실행 tier·CI 소비자에 exact-match하고, 선언 root 밖의 tagged gate 도 오류로 잡는다. 정확한 현재 수는 registry 계약 실행 출력이 정본이다. | [gate registry](../../config/governance/gates.json), [registry contract](../../scripts/governance-gates-contract.mjs) | 2026-09-01 |
