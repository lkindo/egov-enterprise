...
2. **Orchestration skills second** (superpowers-ccg) - for multi-model task routing (CCG: Claude+Codex+Gemini)
3. **Implementation skills third** (frontend-design, mcp-builder) - these guide execution

"Let's build X" ??brainstorming first, then orchestration (CCG) if needed, then implementation skills.
