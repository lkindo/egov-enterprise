...
class UserValidatorTest {
  ...
  void validateUser_failures() {
    ...
    assertThatThrownBy(() -> UserValidator.validateUser(nuri.business.domain.user.entity.User.builder().userId("").esntlId("").userNm("홍길동").pswd("1234").build()))
        .isInstanceOf(IllegalArgumentException.class)
        .hasMessage("User ID cannot be null or empty");

    assertThatThrownBy(() -> UserValidator.validateUser(nuri.business.domain.user.entity.User.builder().userId("a").esntlId("esntl1").userNm("홍길동").pswd("1234").build()))
        .isInstanceOf(IllegalArgumentException.class)
        .hasMessage("User ID must be 4-20 alphanumeric characters");

    assertThatThrownBy(() -> UserValidator.validateUser(nuri.business.domain.user.entity.User.builder().userId("user1").esntlId("esntl1").userNm("").pswd("1234").build()))
        .isInstanceOf(IllegalArgumentException.class)
        .hasMessage("User name cannot be null or empty");

    assertThatThrownBy(() -> UserValidator.validateUser(nuri.business.domain.user.entity.User.builder().userId("user1").esntlId("esntl1").userNm("a").pswd("1234").build()))
        .isInstanceOf(IllegalArgumentException.class)
        .hasMessage("User name contains invalid characters");

    assertThatThrownBy(() -> UserValidator.validateUser(nuri.business.domain.user.entity.User.builder().userId("user1").esntlId("esntl1").userNm("홍길동").pswd("1234").emlAddr("invalid").build()))
        .isInstanceOf(IllegalArgumentException.class)
        .hasMessage("Invalid email format");
  }
  ...
  void validateUser_success() {
    nuri.business.domain.user.entity.User user = nuri.business.domain.user.entity.User.builder()
        .userId("user1")
        .esntlId("esntl1")
        .userNm("홍길동")
        .pswd("1234")
